...
var map__56380 = emmy.numerical.quadrature.infinite.fill_defaults(opts);
var map__56380__$1 = cljs.core.__destructure_map(map__56380);
var opts__$1 = map__56380__$1;
var infinite_breakpoint = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56380__$1,new cljs.core.Keyword(null,"infinite-breakpoint","infinite-breakpoint",1403428770));
...
var l_break = (- r_break);
var ocr_56395 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,b], null);
try{if(((cljs.core.vector_QMARK_(ocr_56395)) && ((cljs.core.count(ocr_56395) === 2)))){
try{var ocr_56395_0__56445 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56395,(0));
if((ocr_56395_0__56445 === -Infinity)){
try{var ocr_56395_1__56446 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56395,(1));
if((ocr_56395_1__56446 === -Infinity)){
...
var e__31462__auto____$1 = e56572;
...
var e__31462__auto____$1 = e56519;
if((e__31462__auto____$1 === cljs.core.match.backtrack)){
try{var ocr_56395_0__56445 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56395,(0));
if((ocr_56395_0__56445 === -Infinity)){
try{var ocr_56395_1__56446 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56395,(1));
...
var e__31462__auto____$2 = e56571;
...
var e__31462__auto____$2 = e56540;
if((e__31462__auto____$2 === cljs.core.match.backtrack)){
try{var ocr_56395_0__56445 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56395,(0));
if((ocr_56395_0__56445 === Infinity)){
try{var ocr_56395_1__56446 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56395,(1));
...
var e__31462__auto____$3 = e56568;
if((e__31462__auto____$3 === cljs.core.match.backtrack)){
throw cljs.core.match.backtrack;
} else {
throw e__31462__auto____$3;
}
} else {
throw e56568;
...
var e__31462__auto____$3 = e56541;
if((e__31462__auto____$3 === cljs.core.match.backtrack)){
try{var ocr_56395_0__56445 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56395,(0));
if((ocr_56395_0__56445 === -Infinity)){
try{var ocr_56395_1__56446 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56395,(1));
...
var e__31462__auto____$4 = e56544;
if((e__31462__auto____$4 === cljs.core.match.backtrack)){
if((b <= l_break)){
...
var e__31462__auto____$4 = e56542;
if((e__31462__auto____$4 === cljs.core.match.backtrack)){
try{var ocr_56395_1__56446 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56395,(1));
if((ocr_56395_1__56446 === Infinity)){
if((a >= r_break)){
...
var e__31462__auto____$5 = e56543;
if((e__31462__auto____$5 === cljs.core.match.backtrack)){
throw cljs.core.match.backtrack;
} else {
throw e__31462__auto____$5;
}
} else {
throw e56543;
...
}catch (e56499){if((e56499 instanceof Error)){
var e__31462__auto__ = e56499;
if((e__31462__auto__ === cljs.core.match.backtrack)){
