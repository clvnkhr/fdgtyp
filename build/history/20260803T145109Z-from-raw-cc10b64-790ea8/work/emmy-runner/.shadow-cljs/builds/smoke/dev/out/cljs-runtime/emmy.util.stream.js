...
var seq__38884 = cljs.core.seq(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,xs));
var chunk__38885 = null;
var count__38886 = (0);
var i__38887 = (0);
while(true){
if((i__38887 < count__38886)){
var x = chunk__38885.cljs$core$IIndexed$_nth$arity$2(null,i__38887);
...
var G__38981 = seq__38884;
var G__38982 = chunk__38885;
var G__38983 = count__38886;
var G__38984 = (i__38887 + (1));
seq__38884 = G__38981;
chunk__38885 = G__38982;
count__38886 = G__38983;
i__38887 = G__38984;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__38884);
if(temp__5825__auto__){
var seq__38884__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__38884__$1)){
var c__5694__auto__ = cljs.core.chunk_first(seq__38884__$1);
var G__38985 = cljs.core.chunk_rest(seq__38884__$1);
var G__38986 = c__5694__auto__;
var G__38987 = cljs.core.count(c__5694__auto__);
var G__38988 = (0);
seq__38884 = G__38985;
chunk__38885 = G__38986;
count__38886 = G__38987;
i__38887 = G__38988;
continue;
} else {
var x = cljs.core.first(seq__38884__$1);
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([emmy.generic.simplify.cljs$core$IFn$_invoke$arity$1(x)], 0));


var G__38989 = cljs.core.next(seq__38884__$1);
var G__38990 = null;
var G__38991 = (0);
var G__38992 = (0);
seq__38884 = G__38989;
chunk__38885 = G__38990;
count__38886 = G__38991;
i__38887 = G__38992;
continue;
}
} else {
...
var seq__38890 = cljs.core.seq(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,xs));
var chunk__38891 = null;
var count__38892 = (0);
var i__38893 = (0);
while(true){
if((i__38893 < count__38892)){
var x = chunk__38891.cljs$core$IIndexed$_nth$arity$2(null,i__38893);
cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(emmy.generic.simplify.cljs$core$IFn$_invoke$arity$1(x));


var G__38993 = seq__38890;
var G__38994 = chunk__38891;
var G__38995 = count__38892;
var G__38996 = (i__38893 + (1));
seq__38890 = G__38993;
chunk__38891 = G__38994;
count__38892 = G__38995;
i__38893 = G__38996;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__38890);
if(temp__5825__auto__){
var seq__38890__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__38890__$1)){
var c__5694__auto__ = cljs.core.chunk_first(seq__38890__$1);
var G__38997 = cljs.core.chunk_rest(seq__38890__$1);
var G__38998 = c__5694__auto__;
var G__38999 = cljs.core.count(c__5694__auto__);
var G__39000 = (0);
seq__38890 = G__38997;
chunk__38891 = G__38998;
count__38892 = G__38999;
i__38893 = G__39000;
continue;
} else {
var x = cljs.core.first(seq__38890__$1);
cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(emmy.generic.simplify.cljs$core$IFn$_invoke$arity$1(x));


var G__39001 = cljs.core.next(seq__38890__$1);
var G__39002 = null;
var G__39003 = (0);
var G__39004 = (0);
seq__38890 = G__39001;
chunk__38891 = G__39002;
count__38892 = G__39003;
i__38893 = G__39004;
continue;
}
} else {
...
var vec__38939 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__38942,o){
var vec__38944 = p__38942;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38944,(0),null);
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38944,(1),null);
...
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38939,(0),null);
var fs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38939,(1),null);
...
(emmy.util.stream.seq_limit.cljs$core$IFn$_invoke$arity$2 = (function (xs,p__38954){
var map__38955 = p__38954;
var map__38955__$1 = cljs.core.__destructure_map(map__38955);
var minterms = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__38955__$1,new cljs.core.Keyword(null,"minterms","minterms",-1267652170),(2));
var maxterms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38955__$1,new cljs.core.Keyword(null,"maxterms","maxterms",951779603));
var tolerance = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__38955__$1,new cljs.core.Keyword(null,"tolerance","tolerance",406811818),emmy.util.sqrt_machine_epsilon);
var convergence_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__38955__$1,new cljs.core.Keyword(null,"convergence-fn","convergence-fn",-157362513),emmy.util.stream.close_enuf_QMARK_(tolerance));
...
var G__38962 = xs;
var vec__38963 = G__38962;
var seq__38964 = cljs.core.seq(vec__38963);
var first__38965 = cljs.core.first(seq__38964);
var seq__38964__$1 = cljs.core.next(seq__38964);
var x1 = first__38965;
var vec__38966 = seq__38964__$1;
var x2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38966,(0),null);
var more = vec__38966;
var terms_checked = (1);
var G__38962__$1 = G__38962;
var terms_checked__$1 = terms_checked;
while(true){
var vec__38969 = G__38962__$1;
...
var x1__$1 = first__38971;
var vec__38972 = seq__38970__$1;
var x2__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38972,(0),null);
var more__$1 = vec__38972;
...
var G__39024 = more__$1;
var G__39025 = terms_checked__$3;
G__38962__$1 = G__39024;
terms_checked__$1 = G__39025;
continue;
}
}
break;
