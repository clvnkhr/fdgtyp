...
try{var _STAR_private_var_access_nowarn_STAR__orig_val__25901 = cljs.analyzer._STAR_private_var_access_nowarn_STAR_;
var _STAR_private_var_access_nowarn_STAR__temp_val__25902 = true;
(cljs.analyzer._STAR_private_var_access_nowarn_STAR_ = _STAR_private_var_access_nowarn_STAR__temp_val__25902);

try{return cljs.analyzer.resolve_var.cljs$core$IFn$_invoke$arity$3(env,sym,cljs.analyzer.confirm_var_exists_throw());
}finally {(cljs.analyzer._STAR_private_var_access_nowarn_STAR_ = _STAR_private_var_access_nowarn_STAR__orig_val__25901);
}}catch (e25900){var e = e25900;
 ...
 */
cljs.analyzer.api.resolve_extern = (function cljs$analyzer$api$resolve_extern(var_args){
...
(cljs.analyzer.api.resolve_extern.cljs$core$IFn$_invoke$arity$1 = (function (sym){
return cljs.analyzer.api.resolve_extern.cljs$core$IFn$_invoke$arity$2(cljs.env._STAR_compiler_STAR_,sym);
}));

(cljs.analyzer.api.resolve_extern.cljs$core$IFn$_invoke$arity$2 = (function (state,sym){
var pre = cljs.analyzer.__GT_pre(sym);
var env__1491__auto__ = state;
var env__1491__auto____$1 = ((cljs.core.map_QMARK_(env__1491__auto__))?cljs.core.atom.cljs$core$IFn$_invoke$arity$1(env__1491__auto__):(((((env__1491__auto__ instanceof clojure.lang.Atom)) && (cljs.core.map_QMARK_(cljs.core.deref(env__1491__auto__)))))?env__1491__auto__:(function (){throw (new java.lang.IllegalArgumentException((""+"Compiler environment must be a map or atom containing a map, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.class$.cljs$core$IFn$_invoke$arity$1 ? cljs.core.class$.cljs$core$IFn$_invoke$arity$1(env__1491__auto__) : cljs.core.class$.call(null,env__1491__auto__))))))})()
));
var _STAR_compiler_STAR__orig_val__25908 = cljs.env._STAR_compiler_STAR_;
var _STAR_compiler_STAR__temp_val__25909 = env__1491__auto____$1;
(cljs.env._STAR_compiler_STAR_ = _STAR_compiler_STAR__temp_val__25909);

try{return new cljs.core.Keyword(null,"info","info",-317069002).cljs$core$IFn$_invoke$arity$1(cljs.analyzer.resolve_extern.cljs$core$IFn$_invoke$arity$1(pre));
}finally {(cljs.env._STAR_compiler_STAR_ = _STAR_compiler_STAR__orig_val__25908);
}}));

(cljs.analyzer.api.resolve_extern.cljs$lang$maxFixedArity = 2);
...
var or__5162__auto__ = cljs.analyzer.api.find_ns.cljs$core$IFn$_invoke$arity$2(state,sym);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2((""+"No namespace found: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sym)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ns","ns",441598760),sym], null));
}
}));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__25933){
var vec__25934 = p__25933;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25934,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25934,(1),null);
