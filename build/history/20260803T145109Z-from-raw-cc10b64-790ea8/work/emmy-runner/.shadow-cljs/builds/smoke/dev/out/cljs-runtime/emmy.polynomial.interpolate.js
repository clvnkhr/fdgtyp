...
var build_term = (function (i,p__32680){
var vec__32681 = p__32680;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32681,(0),null);
var fa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32681,(1),null);
var others = (function (){var iter__5649__auto__ = (function emmy$polynomial$interpolate$lagrange_$_iter__32684(s__32685){
return (new cljs.core.LazySeq(null,(function (){
var s__32685__$1 = s__32685;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32685__$1);
if(temp__5825__auto__){
var s__32685__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32685__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32685__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32687 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32686 = (0);
while(true){
if((i__32686 < size__5648__auto__)){
var j = cljs.core._nth(c__5647__auto__,i__32686);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(i,j)){
cljs.core.chunk_append(b__32687,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(points__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,(0)], null)));

var G__32922 = (i__32686 + (1));
i__32686 = G__32922;
continue;
} else {
var G__32924 = (i__32686 + (1));
i__32686 = G__32924;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32687),emmy$polynomial$interpolate$lagrange_$_iter__32684(cljs.core.chunk_rest(s__32685__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32687),null);
}
} else {
var j = cljs.core.first(s__32685__$2);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(i,j)){
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(points__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,(0)], null)),emmy$polynomial$interpolate$lagrange_$_iter__32684(cljs.core.rest(s__32685__$2)));
} else {
var G__32935 = cljs.core.rest(s__32685__$2);
s__32685__$1 = G__32935;
continue;
}
}
} else {
...
var p = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32673_SHARP_){
return emmy.generic._.cljs$core$IFn$_invoke$arity$2(x,p1__32673_SHARP_);
}),others));
var q = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32674_SHARP_){
return emmy.generic._.cljs$core$IFn$_invoke$arity$2(a,p1__32674_SHARP_);
}),others));
...
var vec__32706 = points__$1;
var vec__32709 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32706,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32709,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32709,(1),null);
return y;
} else {
var l_branch = cljs.core.pop(points__$1);
var r_branch = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(points__$1,(1));
var vec__32713 = cljs.core.first(points__$1);
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32713,(0),null);
var vec__32716 = cljs.core.peek(points__$1);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32716,(0),null);
 ...
 *   
 */
emmy.polynomial.interpolate.neville_prepare = (function emmy$polynomial$interpolate$neville_prepare(p__32727){
var vec__32728 = p__32727;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32728,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32728,(1),null);
...
return (function (p__32738,p__32739){
var vec__32741 = p__32738;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32741,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32741,(1),null);
var pl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32741,(2),null);
var vec__32744 = p__32739;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32744,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32744,(1),null);
var pr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32744,(2),null);
...
return (function (p__32786,p__32787){
var vec__32788 = p__32786;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32788,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32788,(1),null);
var pl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32788,(2),null);
var vec__32791 = p__32787;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32791,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32791,(1),null);
var pr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32791,(2),null);
 ...
 */
emmy.polynomial.interpolate.mn_prepare = (function emmy$polynomial$interpolate$mn_prepare(p__32814){
var vec__32817 = p__32814;
...
return (function (p__32824,p__32825){
var vec__32828 = p__32824;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32828,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32828,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32828,(2),null);
var dl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32828,(3),null);
var vec__32832 = p__32825;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32832,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32832,(1),null);
var cr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32832,(2),null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32832,(3),null);
var diff = (cr - dl);
var den = (xl - xr);
var factor = (diff / den);
var c = (factor * (xl - x));
...
return emmy.util.aggregate.scan.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__32839){
var vec__32842 = p__32839;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32842,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32842,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32842,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32842,(3),null);
return c;
}),row));
});
/**
...
G__32998 = function(prev_row,point){
switch(arguments.length){
case 0:
return G__32998__0.call(this);
case 1:
return G__32998__1.call(this,prev_row);
case 2:
return G__32998__2.call(this,prev_row,point);
}
...
return cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__32877){
var vec__32878 = p__32877;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32878,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32878,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32878,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32878,(3),null);
return c;
