...
var args__$1 = args.map((function (p1__51096_SHARP_){
return sci.impl.types.eval(p1__51096_SHARP_,ctx,bindings);
}));
...
return Reflect.construct(constructor$,args.map((function (p1__51111_SHARP_){
return sci.impl.types.eval(p1__51111_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__51118_SHARP_){
return sci.impl.types.eval(p1__51118_SHARP_,ctx,bindings);
})));
});
...
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51135,(0),null);
