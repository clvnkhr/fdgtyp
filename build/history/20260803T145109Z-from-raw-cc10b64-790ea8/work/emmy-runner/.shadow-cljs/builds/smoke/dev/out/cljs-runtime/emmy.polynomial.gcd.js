...
var memo_count_38912 = cljs.core.count(cljs.core.deref(emmy.polynomial.gcd.gcd_memo));
if((memo_count_38912 > (0))){
var hits_38913 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_hit);
var misses_38914 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_miss);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [goog.string.format("GCD cache hit rate %.2f%% (%d entries)",((100) * (hits_38913 / (hits_38913 + misses_38914))),memo_count_38912)], null);
...
var len__5897__auto___38915 = arguments.length;
var i__5898__auto___38916 = (0);
while(true){
if((i__5898__auto___38916 < len__5897__auto___38915)){
args__5903__auto__.push((arguments[i__5898__auto___38916]));

var G__38917 = (i__5898__auto___38916 + (1));
i__5898__auto___38916 = G__38917;
continue;
} else {
}
break;
...
/** @this {Function} */
(emmy.polynomial.gcd.dbg.cljs$lang$applyTo = (function (seq38712){
var G__38713 = cljs.core.first(seq38712);
var seq38712__$1 = cljs.core.next(seq38712);
var G__38714 = cljs.core.first(seq38712__$1);
var seq38712__$2 = cljs.core.next(seq38712__$1);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38713,G__38714,seq38712__$2);
}));
...
var vec__38720 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var ticks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38720,(0),null);
var units = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38720,(1),null);
...
var _STAR_poly_gcd_time_limit_STAR__orig_val__38730 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var _STAR_clock_STAR__orig_val__38731 = emmy.polynomial.gcd._STAR_clock_STAR_;
var _STAR_poly_gcd_time_limit_STAR__temp_val__38732 = timeout;
var _STAR_clock_STAR__temp_val__38733 = emmy.util.stopwatch.stopwatch();
(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__temp_val__38732);

(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__temp_val__38733);

try{return (thunk.cljs$core$IFn$_invoke$arity$0 ? thunk.cljs$core$IFn$_invoke$arity$0() : thunk.call(null));
}finally {(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__orig_val__38731);

(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__orig_val__38730);
}});
/**
...
if(cljs.core.truth_(and__5160__auto__)){
var G__38736 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [u,v], null);
var fexpr__38735 = cljs.core.deref(emmy.polynomial.gcd.gcd_memo);
return (fexpr__38735.cljs$core$IFn$_invoke$arity$1 ? fexpr__38735.cljs$core$IFn$_invoke$arity$1(G__38736) : fexpr__38735.call(null,G__38736));
} else {
return and__5160__auto__;
}
})();
...
var len__5897__auto___38922 = arguments.length;
var i__5898__auto___38923 = (0);
while(true){
if((i__5898__auto___38923 < len__5897__auto___38922)){
args_arr__5922__auto__.push((arguments[i__5898__auto___38923]));

var G__38924 = (i__5898__auto___38923 + (1));
i__5898__auto___38923 = G__38924;
continue;
} else {
}
break;
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$1 = (function (p__38752){
var vec__38753 = p__38752;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38753,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38753,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [u,v], null);
}));

(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$2 = (function (p__38756,f){
var vec__38757 = p__38756;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38757,(0),null);
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$3 = (function (p__38760,f1,f2){
var vec__38761 = p__38760;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38761,(0),null);
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$variadic = (function (p__38764,f1,f2,more){
var vec__38767 = p__38764;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38767,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38767,(1),null);
var G__38770 = u;
var G__38771 = v;
var G__38772 = (function (u_SINGLEQUOTE_,v_SINGLEQUOTE_){
...
return (f1.cljs$core$IFn$_invoke$arity$3 ? f1.cljs$core$IFn$_invoke$arity$3(G__38770,G__38771,G__38772) : f1.call(null,G__38770,G__38771,G__38772));
}));

/** @this {Function} */
(emmy.polynomial.gcd.cont__GT_.cljs$lang$applyTo = (function (seq38741){
var G__38742 = cljs.core.first(seq38741);
var seq38741__$1 = cljs.core.next(seq38741);
var G__38743 = cljs.core.first(seq38741__$1);
var seq38741__$2 = cljs.core.next(seq38741__$1);
var G__38744 = cljs.core.first(seq38741__$2);
var seq38741__$3 = cljs.core.next(seq38741__$2);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38742,G__38743,G__38744,seq38741__$3);
}));
...
var vec__38785 = emmy.polynomial.gcd.terms__GT_sort_PLUS_unsort(cljs.core.into.cljs$core$IFn$_invoke$arity$2(l_terms,r_terms));
var sort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38785,(0),null);
var unsort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38785,(1),null);
return emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(unsort,(function (){var G__38790 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,u);
var G__38791 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,v);
return (continue$.cljs$core$IFn$_invoke$arity$2 ? continue$.cljs$core$IFn$_invoke$arity$2(G__38790,G__38791) : continue$.call(null,G__38790,G__38791));
})());
} else {
...
var primitive = (cljs.core.truth_(emmy.generic.one_QMARK_.cljs$core$IFn$_invoke$arity$1(content))?p:emmy.polynomial.map_coefficients((function (p1__38794_SHARP_){
return emmy.generic.exact_divide.cljs$core$IFn$_invoke$arity$2(p1__38794_SHARP_,content);
}),p));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [content,primitive], null);
}
});
...
var vec__38806 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(u,gcd);
var ku = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38806,(0),null);
var pu = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38806,(1),null);
var vec__38809 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(v,gcd);
var kv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38809,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38809,(1),null);
...
var vec__38847 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.bare_terms(m),(0));
var mono_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38847,(0),null);
var mono_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38847,(1),null);
...
var vec__38860 = emmy.polynomial.pseudo_remainder(u,v);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38860,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38860,(1),null);
if(cljs.core.truth_(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(r))){
return emmy.generic.abs.cljs$core$IFn$_invoke$arity$1(v);
} else {
var vec__38867 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(r,gcd);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38867,(0),null);
var prim = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38867,(1),null);
var G__38936 = v;
var G__38937 = prim;
u = G__38936;
v = G__38937;
