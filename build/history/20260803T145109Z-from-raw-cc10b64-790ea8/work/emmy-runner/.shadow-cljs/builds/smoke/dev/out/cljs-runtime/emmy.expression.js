...
return emmy.expression.__GT_Literal(e.type,(function (){var G__26797 = e.expression;
...
if(emmy.expression.literal_QMARK_(expr)){
var G__26933 = emmy.expression.expression_of(expr);
expr = G__26933;
continue;
} else {
...
var vec__26811 = node;
var seq__26812 = cljs.core.seq(vec__26811);
var first__26813 = cljs.core.first(seq__26812);
var seq__26812__$1 = cljs.core.next(seq__26812);
var f_sym = first__26813;
var args = seq__26812__$1;
...
if(emmy.expression.literal_QMARK_(expr)){
return emmy.expression.fmap((function (p1__26821_SHARP_){
return emmy.expression.substitute.cljs$core$IFn$_invoke$arity$2(p1__26821_SHARP_,s_map);
}),expr);
} else {
...
var head_compare = (function (){var G__26841 = cljs.core.first(l);
var G__26842 = cljs.core.first(r);
return (emmy.expression.compare.cljs$core$IFn$_invoke$arity$2 ? emmy.expression.compare.cljs$core$IFn$_invoke$arity$2(G__26841,G__26842) : emmy.expression.compare.call(null,G__26841,G__26842));
})();
if((head_compare === (0))){
var G__26957 = cljs.core.rest(l);
var G__26958 = cljs.core.rest(r);
l = G__26957;
r = G__26958;
continue;
} else {
...
return (((!(cljs.core.sequential_QMARK_(xs)))) || (cljs.core.every_QMARK_((function (p__26853){
var vec__26854 = p__26853;
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26854,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26854,(1),null);
