...
var len__5897__auto___48592 = arguments.length;
var i__5898__auto___48593 = (0);
while(true){
if((i__5898__auto___48593 < len__5897__auto___48592)){
args__5903__auto__.push((arguments[i__5898__auto___48593]));

var G__48595 = (i__5898__auto___48593 + (1));
i__5898__auto___48593 = G__48595;
continue;
} else {
}
break;
...
/** @this {Function} */
(emmy.calculus.indexed.with_kvs.cljs$lang$applyTo = (function (seq48440){
var G__48441 = cljs.core.first(seq48440);
var seq48440__$1 = cljs.core.next(seq48440);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48441,seq48440__$1);
}));
...
var combos = emmy.util.permute.cartesian_product((function (){var iter__5649__auto__ = (function emmy$calculus$indexed$indexed__GT_typed_$_typed_$_iter__48525(s__48526){
return (new cljs.core.LazySeq(null,(function (){
var s__48526__$1 = s__48526;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__48526__$1);
if(temp__5825__auto__){
var s__48526__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48526__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__48526__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__48528 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__48527 = (0);
while(true){
if((i__48527 < size__5648__auto__)){
var x = cljs.core._nth(c__5647__auto__,i__48527);
cljs.core.chunk_append(b__48528,cljs.core.map.cljs$core$IFn$_invoke$arity$3(((function (i__48527,x,c__5647__auto__,size__5648__auto__,b__48528,s__48526__$2,temp__5825__auto__,n_seq,vector_basis,oneform_basis,n,arg_types,index_types){
return (function (i,arg){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,((emmy.calculus.vector_field.vector_field_QMARK_(arg))?(function (){var fexpr__48535 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(oneform_basis,i);
return (fexpr__48535.cljs$core$IFn$_invoke$arity$1 ? fexpr__48535.cljs$core$IFn$_invoke$arity$1(arg) : fexpr__48535.call(null,arg));
})():(function (){var G__48536 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(vector_basis,i);
return (arg.cljs$core$IFn$_invoke$arity$1 ? arg.cljs$core$IFn$_invoke$arity$1(G__48536) : arg.call(null,G__48536));
})())], null);
});})(i__48527,x,c__5647__auto__,size__5648__auto__,b__48528,s__48526__$2,temp__5825__auto__,n_seq,vector_basis,oneform_basis,n,arg_types,index_types))
,n_seq,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(x)));

var G__48602 = (i__48527 + (1));
i__48527 = G__48602;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48528),emmy$calculus$indexed$indexed__GT_typed_$_typed_$_iter__48525(cljs.core.chunk_rest(s__48526__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48528),null);
}
} else {
var x = cljs.core.first(s__48526__$2);
return cljs.core.cons(cljs.core.map.cljs$core$IFn$_invoke$arity$3(((function (x,s__48526__$2,temp__5825__auto__,n_seq,vector_basis,oneform_basis,n,arg_types,index_types){
return (function (i,arg){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,((emmy.calculus.vector_field.vector_field_QMARK_(arg))?(function (){var fexpr__48537 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(oneform_basis,i);
return (fexpr__48537.cljs$core$IFn$_invoke$arity$1 ? fexpr__48537.cljs$core$IFn$_invoke$arity$1(arg) : fexpr__48537.call(null,arg));
})():(function (){var G__48538 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(vector_basis,i);
return (arg.cljs$core$IFn$_invoke$arity$1 ? arg.cljs$core$IFn$_invoke$arity$1(G__48538) : arg.call(null,G__48538));
})())], null);
});})(x,s__48526__$2,temp__5825__auto__,n_seq,vector_basis,oneform_basis,n,arg_types,index_types))
,n_seq,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(x)),emmy$calculus$indexed$indexed__GT_typed_$_typed_$_iter__48525(cljs.core.rest(s__48526__$2)));
}
} else {
return null;
}
...
var G__48539 = (function (){var iter__5649__auto__ = (function emmy$calculus$indexed$indexed__GT_typed_$_typed_$_iter__48540(s__48541){
return (new cljs.core.LazySeq(null,(function (){
var s__48541__$1 = s__48541;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__48541__$1);
if(temp__5825__auto__){
var s__48541__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48541__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__48541__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__48543 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__48542 = (0);
while(true){
if((i__48542 < size__5648__auto__)){
var combo = cljs.core._nth(c__5647__auto__,i__48542);
...
cljs.core.chunk_append(b__48543,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(emmy.generic._STAR_,(indexed.cljs$core$IFn$_invoke$arity$1 ? indexed.cljs$core$IFn$_invoke$arity$1(indices) : indexed.call(null,indices)),cljs.core.reverse(product_args)));

var G__48605 = (i__48542 + (1));
i__48542 = G__48605;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48543),emmy$calculus$indexed$indexed__GT_typed_$_typed_$_iter__48540(cljs.core.chunk_rest(s__48541__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48543),null);
}
} else {
var combo = cljs.core.first(s__48541__$2);
var indices = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,combo);
var product_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.peek,combo);
return cljs.core.cons(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(emmy.generic._STAR_,(indexed.cljs$core$IFn$_invoke$arity$1 ? indexed.cljs$core$IFn$_invoke$arity$1(indices) : indexed.call(null,indices)),cljs.core.reverse(product_args)),emmy$calculus$indexed$indexed__GT_typed_$_typed_$_iter__48540(cljs.core.rest(s__48541__$2)));
}
} else {
return null;
}
...
return (emmy.util.aggregate.generic_sum.cljs$core$IFn$_invoke$arity$1 ? emmy.util.aggregate.generic_sum.cljs$core$IFn$_invoke$arity$1(G__48539) : emmy.util.aggregate.generic_sum.call(null,G__48539));
};
...
emmy$calculus$indexed$indexed__GT_typed_$_typed.cljs$lang$applyTo = (function (arglist__48607){
...
var map__48553 = cljs.core.frequencies(i1);
var map__48553__$1 = cljs.core.__destructure_map(map__48553);
var nu1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48553__$1,new cljs.core.Symbol(null,"up","up",1370819414,null));
var nd1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48553__$1,new cljs.core.Symbol(null,"down","down",-1089190199,null));
var map__48554 = cljs.core.frequencies(i2);
var map__48554__$1 = cljs.core.__destructure_map(map__48554);
var nu2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48554__$1,new cljs.core.Symbol(null,"up","up",1370819414,null));
var nd2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48554__$1,new cljs.core.Symbol(null,"down","down",-1089190199,null));
...
var argv = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,args);
var G__48564 = (function (i){
var G__48568 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(insertv(cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(argv,(0),nuc),u,i),insertv(cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(argv,nuc),d,i));
return (T.cljs$core$IFn$_invoke$arity$1 ? T.cljs$core$IFn$_invoke$arity$1(G__48568) : T.call(null,G__48568));
});
var G__48565 = (0);
var G__48566 = n;
return (emmy.util.aggregate.generic_sum.cljs$core$IFn$_invoke$arity$3 ? emmy.util.aggregate.generic_sum.cljs$core$IFn$_invoke$arity$3(G__48564,G__48565,G__48566) : emmy.util.aggregate.generic_sum.call(null,G__48564,G__48565,G__48566));
...
var shape = (function (){var G__48581 = emmy.structure.orientation(cf);
return (emmy.structure.opposite_orientation.cljs$core$IFn$_invoke$arity$1 ? emmy.structure.opposite_orientation.cljs$core$IFn$_invoke$arity$1(G__48581) : emmy.structure.opposite_orientation.call(null,G__48581));
})();
var t = (function (){var G__48582 = shape;
var G__48582__$1 = (((G__48582 instanceof cljs.core.Keyword))?G__48582.fqn:null);
switch (G__48582__$1) {
...
break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48582__$1))));

}
})();
var G__48613 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cf,(0));
var G__48614 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,t);
cf = G__48613;
acc = G__48614;
continue;
}
...
var args = null;
if (arguments.length > 0) {
var G__48626__i = 0, G__48626__a = new Array(arguments.length -  0);
while (G__48626__i < G__48626__a.length) {G__48626__a[G__48626__i] = arguments[G__48626__i + 0]; ++G__48626__i;}
  args = new cljs.core.IndexedSeq(G__48626__a,0,null);
} 
...
emmy$calculus$indexed$structure__GT_typed_$_indexed_fn.cljs$lang$applyTo = (function (arglist__48627){
var args = cljs.core.seq(arglist__48627);
