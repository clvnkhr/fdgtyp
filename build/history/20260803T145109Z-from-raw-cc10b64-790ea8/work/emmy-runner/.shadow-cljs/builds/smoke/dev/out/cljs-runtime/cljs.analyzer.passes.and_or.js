...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__21354){
var map__21356 = p__21354;
var map__21356__$1 = cljs.core.__destructure_map(map__21356);
var ast = map__21356__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21356__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
...
if(cljs.core.truth_((function (){var fexpr__21364 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"var","var",-769682797),null,new cljs.core.Keyword(null,"local","local",-1497766724),null], null), null);
return (fexpr__21364.cljs$core$IFn$_invoke$arity$1 ? fexpr__21364.cljs$core$IFn$_invoke$arity$1(op) : fexpr__21364.call(null,op));
})())){
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__21375_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__21375_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var map__21377 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__21377__$1 = cljs.core.__destructure_map(map__21377);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21377__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21377__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var map__21378 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__21378__$1 = cljs.core.__destructure_map(map__21378);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21378__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
