...
var G__39087 = new_m;
var G__39088 = emmy.polynomial.evenly_divide(h,emmy.polynomial.mul(new_m,new_s));
var G__39089 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(tracker,doublefacts,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([singlefacts], 0));
var G__39090 = new_s;
var G__39091 = new_m;
m = G__39087;
h = G__39088;
 ...
 */
emmy.polynomial.factor.simplify_product = emmy.pattern.rule.rule_simplifier.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([emmy.simplify.rules.associative.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Symbol(null,"*","*",345799209,null)], 0)),emmy.simplify.rules.unary_elimination.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Symbol(null,"*","*",345799209,null)], 0)),emmy.simplify.rules.constant_elimination(new cljs.core.Symbol(null,"*","*",345799209,null),(1)),emmy.pattern.rule.rule_STAR_(emmy.pattern.rule.pattern_STAR_.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"*","*",345799209,null),null,(1),null)),emmy.pattern.rule._EQ__GT_),(function (G__39013){
...
var G__39031 = emmy.polynomial.__GT_expression(factor,vars);
return (simplify.cljs$core$IFn$_invoke$arity$1 ? simplify.cljs$core$IFn$_invoke$arity$1(G__39031) : simplify.call(null,G__39031));
}),emmy.polynomial.factor.split_polynomial(p));
var G__39032 = emmy.polynomial.factor.factors__GT_expression(factors);
return (emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1(G__39032) : emmy.polynomial.factor.simplify_product.call(null,G__39032));
...
var G__39028 = emmy.polynomial.__GT_expression(p,vars);
return (emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1(G__39028) : emmy.polynomial.factor.simplify_product.call(null,G__39028));
} else {
throw e39027;
...
var cont = (function (p1__39035_SHARP_,p2__39036_SHARP_){
return emmy.polynomial.factor.poly__GT_factored_expression.cljs$core$IFn$_invoke$arity$3(p1__39035_SHARP_,p2__39036_SHARP_,simplify);
});
...
*/
emmy.polynomial.factor.t_emmy$polynomial$factor39043 = (function (symgen,meta39044){
this.symgen = symgen;
this.meta39044 = meta39044;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(emmy.polynomial.factor.t_emmy$polynomial$factor39043.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39045,meta39044__$1){
var self__ = this;
var _39045__$1 = this;
return (new emmy.polynomial.factor.t_emmy$polynomial$factor39043(self__.symgen,meta39044__$1));
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39043.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39045){
var self__ = this;
var _39045__$1 = this;
return self__.meta39044;
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39043.prototype.emmy$expression$analyze$ICanonicalize$ = cljs.core.PROTOCOL_SENTINEL);

(emmy.polynomial.factor.t_emmy$polynomial$factor39043.prototype.emmy$expression$analyze$ICanonicalize$expression__GT_$arity$4 = (function (_,expr,cont,v_compare){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.expression__GT_.cljs$core$IFn$_invoke$arity$3(expr,cont,v_compare);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39043.prototype.emmy$expression$analyze$ICanonicalize$__GT_expression$arity$3 = (function (_,p,vars){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.factor.poly__GT_factored_expression.cljs$core$IFn$_invoke$arity$2(p,vars);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39043.prototype.emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$arity$2 = (function (_,o){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.analyzer.emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$arity$2(null,o);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39043.getBasis = (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"symgen","symgen",-880919559,null),new cljs.core.Symbol(null,"meta39044","meta39044",-619688672,null)], null);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39043.cljs$lang$type = true);

(emmy.polynomial.factor.t_emmy$polynomial$factor39043.cljs$lang$ctorStr = "emmy.polynomial.factor/t_emmy$polynomial$factor39043");

(emmy.polynomial.factor.t_emmy$polynomial$factor39043.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"emmy.polynomial.factor/t_emmy$polynomial$factor39043");
}));

/**
 * Positional factory function for emmy.polynomial.factor/t_emmy$polynomial$factor39043.
 */
emmy.polynomial.factor.__GT_t_emmy$polynomial$factor39043 = (function emmy$polynomial$factor$__GT_t_emmy$polynomial$factor39043(symgen,meta39044){
return (new emmy.polynomial.factor.t_emmy$polynomial$factor39043(symgen,meta39044));
});
...
return emmy.expression.analyze.make_analyzer.cljs$core$IFn$_invoke$arity$2((new emmy.polynomial.factor.t_emmy$polynomial$factor39043(symgen,cljs.core.PersistentArrayMap.EMPTY)),symgen);
})();
/**
...
var fact_exp = (function (){var G__39047 = cljs.core.first((emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1 ? emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1(expr) : emmy.numsymb.operands.call(null,expr)));
return (emmy.polynomial.factor.factor.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.factor.cljs$core$IFn$_invoke$arity$1(G__39047) : emmy.polynomial.factor.factor.call(null,G__39047));
})();
var expt = emmy.numsymb.symbolic_operator(new cljs.core.Symbol(null,"expt","expt",2123850345,null));
...
var G__39068 = (sqrt.cljs$core$IFn$_invoke$arity$1 ? sqrt.cljs$core$IFn$_invoke$arity$1(odds) : sqrt.call(null,odds));
var G__39069 = evens;
return (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(G__39068,G__39069) : _STAR_.call(null,G__39068,G__39069));
} else {
var vec__39070 = factors;
...
var f = first__39072;
var more = seq__39071__$1;
if(cljs.core.truth_(emmy.numsymb.expt_QMARK_(f))){
var vec__39073 = (emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1 ? emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1(f) : emmy.numsymb.operands.call(null,f));
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39073,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39073,(1),null);
if((!(even_QMARK_(e)))){
var G__39102 = more;
var G__39103 = (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(f,odds) : _STAR_.call(null,f,odds));
var G__39104 = evens;
factors = G__39102;
odds = G__39103;
evens = G__39104;
...
var G__39105 = more;
var G__39106 = odds;
var G__39107 = (function (){var power = cljs.core.quot(e,(2));
if((power > (1))){
var G__39079 = evens;
var G__39080 = (expt.cljs$core$IFn$_invoke$arity$2 ? expt.cljs$core$IFn$_invoke$arity$2(b,power) : expt.call(null,b,power));
return (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(G__39079,G__39080) : _STAR_.call(null,G__39079,G__39080));
} else {
...
var G__39108 = more;
var G__39109 = (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(f,odds) : _STAR_.call(null,f,odds));
var G__39110 = evens;
factors = G__39108;
odds = G__39109;
evens = G__39110;
