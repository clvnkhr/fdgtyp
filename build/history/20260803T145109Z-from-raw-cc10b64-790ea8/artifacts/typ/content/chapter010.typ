...
/* fdg-code-source: chapter010/001
(define (gradient metric basis)
  (compose (raise metric basis) d))
fdg-code-source-end */
#fdg-code-block("chapter010/001")

Let $theta$ be a one-form field:

$ theta = theta_x sans(d x) + theta_y sans(d y) + theta_z sans(d z) . $ <10.4>
...
/* fdg-code-source: chapter010/002
...
/* fdg-code-source: chapter010/004
...
/* fdg-code-source: chapter010/006
...
fdg-code-source-end */
#fdg-code-block("chapter010/006")

The geometry is specified by the metric:

/* fdg-code-source: chapter010/007
...
fdg-code-source-end */
#fdg-code-block("chapter010/010")

The curl is a bit complicated:

/* fdg-code-source: chapter010/011
((orthonormal-spherical-1form-basis
...
;;     r0))
fdg-code-source-end */
#fdg-code-block("chapter010/011")

But the divergence and Laplacian are simpler

/* fdg-code-source: chapter010/012
...
/* fdg-code-source: chapter010/013
(define SR R4-rect)
...
/* fdg-code-source: chapter010/014
(define (g-Minkowski u v)
  (+ (* -1 (dct u) (dct v))
     ...
     (* (dz u) (dz v))))
fdg-code-source-end */
#fdg-code-block("chapter010/014")

The length of a vector is described in terms of the metric:

$ sigma = sans(g) (sans(v)\,sans(v)). $ <10.12>
...
/* fdg-code-source: chapter010/015
...
;;       (down 0 0 0 1))
fdg-code-source-end */
#fdg-code-block("chapter010/017")

So, the Laplacian of a scalar field is the wave equation!

/* fdg-code-source: chapter010/018
...
/* fdg-code-source: chapter010/019
...
/* fdg-code-source: chapter010/020
...
/* fdg-code-source: chapter010/023
(define (J charge-density Ix Iy Iz)
  (- (* (/ 1 :c) (+ (* Ix dx) (* Iy dy) (* Iz dz)))
     (* charge-density dct)))
fdg-code-source-end */
#fdg-code-block("chapter010/023")
...
/* fdg-code-source: chapter010/024
(define F
...
/* fdg-code-source: chapter010/029
...
/* fdg-code-source: chapter010/030
(((- (d (SR-star F)) (* 4 :pi (SR-star 4-current)))
  d/dct d/dy d/dz)
 an-event)
...
/* fdg-code-source: chapter010/033
(define E
...
fdg-code-source-end */
#fdg-code-block("chapter010/033")

The 3-space force that results is a mess:

/* fdg-code-source: chapter010/034
...
fdg-code-source-end */
#fdg-code-block("chapter010/034")

The relativistic Lorentz 4-force is usually written in coordinates as

$ f^nu = - sum_(alpha\,mu) q U^mu F_(mu alpha) eta^(alpha nu)\, $ <10.28>
...
/* fdg-code-source: chapter010/035
...
/* fdg-code-source: chapter010/037
(define (Ux beta)
...
/* fdg-code-source: chapter010/038
((Force 'q F (Ux 'v/c) dct) an-event)
;; (/ (* q v/c (Ex (up ct0 x0 y0 z0)))
;;    (sqrt (+ 1 (* -1 (expt v/c 2)))))
fdg-code-source-end */
#fdg-code-block("chapter010/038")
