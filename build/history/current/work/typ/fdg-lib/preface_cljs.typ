...
#fdg-chapter(
  ...
  This edition of the book is a vibe-coded monstrosity created by a mathematician who can program predominantly in Python but not (yet?) in Scheme or Clojure(Script). It started from the #link("https://www.github.com/mentat-collective/fdg-book", "mentat-collective/fdg-book") by ... (see also the wonderful talks ...)
