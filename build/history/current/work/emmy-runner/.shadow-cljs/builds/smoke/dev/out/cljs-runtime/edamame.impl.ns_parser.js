...
var len__5897__auto___49523 = arguments.length;
var i__5898__auto___49524 = (0);
while(true){
if((i__5898__auto___49524 < len__5897__auto___49523)){
args__5903__auto__.push((arguments[i__5898__auto___49524]));

var G__49525 = (i__5898__auto___49524 + (1));
i__5898__auto___49524 = G__49525;
continue;
} else {
}
break;
...
/** @this {Function} */
(edamame.impl.ns_parser.load_lib.cljs$lang$applyTo = (function (seq49502){
...
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49503,G__49504,seq49502__$2);
}));
...
var vec__49507 = arg;
var seq__49508 = cljs.core.seq(vec__49507);
var first__49509 = cljs.core.first(seq__49508);
var seq__49508__$1 = cljs.core.next(seq__49508);
var prefix = first__49509;
var args_STAR___$2 = seq__49508__$1;
if((prefix == null)){
...
edamame.impl.ns_parser._ns = (function edamame$impl$ns_parser$_ns(p__49513){
...
var _ns = first__49516;
var first__49516__$1 = cljs.core.first(seq__49515__$1);
var seq__49515__$2 = cljs.core.next(seq__49515__$1);
var name = first__49516__$1;
var references = seq__49515__$2;
...
var requires = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__49510_SHARP_){
return edamame.impl.ns_parser.load_libs(new cljs.core.Keyword(null,"require","require",-468001333),cljs.core.rest(p1__49510_SHARP_));
