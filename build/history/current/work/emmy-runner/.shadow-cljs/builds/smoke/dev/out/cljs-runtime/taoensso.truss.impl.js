...
var ensure_set_26787 = taoensso.truss.impl.ensure_set;
taoensso.truss.impl.ks_EQ_ = (function taoensso$truss$impl$ks_EQ_(ks,m){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.set(cljs.core.keys(m)),(ensure_set_26787.cljs$core$IFn$_invoke$arity$1 ? ensure_set_26787.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_26787.call(null,ks)));
});

taoensso.truss.impl.ks_LT__EQ_ = (function taoensso$truss$impl$ks_LT__EQ_(ks,m){
return clojure.set.subset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_26787.cljs$core$IFn$_invoke$arity$1 ? ensure_set_26787.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_26787.call(null,ks)));
});

taoensso.truss.impl.ks_GT__EQ_ = (function taoensso$truss$impl$ks_GT__EQ_(ks,m){
return clojure.set.superset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_26787.cljs$core$IFn$_invoke$arity$1 ? ensure_set_26787.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_26787.call(null,ks)));
});

taoensso.truss.impl.ks_nnil_QMARK_ = (function taoensso$truss$impl$ks_nnil_QMARK_(ks,m){
return taoensso.truss.impl.revery_QMARK_((function (p1__26683_SHARP_){
return taoensso.truss.impl.some_QMARK_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,p1__26683_SHARP_));
}),ks);
});
...
}catch (e26692){if((e26692 instanceof Error)){
var _ = e26692;
return null;
} else {
throw e26692;
...
var vec__26701 = pred;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(0),null);
var a1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(1),null);
var a2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(2),null);
var a3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(3),null);
...
var vec__26715 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [self(a1),self(a2),self(a3)], null);
var vec__26718 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26715,(0),null);
var a1__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26718,(0),null);
var nt_a1_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26718,(1),null);
var vec__26721 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26715,(1),null);
var a2__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26721,(0),null);
var nt_a2_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26721,(1),null);
var vec__26724 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26715,(2),null);
var a3__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26724,(0),null);
var nt_a3_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26724,(1),null);
...
break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26736__$1))));
...
var G__26750 = (new cljs.core.Delay((function (){
...
return (error_fn.cljs$core$IFn$_invoke$arity$1 ? error_fn.cljs$core$IFn$_invoke$arity$1(G__26750) : error_fn.call(null,G__26750));
} else {
return null;
}
});
