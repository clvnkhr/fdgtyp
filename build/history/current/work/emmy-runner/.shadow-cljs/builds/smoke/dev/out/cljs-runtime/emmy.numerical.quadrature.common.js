...
emmy.numerical.quadrature.common.close_l = (function emmy$numerical$quadrature$common$close_l(p__54101){
var vec__54161 = p__54101;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54161,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54161,(1),null);
...
emmy.numerical.quadrature.common.close_r = (function emmy$numerical$quadrature$common$close_r(p__54291){
var vec__54292 = p__54291;
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54292,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54292,(1),null);
...
emmy.numerical.quadrature.common.open_l = (function emmy$numerical$quadrature$common$open_l(p__54298){
var vec__54299 = p__54298;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54299,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54299,(1),null);
...
emmy.numerical.quadrature.common.open_r = (function emmy$numerical$quadrature$common$open_r(p__54302){
var vec__54303 = p__54302;
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54303,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54303,(1),null);
...
emmy.numerical.quadrature.common.flip = (function emmy$numerical$quadrature$common$flip(p__54306){
var vec__54307 = p__54306;
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54307,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54307,(1),null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,k,(function (){var G__54317 = emmy.numerical.quadrature.common.interval(opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__54317) : f.call(null,G__54317));
})());
});
/**
...
var emmy$numerical$quadrature$common$make_integrator_fn_$_call__4 = (function (f,a,b,p__54327){
var map__54329 = p__54327;
var map__54329__$1 = cljs.core.__destructure_map(map__54329);
var opts = map__54329__$1;
var roundoff_cutoff = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__54329__$1,new cljs.core.Keyword(null,"roundoff-cutoff","roundoff-cutoff",1739938187),emmy.numerical.quadrature.common._STAR_roundoff_cutoff_STAR_);
...
emmy$numerical$quadrature$common$make_integrator_fn_$_call = function(f,a,b,p__54327){
switch(arguments.length){
case 3:
return emmy$numerical$quadrature$common$make_integrator_fn_$_call__3.call(this,f,a,b);
case 4:
return emmy$numerical$quadrature$common$make_integrator_fn_$_call__4.call(this,f,a,b,p__54327);
}
...
var vec__54337 = ((typeof cljs.core.first(body) === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(body),cljs.core.next(body)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,body], null));
var docstring = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54337,(0),null);
var body__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54337,(1),null);
var vec__54340 = ((cljs.core.map_QMARK_(cljs.core.first(body__$1)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(body__$1),cljs.core.next(body__$1)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,body__$1], null));
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54340,(0),null);
var body__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54340,(1),null);
...
var len__5897__auto___54367 = arguments.length;
var i__5898__auto___54368 = (0);
while(true){
if((i__5898__auto___54368 < len__5897__auto___54367)){
args__5903__auto__.push((arguments[i__5898__auto___54368]));

var G__54369 = (i__5898__auto___54368 + (1));
i__5898__auto___54368 = G__54369;
continue;
} else {
}
break;
...
var vec__54353 = emmy.numerical.quadrature.common.name_with_attributes.cljs$core$IFn$_invoke$arity$3(sym,body,meta);
var sym__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54353,(0),null);
var body__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54353,(1),null);
var map__54356 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,body__$1);
var map__54356__$1 = cljs.core.__destructure_map(map__54356);
var area_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54356__$1,new cljs.core.Keyword(null,"area-fn","area-fn",-1818898652));
var seq_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54356__$1,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231));
...
/** @this {Function} */
(emmy.numerical.quadrature.common.defintegrator.cljs$lang$applyTo = (function (seq54343){
var G__54344 = cljs.core.first(seq54343);
var seq54343__$1 = cljs.core.next(seq54343);
var G__54345 = cljs.core.first(seq54343__$1);
var seq54343__$2 = cljs.core.next(seq54343__$1);
var G__54346 = cljs.core.first(seq54343__$2);
var seq54343__$3 = cljs.core.next(seq54343__$2);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54344,G__54345,G__54346,seq54343__$3);
}));
