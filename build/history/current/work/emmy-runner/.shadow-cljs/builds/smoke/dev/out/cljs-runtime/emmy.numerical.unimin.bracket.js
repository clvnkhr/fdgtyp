 ...
 */
emmy.numerical.unimin.bracket.parabolic_pieces = (function emmy$numerical$unimin$bracket$parabolic_pieces(p__49162,p__49163,p__49164){
var vec__49165 = p__49162;
var xa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49165,(0),null);
var fa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49165,(1),null);
var vec__49168 = p__49163;
var xb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49168,(0),null);
var fb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49168,(1),null);
var vec__49171 = p__49164;
var xc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49171,(0),null);
var fc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49171,(1),null);
...
if(cljs.core.truth_((function (p1__49161_SHARP_){
return (cljs.core.second(p1__49161_SHARP_) >= (0));
}))){
} else {
throw (new Error("Assert failed: (fn* [p1__49161#] (>= (second p1__49161#) 0))"));
}
 ...
 */
emmy.numerical.unimin.bracket.parabolic_step = (function emmy$numerical$unimin$bracket$parabolic_step(a,p__49174,c){
var vec__49175 = p__49174;
var xb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49175,(0),null);
var b = vec__49175;
var two_eps = (2.0 * 1.0E-21);
var vec__49178 = emmy.numerical.unimin.bracket.parabolic_pieces(a,b,c);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49178,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49178,(1),null);
 ...
 *   the function.
 */
emmy.numerical.unimin.bracket.bracket_step_fn = (function emmy$numerical$unimin$bracket$bracket_step_fn(f,p__49181){
var map__49182 = p__49181;
var map__49182__$1 = cljs.core.__destructure_map(map__49182);
var grow_limit = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49182__$1,new cljs.core.Keyword(null,"grow-limit","grow-limit",2130208943),110.0);
return (function (a,p__49183,p__49184){
var vec__49185 = p__49183;
var xb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49185,(0),null);
var fb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49185,(1),null);
var b = vec__49185;
var vec__49188 = p__49184;
var xc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49188,(0),null);
var fc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49188,(1),null);
var c = vec__49188;
...
(emmy.numerical.unimin.bracket.bracket_min.cljs$core$IFn$_invoke$arity$2 = (function (f,p__49193){
var map__49194 = p__49193;
var map__49194__$1 = cljs.core.__destructure_map(map__49194);
var opts = map__49194__$1;
var xa = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49194__$1,new cljs.core.Keyword(null,"xa","xa",-251918777),0.0);
var xb = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49194__$1,new cljs.core.Keyword(null,"xb","xb",-1641297359),1.0);
var maxiter = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49194__$1,new cljs.core.Keyword(null,"maxiter","maxiter",-1867223754),(1000));
var maxfun = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49194__$1,new cljs.core.Keyword(null,"maxfun","maxfun",-50301814),(1000));
var vec__49195 = emmy.util.counted.cljs$core$IFn$_invoke$arity$1(f);
var f_counter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49195,(0),null);
var f__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49195,(1),null);
var step = emmy.numerical.unimin.bracket.bracket_step_fn(f__$1,opts);
var stop_fn = (function (_,p__49207,p__49208,iteration){
var vec__49209 = p__49207;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49209,(0),null);
var fb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49209,(1),null);
var vec__49212 = p__49208;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49212,(0),null);
var fc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49212,(1),null);
return (((iteration > maxiter)) || ((((cljs.core.deref(f_counter) > maxfun)) || ((fb <= fc)))));
});
var complete = (function (p__49215,b,p__49216,iterations){
var vec__49217 = p__49215;
var xa__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49217,(0),null);
var a = vec__49217;
var vec__49220 = p__49216;
var xc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49220,(0),null);
var c = vec__49220;
...
var vec__49198 = emmy.numerical.unimin.bracket.ascending_by(f__$1,xa,xb);
var vec__49201 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49198,(0),null);
var xb__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49201,(0),null);
var b = vec__49201;
var vec__49204 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49198,(1),null);
var xa__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49204,(0),null);
var a = vec__49204;
