...
var G__50283 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__50284 = n;
var G__50285 = cljs.core.nnext(bs);
var G__50286 = true;
ret = G__50283;
n = G__50284;
bs = G__50285;
seen_rest_QMARK_ = G__50286;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__50256_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5162__auto__ = mkns;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return cljs.core.namespace(p1__50256_SHARP_);
}
})(),cljs.core.name(p1__50256_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__50257_SHARP_){
...
return cljs.core.namespace(p1__50257_SHARP_);
}
})(),cljs.core.name(p1__50257_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__50258_SHARP_,p2__50259_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__50258_SHARP_,p2__50259_SHARP_,(function (){var fexpr__50268 = cljs.core.val(entry);
return (fexpr__50268.cljs$core$IFn$_invoke$arity$1 ? fexpr__50268.cljs$core$IFn$_invoke$arity$1(p2__50259_SHARP_) : fexpr__50268.call(null,p2__50259_SHARP_));
})());
...
var G__50298 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__50299 = cljs.core.next(bes);
ret = G__50298;
bes = G__50299;
continue;
} else {
...
var temp__5823__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50260_SHARP_){
return (cljs.core.first(p1__50260_SHARP_) instanceof cljs.core.Keyword);
}),bents));
