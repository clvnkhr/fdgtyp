...
var memo_count_38856 = cljs.core.count(cljs.core.deref(emmy.polynomial.gcd.gcd_memo));
if((memo_count_38856 > (0))){
var hits_38857 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_hit);
var misses_38858 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_miss);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [goog.string.format("GCD cache hit rate %.2f%% (%d entries)",((100) * (hits_38857 / (hits_38857 + misses_38858))),memo_count_38856)], null);
...
var len__5897__auto___38859 = arguments.length;
var i__5898__auto___38860 = (0);
while(true){
if((i__5898__auto___38860 < len__5897__auto___38859)){
args__5903__auto__.push((arguments[i__5898__auto___38860]));

var G__38861 = (i__5898__auto___38860 + (1));
i__5898__auto___38860 = G__38861;
continue;
} else {
}
break;
...
/** @this {Function} */
(emmy.polynomial.gcd.dbg.cljs$lang$applyTo = (function (seq38698){
...
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38699,G__38700,seq38698__$2);
}));
...
var vec__38707 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var ticks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38707,(0),null);
var units = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38707,(1),null);
...
var _STAR_poly_gcd_time_limit_STAR__orig_val__38712 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var _STAR_clock_STAR__orig_val__38713 = emmy.polynomial.gcd._STAR_clock_STAR_;
var _STAR_poly_gcd_time_limit_STAR__temp_val__38714 = timeout;
var _STAR_clock_STAR__temp_val__38715 = emmy.util.stopwatch.stopwatch();
(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__temp_val__38714);

(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__temp_val__38715);

try{return (thunk.cljs$core$IFn$_invoke$arity$0 ? thunk.cljs$core$IFn$_invoke$arity$0() : thunk.call(null));
}finally {(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__orig_val__38713);

(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__orig_val__38712);
}});
/**
...
if(cljs.core.truth_(and__5160__auto__)){
var G__38717 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [u,v], null);
var fexpr__38716 = cljs.core.deref(emmy.polynomial.gcd.gcd_memo);
return (fexpr__38716.cljs$core$IFn$_invoke$arity$1 ? fexpr__38716.cljs$core$IFn$_invoke$arity$1(G__38717) : fexpr__38716.call(null,G__38717));
} else {
return and__5160__auto__;
}
})();
...
var len__5897__auto___38873 = arguments.length;
var i__5898__auto___38874 = (0);
while(true){
if((i__5898__auto___38874 < len__5897__auto___38873)){
args_arr__5922__auto__.push((arguments[i__5898__auto___38874]));

var G__38875 = (i__5898__auto___38874 + (1));
i__5898__auto___38874 = G__38875;
continue;
} else {
}
break;
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$1 = (function (p__38728){
var vec__38729 = p__38728;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38729,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38729,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [u,v], null);
}));

(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$2 = (function (p__38732,f){
var vec__38733 = p__38732;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38733,(0),null);
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$3 = (function (p__38736,f1,f2){
var vec__38737 = p__38736;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38737,(0),null);
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$variadic = (function (p__38740,f1,f2,more){
...
var G__38744 = u;
var G__38745 = v;
var G__38746 = (function (u_SINGLEQUOTE_,v_SINGLEQUOTE_){
...
return (f1.cljs$core$IFn$_invoke$arity$3 ? f1.cljs$core$IFn$_invoke$arity$3(G__38744,G__38745,G__38746) : f1.call(null,G__38744,G__38745,G__38746));
}));

/** @this {Function} */
(emmy.polynomial.gcd.cont__GT_.cljs$lang$applyTo = (function (seq38720){
var G__38721 = cljs.core.first(seq38720);
var seq38720__$1 = cljs.core.next(seq38720);
var G__38722 = cljs.core.first(seq38720__$1);
var seq38720__$2 = cljs.core.next(seq38720__$1);
var G__38723 = cljs.core.first(seq38720__$2);
var seq38720__$3 = cljs.core.next(seq38720__$2);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38721,G__38722,G__38723,seq38720__$3);
}));
...
var vec__38749 = emmy.polynomial.gcd.terms__GT_sort_PLUS_unsort(cljs.core.into.cljs$core$IFn$_invoke$arity$2(l_terms,r_terms));
var sort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38749,(0),null);
var unsort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38749,(1),null);
return emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(unsort,(function (){var G__38753 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,u);
var G__38754 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,v);
return (continue$.cljs$core$IFn$_invoke$arity$2 ? continue$.cljs$core$IFn$_invoke$arity$2(G__38753,G__38754) : continue$.call(null,G__38753,G__38754));
})());
} else {
...
var primitive = (cljs.core.truth_(emmy.generic.one_QMARK_.cljs$core$IFn$_invoke$arity$1(content))?p:emmy.polynomial.map_coefficients((function (p1__38755_SHARP_){
return emmy.generic.exact_divide.cljs$core$IFn$_invoke$arity$2(p1__38755_SHARP_,content);
}),p));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [content,primitive], null);
}
});
...
var vec__38757 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(u,gcd);
var ku = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38757,(0),null);
var pu = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38757,(1),null);
var vec__38760 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(v,gcd);
var kv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38760,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38760,(1),null);
...
var vec__38786 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.bare_terms(m),(0));
var mono_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38786,(0),null);
var mono_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38786,(1),null);
...
var vec__38801 = emmy.polynomial.pseudo_remainder(u,v);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38801,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38801,(1),null);
if(cljs.core.truth_(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(r))){
return emmy.generic.abs.cljs$core$IFn$_invoke$arity$1(v);
} else {
var vec__38805 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(r,gcd);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38805,(0),null);
var prim = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38805,(1),null);
var G__38905 = v;
var G__38906 = prim;
u = G__38905;
v = G__38906;
