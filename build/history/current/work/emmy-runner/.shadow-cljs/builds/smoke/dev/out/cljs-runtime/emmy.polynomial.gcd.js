...
var memo_count_38860 = cljs.core.count(cljs.core.deref(emmy.polynomial.gcd.gcd_memo));
if((memo_count_38860 > (0))){
var hits_38861 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_hit);
var misses_38862 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_miss);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [goog.string.format("GCD cache hit rate %.2f%% (%d entries)",((100) * (hits_38861 / (hits_38861 + misses_38862))),memo_count_38860)], null);
...
/** @this {Function} */
(emmy.polynomial.gcd.dbg.cljs$lang$applyTo = (function (seq38705){
var G__38706 = cljs.core.first(seq38705);
var seq38705__$1 = cljs.core.next(seq38705);
var G__38707 = cljs.core.first(seq38705__$1);
var seq38705__$2 = cljs.core.next(seq38705__$1);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38706,G__38707,seq38705__$2);
}));
...
var vec__38716 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var ticks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38716,(0),null);
var units = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38716,(1),null);
...
var _STAR_poly_gcd_time_limit_STAR__orig_val__38721 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var _STAR_clock_STAR__orig_val__38722 = emmy.polynomial.gcd._STAR_clock_STAR_;
var _STAR_poly_gcd_time_limit_STAR__temp_val__38723 = timeout;
var _STAR_clock_STAR__temp_val__38724 = emmy.util.stopwatch.stopwatch();
(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__temp_val__38723);

(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__temp_val__38724);

try{return (thunk.cljs$core$IFn$_invoke$arity$0 ? thunk.cljs$core$IFn$_invoke$arity$0() : thunk.call(null));
}finally {(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__orig_val__38722);

(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__orig_val__38721);
}});
/**
...
if(cljs.core.truth_(and__5160__auto__)){
var G__38726 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [u,v], null);
var fexpr__38725 = cljs.core.deref(emmy.polynomial.gcd.gcd_memo);
return (fexpr__38725.cljs$core$IFn$_invoke$arity$1 ? fexpr__38725.cljs$core$IFn$_invoke$arity$1(G__38726) : fexpr__38725.call(null,G__38726));
} else {
return and__5160__auto__;
}
})();
...
var len__5897__auto___38870 = arguments.length;
var i__5898__auto___38871 = (0);
while(true){
if((i__5898__auto___38871 < len__5897__auto___38870)){
args_arr__5922__auto__.push((arguments[i__5898__auto___38871]));

var G__38874 = (i__5898__auto___38871 + (1));
i__5898__auto___38871 = G__38874;
continue;
} else {
}
break;
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$1 = (function (p__38741){
var vec__38742 = p__38741;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38742,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38742,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [u,v], null);
}));

(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$2 = (function (p__38745,f){
var vec__38746 = p__38745;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38746,(0),null);
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$3 = (function (p__38750,f1,f2){
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$variadic = (function (p__38754,f1,f2,more){
var vec__38755 = p__38754;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38755,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38755,(1),null);
var G__38758 = u;
var G__38759 = v;
var G__38760 = (function (u_SINGLEQUOTE_,v_SINGLEQUOTE_){
...
return (f1.cljs$core$IFn$_invoke$arity$3 ? f1.cljs$core$IFn$_invoke$arity$3(G__38758,G__38759,G__38760) : f1.call(null,G__38758,G__38759,G__38760));
}));

/** @this {Function} */
(emmy.polynomial.gcd.cont__GT_.cljs$lang$applyTo = (function (seq38729){
...
var G__38732 = cljs.core.first(seq38729__$2);
var seq38729__$3 = cljs.core.next(seq38729__$2);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38730,G__38731,G__38732,seq38729__$3);
}));
...
return emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(unsort,(function (){var G__38788 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,u);
var G__38789 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,v);
return (continue$.cljs$core$IFn$_invoke$arity$2 ? continue$.cljs$core$IFn$_invoke$arity$2(G__38788,G__38789) : continue$.call(null,G__38788,G__38789));
})());
} else {
...
var primitive = (cljs.core.truth_(emmy.generic.one_QMARK_.cljs$core$IFn$_invoke$arity$1(content))?p:emmy.polynomial.map_coefficients((function (p1__38792_SHARP_){
return emmy.generic.exact_divide.cljs$core$IFn$_invoke$arity$2(p1__38792_SHARP_,content);
}),p));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [content,primitive], null);
}
});
...
var vec__38809 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(u,gcd);
var ku = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38809,(0),null);
var pu = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38809,(1),null);
var vec__38812 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(v,gcd);
var kv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38812,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38812,(1),null);
...
var vec__38828 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.bare_terms(m),(0));
var mono_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38828,(0),null);
var mono_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38828,(1),null);
...
var vec__38833 = emmy.polynomial.pseudo_remainder(u,v);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38833,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38833,(1),null);
if(cljs.core.truth_(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(r))){
return emmy.generic.abs.cljs$core$IFn$_invoke$arity$1(v);
} else {
var vec__38836 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(r,gcd);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38836,(0),null);
var prim = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38836,(1),null);
var G__38894 = v;
var G__38895 = prim;
u = G__38894;
v = G__38895;
