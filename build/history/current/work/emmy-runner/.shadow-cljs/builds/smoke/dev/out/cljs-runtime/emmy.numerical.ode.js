 ...
 * segments.
 */
emmy.numerical.ode.stream_integrator = (function emmy$numerical$ode$stream_integrator(f_SINGLEQUOTE_,x0,y0,p__58824){
var map__58825 = p__58824;
var map__58825__$1 = cljs.core.__destructure_map(map__58825);
var epsilon = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58825__$1,new cljs.core.Keyword(null,"epsilon","epsilon",-730158570),1.0E-8);
var js_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58825__$1,new cljs.core.Keyword(null,"js?","js?",731848670),false);
 ...
 */
emmy.numerical.ode.make_integrator_STAR_ = (function emmy$numerical$ode$make_integrator_STAR_(state_derivative,derivative_args,initial_state,p__58854){
var map__58855 = p__58854;
var map__58855__$1 = cljs.core.__destructure_map(map__58855);
var opts = map__58855__$1;
var compile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58855__$1,new cljs.core.Keyword(null,"compile?","compile?",-826687650),true);
...
return emmy.numerical.ode.flatten_into_primitive_array((function (){var G__58867 = emmy.structure.unflatten.cljs$core$IFn$_invoke$arity$2(ys,initial_state);
return (f_SINGLEQUOTE_.cljs$core$IFn$_invoke$arity$1 ? f_SINGLEQUOTE_.cljs$core$IFn$_invoke$arity$1(G__58867) : f_SINGLEQUOTE_.call(null,G__58867));
})(),yps);
});
})()
);
...
var emmy$numerical$ode$make_integrator_$_call__4 = (function (initial_state,step_size,t,p__58889){
var map__58890 = p__58889;
var map__58890__$1 = cljs.core.__destructure_map(map__58890);
var opts = map__58890__$1;
var observe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58890__$1,new cljs.core.Keyword(null,"observe","observe",-86651450));
...
var array__GT_state = (function (p1__58883_SHARP_){
return emmy.structure.unflatten.cljs$core$IFn$_invoke$arity$2(p1__58883_SHARP_,initial_state);
});
var step = (function (x){
...
if(cljs.core.truth_(observe)){
var seq__58892_58923 = cljs.core.seq(cljs.core.range.cljs$core$IFn$_invoke$arity$3((0),t,step_size));
var chunk__58893_58924 = null;
var count__58894_58925 = (0);
var i__58895_58926 = (0);
while(true){
if((i__58895_58926 < count__58894_58925)){
var x_58927 = chunk__58893_58924.cljs$core$IIndexed$_nth$arity$2(null,i__58895_58926);
step(x_58927);


var G__58928 = seq__58892_58923;
var G__58929 = chunk__58893_58924;
var G__58930 = count__58894_58925;
var G__58931 = (i__58895_58926 + (1));
seq__58892_58923 = G__58928;
chunk__58893_58924 = G__58929;
count__58894_58925 = G__58930;
i__58895_58926 = G__58931;
continue;
} else {
var temp__5825__auto___58932 = cljs.core.seq(seq__58892_58923);
if(temp__5825__auto___58932){
var seq__58892_58933__$1 = temp__5825__auto___58932;
if(cljs.core.chunked_seq_QMARK_(seq__58892_58933__$1)){
var c__5694__auto___58934 = cljs.core.chunk_first(seq__58892_58933__$1);
var G__58935 = cljs.core.chunk_rest(seq__58892_58933__$1);
var G__58936 = c__5694__auto___58934;
var G__58937 = cljs.core.count(c__5694__auto___58934);
var G__58938 = (0);
seq__58892_58923 = G__58935;
chunk__58893_58924 = G__58936;
count__58894_58925 = G__58937;
i__58895_58926 = G__58938;
continue;
} else {
var x_58939 = cljs.core.first(seq__58892_58933__$1);
step(x_58939);


var G__58940 = cljs.core.next(seq__58892_58933__$1);
var G__58941 = null;
var G__58942 = (0);
var G__58943 = (0);
seq__58892_58923 = G__58940;
chunk__58893_58924 = G__58941;
count__58894_58925 = G__58942;
i__58895_58926 = G__58943;
continue;
}
} else {
}
...
emmy$numerical$ode$make_integrator_$_call = function(initial_state,step_size,t,p__58889){
switch(arguments.length){
case 3:
return emmy$numerical$ode$make_integrator_$_call__3.call(this,initial_state,step_size,t);
case 4:
return emmy$numerical$ode$make_integrator_$_call__4.call(this,initial_state,step_size,t,p__58889);
}
...
/** @this {Function} */
(emmy.numerical.ode.evolve.cljs$lang$applyTo = (function (seq58913){
...
try{return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(f,(function (){var iter__5649__auto__ = (function emmy$numerical$ode$integrate_state_derivative_$_iter__58916(s__58917){
...
var c__5647__auto__ = cljs.core.chunk_first(s__58917__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__58919 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__58918 = (0);
while(true){
if((i__58918 < size__5648__auto__)){
var x = cljs.core._nth(c__5647__auto__,i__58918);
if((x < (t1 + (dt / (2))))){
cljs.core.chunk_append(b__58919,x);

var G__58950 = (i__58918 + (1));
i__58918 = G__58950;
continue;
} else {
var G__58951 = (i__58918 + (1));
i__58918 = G__58951;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58919),emmy$numerical$ode$integrate_state_derivative_$_iter__58916(cljs.core.chunk_rest(s__58917__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58919),null);
}
} else {
var x = cljs.core.first(s__58917__$2);
if((x < (t1 + (dt / (2))))){
return cljs.core.cons(x,emmy$numerical$ode$integrate_state_derivative_$_iter__58916(cljs.core.rest(s__58917__$2)));
} else {
var G__58952 = cljs.core.rest(s__58917__$2);
s__58917__$1 = G__58952;
continue;
}
}
} else {
