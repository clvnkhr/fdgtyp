...
return Reflect.construct(constructor$,args.map((function (p1__51112_SHARP_){
return sci.impl.types.eval(p1__51112_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__51113_SHARP_){
return sci.impl.types.eval(p1__51113_SHARP_,ctx,bindings);
})));
});
...
if(cljs.core.truth_(temp__5823__auto__)){
var vec__51164 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51164,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51164,(1),null);
