...
var lib = first__21311;
var spec = seq__21310__$1;
var libspec__$1 = vec__21309;
var vec__21312 = cljs.core.split_with(cljs.core.complement(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"as-alias","as-alias",82482467),null], null), null)),spec);
var pre_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21312,(0),null);
var vec__21315 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21312,(1),null);
...
var _ = first__21317;
var first__21317__$1 = cljs.core.first(seq__21316__$1);
var seq__21316__$2 = cljs.core.next(seq__21316__$1);
var alias = first__21317__$1;
var post_spec = seq__21316__$2;
var post = vec__21315;
...
var G__21326 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"as-alias","as-alias",82482467),cljs.core.PersistentArrayMap.createAsIfByAssoc([alias,lib])], null);
if((cljs.core.count(libspec_SINGLEQUOTE_) > (1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21326,new cljs.core.Keyword(null,"libspec","libspec",1228503756),libspec_SINGLEQUOTE_);
} else {
return G__21326;
}
} else {
...
var vec__21346 = chunk__21331.cljs$core$IIndexed$_nth$arity$2(null,i__21333);
...
var G__21392 = seq__21330;
var G__21393 = chunk__21331;
var G__21394 = count__21332;
var G__21395 = (i__21333 + (1));
seq__21330 = G__21392;
chunk__21331 = G__21393;
count__21332 = G__21394;
i__21333 = G__21395;
continue;
} else {
...
var G__21396 = cljs.core.chunk_rest(seq__21330__$1);
var G__21397 = c__5694__auto__;
var G__21398 = cljs.core.count(c__5694__auto__);
var G__21399 = (0);
seq__21330 = G__21396;
chunk__21331 = G__21397;
count__21332 = G__21398;
i__21333 = G__21399;
continue;
} else {
var vec__21352 = cljs.core.first(seq__21330__$1);
var alias = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21352,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21352,(1),null);
if((!(cljs.core.contains_QMARK_(as_aliases,alias)))){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Duplicate :as-alias "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(alias)+", already in use for lib "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(as_aliases,alias))))+"\n"+"(not (contains? as-aliases alias))")));
}
...
var G__21401 = cljs.core.next(seq__21330__$1);
var G__21402 = null;
var G__21403 = (0);
var G__21404 = (0);
seq__21330 = G__21401;
chunk__21331 = G__21402;
count__21332 = G__21403;
i__21333 = G__21404;
continue;
}
} else {
