...
(def orthonormal-spherical-oneform-basis
  (vector-basis->dual orthonormal-spherical-vector-basis spherical))

(def orthonormal-spherical-basis
  (make-basis orthonormal-spherical-vector-basis orthonormal-spherical-oneform-basis))
