...
var memo_count_38858 = cljs.core.count(cljs.core.deref(emmy.polynomial.gcd.gcd_memo));
if((memo_count_38858 > (0))){
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [goog.string.format("GCD cache hit rate %.2f%% (%d entries)",((100) * (hits_38859 / (hits_38859 + misses_38860))),memo_count_38858)], null);
...
var len__5897__auto___38861 = arguments.length;
var i__5898__auto___38863 = (0);
while(true){
if((i__5898__auto___38863 < len__5897__auto___38861)){
args__5903__auto__.push((arguments[i__5898__auto___38863]));

var G__38865 = (i__5898__auto___38863 + (1));
i__5898__auto___38863 = G__38865;
continue;
} else {
}
break;
...
var vec__38708 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var ticks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38708,(0),null);
var units = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38708,(1),null);
...
var len__5897__auto___38877 = arguments.length;
var i__5898__auto___38878 = (0);
while(true){
if((i__5898__auto___38878 < len__5897__auto___38877)){
args_arr__5922__auto__.push((arguments[i__5898__auto___38878]));

var G__38879 = (i__5898__auto___38878 + (1));
i__5898__auto___38878 = G__38879;
continue;
} else {
}
break;
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$1 = (function (p__38729){
var vec__38730 = p__38729;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38730,(0),null);
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$2 = (function (p__38733,f){
var vec__38735 = p__38733;
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$3 = (function (p__38738,f1,f2){
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$variadic = (function (p__38742,f1,f2,more){
var vec__38743 = p__38742;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38743,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38743,(1),null);
var G__38746 = u;
var G__38747 = v;
var G__38748 = (function (u_SINGLEQUOTE_,v_SINGLEQUOTE_){
...
return (f1.cljs$core$IFn$_invoke$arity$3 ? f1.cljs$core$IFn$_invoke$arity$3(G__38746,G__38747,G__38748) : f1.call(null,G__38746,G__38747,G__38748));
}));
...
var vec__38751 = emmy.polynomial.gcd.terms__GT_sort_PLUS_unsort(cljs.core.into.cljs$core$IFn$_invoke$arity$2(l_terms,r_terms));
var sort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38751,(0),null);
var unsort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38751,(1),null);
return emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(unsort,(function (){var G__38754 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,u);
var G__38755 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,v);
return (continue$.cljs$core$IFn$_invoke$arity$2 ? continue$.cljs$core$IFn$_invoke$arity$2(G__38754,G__38755) : continue$.call(null,G__38754,G__38755));
})());
} else {
...
var primitive = (cljs.core.truth_(emmy.generic.one_QMARK_.cljs$core$IFn$_invoke$arity$1(content))?p:emmy.polynomial.map_coefficients((function (p1__38757_SHARP_){
return emmy.generic.exact_divide.cljs$core$IFn$_invoke$arity$2(p1__38757_SHARP_,content);
}),p));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [content,primitive], null);
}
});
...
var vec__38760 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(u,gcd);
var ku = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38760,(0),null);
var pu = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38760,(1),null);
var vec__38763 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(v,gcd);
var kv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38763,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38763,(1),null);
...
var vec__38780 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.bare_terms(m),(0));
var mono_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38780,(0),null);
var mono_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38780,(1),null);
...
var vec__38786 = emmy.polynomial.pseudo_remainder(u,v);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38786,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38786,(1),null);
if(cljs.core.truth_(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(r))){
return emmy.generic.abs.cljs$core$IFn$_invoke$arity$1(v);
} else {
var vec__38789 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(r,gcd);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38789,(0),null);
var prim = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38789,(1),null);
var G__38904 = v;
var G__38905 = prim;
u = G__38904;
v = G__38905;
