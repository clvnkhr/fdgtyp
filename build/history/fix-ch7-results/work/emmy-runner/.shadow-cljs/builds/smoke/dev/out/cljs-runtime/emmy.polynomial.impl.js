...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(emmy.polynomial.impl.exponents,comparator,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$iter__32546(s__32547){
return (new cljs.core.LazySeq(null,(function (){
var s__32547__$1 = s__32547;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32547__$1);
if(temp__5825__auto__){
var s__32547__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32547__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32547__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32549 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32548 = (0);
while(true){
if((i__32548 < size__5648__auto__)){
var vec__32560 = cljs.core._nth(c__5647__auto__,i__32548);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32560,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32560,(1),null);
...
cljs.core.chunk_append(b__32549,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum));

var G__32694 = (i__32548 + (1));
i__32548 = G__32694;
continue;
} else {
var G__32695 = (i__32548 + (1));
i__32548 = G__32695;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32549),emmy$polynomial$impl$iter__32546(cljs.core.chunk_rest(s__32547__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32549),null);
}
} else {
var vec__32574 = cljs.core.first(s__32547__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32574,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32574,(1),null);
var coef_sum = cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1(emmy.polynomial.impl.coefficient),emmy.generic._PLUS_,terms);
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(coef_sum))){
var expts__$1 = ((cljs.core.vector_QMARK_(expts))?emmy.polynomial.exponent.dense__GT_exponents(expts):((cljs.core.sorted_QMARK_(expts))?expts:((cljs.core.map_QMARK_(expts))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.empty,expts):emmy.util.illegal("Invalid inputs to sparse->terms TODO")
)));
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum),emmy$polynomial$impl$iter__32546(cljs.core.rest(s__32547__$2)));
} else {
var G__32701 = cljs.core.rest(s__32547__$2);
s__32547__$1 = G__32701;
continue;
}
}
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$map_coefficients_$_iter__32580(s__32581){
return (new cljs.core.LazySeq(null,(function (){
var s__32581__$1 = s__32581;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32581__$1);
if(temp__5825__auto__){
var s__32581__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32581__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32581__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32583 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32582 = (0);
while(true){
if((i__32582 < size__5648__auto__)){
var vec__32597 = cljs.core._nth(c__5647__auto__,i__32582);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32597,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32597,(1),null);
...
cljs.core.chunk_append(b__32583,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c));

var G__32711 = (i__32582 + (1));
i__32582 = G__32711;
continue;
} else {
var G__32712 = (i__32582 + (1));
i__32582 = G__32712;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32583),emmy$polynomial$impl$map_coefficients_$_iter__32580(cljs.core.chunk_rest(s__32581__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32583),null);
}
} else {
var vec__32612 = cljs.core.first(s__32581__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32612,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32612,(1),null);
var f_c = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(c) : f.call(null,c));
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(f_c))){
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c),emmy$polynomial$impl$map_coefficients_$_iter__32580(cljs.core.rest(s__32581__$2)));
} else {
var G__32715 = cljs.core.rest(s__32581__$2);
s__32581__$1 = G__32715;
continue;
}
}
} else {
 ...
 */
emmy.polynomial.impl.t_STAR_ts = (function emmy$polynomial$impl$t_STAR_ts(p__32646,v){
var vec__32650 = p__32646;
var tags = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32650,(0),null);
var coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32650,(1),null);
...
var vec__32653 = t;
var tags1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32653,(0),null);
var coeff1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32653,(1),null);
var G__32720 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.mul(tags,tags1),emmy.generic.mul.cljs$core$IFn$_invoke$arity$2(coeff,coeff1)));
var G__32721 = (i + (1));
acc = G__32720;
i = G__32721;
continue;
...
var vec__32661 = cljs.core.peek(v);
var vn_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32661,(0),null);
var vn_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32661,(1),null);
var good_QMARK_ = (function (p1__32660_SHARP_){
return emmy.polynomial.exponent.every_power_QMARK_(cljs.core.pos_QMARK_,p1__32660_SHARP_);
});
...
var vec__32667 = cljs.core.peek(remainder);
var r_exponents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32667,(0),null);
var r_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32667,(1),null);
...
var G__32730 = emmy.polynomial.impl.add(quotient,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_term], null));
var G__32731 = emmy.polynomial.impl.sub(remainder,emmy.polynomial.impl.t_STAR_ts(new_term,v));
quotient = G__32730;
remainder = G__32731;
continue;
} else {
