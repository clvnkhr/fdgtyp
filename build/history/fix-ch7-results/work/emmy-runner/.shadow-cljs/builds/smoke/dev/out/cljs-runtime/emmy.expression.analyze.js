...
var emmy$expression$analyze$ICanonicalize$expression__GT_$dyn_36953 = (function() {
var G__36954 = null;
var G__36954__3 = (function (analyzer,x,continue$){
...
var G__36954__4 = (function (analyzer,x,continue$,compare_fn){
var x__5519__auto__ = (((analyzer == null))?null:analyzer);
var m__5520__auto__ = (emmy.expression.analyze.expression__GT_[goog.typeOf(x__5519__auto__)]);
if((!((m__5520__auto__ == null)))){
...
G__36954 = function(analyzer,x,continue$,compare_fn){
switch(arguments.length){
case 3:
return G__36954__3.call(this,analyzer,x,continue$);
case 4:
return G__36954__4.call(this,analyzer,x,continue$,compare_fn);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__36954.cljs$core$IFn$_invoke$arity$3 = G__36954__3;
G__36954.cljs$core$IFn$_invoke$arity$4 = G__36954__4;
return G__36954;
})()
;
/**
...
return emmy$expression$analyze$ICanonicalize$expression__GT_$dyn_36953(analyzer,x,continue$);
}
}));
...
return emmy$expression$analyze$ICanonicalize$expression__GT_$dyn_36953(analyzer,x,continue$,compare_fn);
}
}));
...
var emmy$expression$analyze$ICanonicalize$__GT_expression$dyn_36959 = (function (analyzer,b,variables){
var x__5519__auto__ = (((analyzer == null))?null:analyzer);
...
return emmy$expression$analyze$ICanonicalize$__GT_expression$dyn_36959(analyzer,b,variables);
}
});

var emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$dyn_36961 = (function (analyzer,x){
var x__5519__auto__ = (((analyzer == null))?null:analyzer);
...
return emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$dyn_36961(analyzer,x);
}
});
...
var expr__GT_var = (function (){var G__36907 = cljs.core.PersistentArrayMap.EMPTY;
return (ref.cljs$core$IFn$_invoke$arity$1 ? ref.cljs$core$IFn$_invoke$arity$1(G__36907) : ref.call(null,G__36907));
})();
var var__GT_expr = (function (){var G__36908 = cljs.core.PersistentArrayMap.EMPTY;
return (ref.cljs$core$IFn$_invoke$arity$1 ? ref.cljs$core$IFn$_invoke$arity$1(G__36908) : ref.call(null,G__36908));
})();
...
return cljs.core.identity((function (){var temp__5823__auto__ = (function (){var fexpr__36924 = cljs.core.deref(expr__GT_var);
return (fexpr__36924.cljs$core$IFn$_invoke$arity$1 ? fexpr__36924.cljs$core$IFn$_invoke$arity$1(expr_k) : fexpr__36924.call(null,expr_k));
})();
...
var vcompare_36965 = emmy.expression.analyze.make_vcompare(emmy.expression.variables_in(expr));
cljs.core.reset_BANG_(compare_fn,vcompare_36965);

return ianalyze(expr);
});
var v_compare = (function emmy$expression$analyze$v_compare(v1,v2){
var fexpr__36925 = cljs.core.deref(compare_fn);
return (fexpr__36925.cljs$core$IFn$_invoke$arity$2 ? fexpr__36925.cljs$core$IFn$_invoke$arity$2(v1,v2) : fexpr__36925.call(null,v1,v2));
});
...
var temp__5823__auto__ = (function (){var fexpr__36927 = cljs.core.deref(expr__GT_var);
return (fexpr__36927.cljs$core$IFn$_invoke$arity$1 ? fexpr__36927.cljs$core$IFn$_invoke$arity$1(analyzed_expr) : fexpr__36927.call(null,analyzed_expr));
})();
if(cljs.core.truth_(temp__5823__auto__)){
var existing_expr = temp__5823__auto__;
return existing_expr;
...
var G__36928_36970 = expr__GT_var;
var G__36929_36971 = cljs.core.PersistentArrayMap.EMPTY;
(ref_set.cljs$core$IFn$_invoke$arity$2 ? ref_set.cljs$core$IFn$_invoke$arity$2(G__36928_36970,G__36929_36971) : ref_set.call(null,G__36928_36970,G__36929_36971));

var G__36930_36972 = var__GT_expr;
var G__36931_36973 = cljs.core.PersistentArrayMap.EMPTY;
(ref_set.cljs$core$IFn$_invoke$arity$2 ? ref_set.cljs$core$IFn$_invoke$arity$2(G__36930_36972,G__36931_36973) : ref_set.call(null,G__36930_36972,G__36931_36973));

return null;
});
var base_simplify = (function emmy$expression$analyze$base_simplify(expr){
if(cljs.core.truth_(unquoted_list_QMARK_(expr))){
return emmy.expression.analyze.expression__GT_(backend,expr,(function (p1__36899_SHARP_,p2__36900_SHARP_){
return emmy.expression.analyze.__GT_expression(backend,p1__36899_SHARP_,p2__36900_SHARP_);
}),v_compare);
} else {
return expr;
}
...
var _STAR_incremental_simplifier_STAR__orig_val__36937 = emmy.numsymb._STAR_incremental_simplifier_STAR_;
var _STAR_incremental_simplifier_STAR__temp_val__36938 = false;
(emmy.numsymb._STAR_incremental_simplifier_STAR_ = _STAR_incremental_simplifier_STAR__temp_val__36938);

try{return base_simplify(analyze(expr));
}finally {(emmy.numsymb._STAR_incremental_simplifier_STAR_ = _STAR_incremental_simplifier_STAR__orig_val__36937);
}});
...
var temp__5823__auto__ = (function (){var fexpr__36942 = cljs.core.deref(var__GT_expr);
return (fexpr__36942.cljs$core$IFn$_invoke$arity$1 ? fexpr__36942.cljs$core$IFn$_invoke$arity$1(expr) : fexpr__36942.call(null,expr));
})();
if(cljs.core.truth_(temp__5823__auto__)){
