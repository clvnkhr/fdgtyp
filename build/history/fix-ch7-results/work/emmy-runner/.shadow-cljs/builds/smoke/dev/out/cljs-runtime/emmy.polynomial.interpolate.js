...
var build_term = (function (i,p__32747){
var vec__32748 = p__32747;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32748,(0),null);
var fa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32748,(1),null);
var others = (function (){var iter__5649__auto__ = (function emmy$polynomial$interpolate$lagrange_$_iter__32754(s__32755){
return (new cljs.core.LazySeq(null,(function (){
var s__32755__$1 = s__32755;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32755__$1);
if(temp__5825__auto__){
var s__32755__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32755__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32755__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32757 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32756 = (0);
while(true){
if((i__32756 < size__5648__auto__)){
var j = cljs.core._nth(c__5647__auto__,i__32756);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(i,j)){
cljs.core.chunk_append(b__32757,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(points__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,(0)], null)));

var G__33010 = (i__32756 + (1));
i__32756 = G__33010;
continue;
} else {
var G__33011 = (i__32756 + (1));
i__32756 = G__33011;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32757),emmy$polynomial$interpolate$lagrange_$_iter__32754(cljs.core.chunk_rest(s__32755__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32757),null);
}
} else {
var j = cljs.core.first(s__32755__$2);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(i,j)){
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(points__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,(0)], null)),emmy$polynomial$interpolate$lagrange_$_iter__32754(cljs.core.rest(s__32755__$2)));
} else {
var G__33015 = cljs.core.rest(s__32755__$2);
s__32755__$1 = G__33015;
continue;
}
}
} else {
...
var p = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32734_SHARP_){
return emmy.generic._.cljs$core$IFn$_invoke$arity$2(x,p1__32734_SHARP_);
}),others));
var q = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32735_SHARP_){
return emmy.generic._.cljs$core$IFn$_invoke$arity$2(a,p1__32735_SHARP_);
}),others));
...
var vec__32796 = points__$1;
var vec__32799 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32796,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32799,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32799,(1),null);
return y;
} else {
var l_branch = cljs.core.pop(points__$1);
var r_branch = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(points__$1,(1));
var vec__32805 = cljs.core.first(points__$1);
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32805,(0),null);
var vec__32808 = cljs.core.peek(points__$1);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32808,(0),null);
 ...
 *   
 */
emmy.polynomial.interpolate.neville_prepare = (function emmy$polynomial$interpolate$neville_prepare(p__32821){
var vec__32825 = p__32821;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32825,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32825,(1),null);
...
var vec__32836 = p__32833;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32836,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32836,(1),null);
var pl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32836,(2),null);
var vec__32840 = p__32834;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32840,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32840,(1),null);
var pr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32840,(2),null);
...
return (function (p__32883,p__32884){
var vec__32886 = p__32883;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32886,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32886,(1),null);
var pl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32886,(2),null);
var vec__32889 = p__32884;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32889,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32889,(1),null);
var pr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32889,(2),null);
 ...
 */
emmy.polynomial.interpolate.mn_prepare = (function emmy$polynomial$interpolate$mn_prepare(p__32914){
var vec__32915 = p__32914;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32915,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32915,(1),null);
...
return (function (p__32922,p__32923){
...
return emmy.util.aggregate.scan.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__32935){
var vec__32937 = p__32935;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32937,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32937,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32937,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32937,(3),null);
return c;
}),row));
});
/**
...
G__33069 = function(prev_row,point){
switch(arguments.length){
case 0:
return G__33069__0.call(this);
case 1:
return G__33069__1.call(this,prev_row);
case 2:
return G__33069__2.call(this,prev_row,point);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__33069.cljs$core$IFn$_invoke$arity$0 = G__33069__0;
...
return cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__32972){
var vec__32973 = p__32972;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32973,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32973,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32973,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32973,(3),null);
return c;
