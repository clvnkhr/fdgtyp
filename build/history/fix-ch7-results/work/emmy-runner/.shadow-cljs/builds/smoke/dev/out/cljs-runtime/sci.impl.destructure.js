...
var G__50296 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__50297 = n;
var G__50298 = cljs.core.nnext(bs);
var G__50299 = true;
ret = G__50296;
n = G__50297;
bs = G__50298;
seen_rest_QMARK_ = G__50299;
continue;
} else {
...
})(),cljs.core.name(p1__50230_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__50231_SHARP_){
...
return cljs.core.namespace(p1__50231_SHARP_);
}
})(),cljs.core.name(p1__50231_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__50233_SHARP_,p2__50234_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__50233_SHARP_,p2__50234_SHARP_,(function (){var fexpr__50261 = cljs.core.val(entry);
return (fexpr__50261.cljs$core$IFn$_invoke$arity$1 ? fexpr__50261.cljs$core$IFn$_invoke$arity$1(p2__50234_SHARP_) : fexpr__50261.call(null,p2__50234_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__50262 = cljs.core.key(entry);
return (fexpr__50262.cljs$core$IFn$_invoke$arity$1 ? fexpr__50262.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__50262.call(null,bes));
})());
...
var G__50318 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__50319 = cljs.core.next(bes);
ret = G__50318;
bes = G__50319;
continue;
} else {
...
var temp__5823__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50235_SHARP_){
return (cljs.core.first(p1__50235_SHARP_) instanceof cljs.core.Keyword);
}),bents));
