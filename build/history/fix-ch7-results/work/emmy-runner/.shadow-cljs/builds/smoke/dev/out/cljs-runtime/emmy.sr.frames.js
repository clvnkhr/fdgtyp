...
emmy.sr.frames.coordinates__GT_event = (function emmy$sr$frames$coordinates__GT_event(ancestor_frame,_,p__59237){
var map__59238 = p__59237;
var map__59238__$1 = cljs.core.__destructure_map(map__59238);
var boost_direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59238__$1,new cljs.core.Keyword(null,"boost-direction","boost-direction",-1975902118));
var vc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59238__$1,new cljs.core.Keyword(null,"vc","vc",194349650));
var origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59238__$1,new cljs.core.Keyword(null,"origin","origin",1037372088));
...
emmy.sr.frames.event__GT_coordinates = (function emmy$sr$frames$event__GT_coordinates(ancestor_frame,this_frame,p__59249){
var map__59250 = p__59249;
var map__59250__$1 = cljs.core.__destructure_map(map__59250);
var boost_direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59250__$1,new cljs.core.Keyword(null,"boost-direction","boost-direction",-1975902118));
var vc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59250__$1,new cljs.core.Keyword(null,"vc","vc",194349650));
var origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59250__$1,new cljs.core.Keyword(null,"origin","origin",1037372088));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(emmy.calculus.frame.frame_owner(origin),ancestor_frame)){
} else {
throw (new Error("Assert failed: (= (cf/frame-owner origin) ancestor-frame)"));
}
...
var make_59277 = emmy.calculus.frame.frame_maker(emmy.sr.frames.coordinates__GT_event,emmy.sr.frames.event__GT_coordinates);
emmy.sr.frames.make_SR_frame = (function emmy$sr$frames$make_SR_frame(name,ancestor_frame,boost_direction,v_over_c,origin){
return make_59277(name,ancestor_frame,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"boost-direction","boost-direction",-1975902118),boost_direction,new cljs.core.Keyword(null,"vc","vc",194349650),v_over_c,new cljs.core.Keyword(null,"origin","origin",1037372088),origin], null));
});
