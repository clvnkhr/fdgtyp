...
var len__5897__auto___36537 = arguments.length;
var i__5898__auto___36539 = (0);
while(true){
if((i__5898__auto___36539 < len__5897__auto___36537)){
args__5903__auto__.push((arguments[i__5898__auto___36539]));

var G__36540 = (i__5898__auto___36539 + (1));
i__5898__auto___36539 = G__36540;
continue;
} else {
}
break;
...
var err_36544 = "Invalid Timbre logging level: should be e/o #{:trace :debug :info :warn :error :fatal :report}";
var level__GT_int_36545 = (function (p1__36154_SHARP_){
var G__36159 = p1__36154_SHARP_;
...
if(cljs.core.truth_(level__GT_int_36545(x))){
return true;
} else {
return false;
}
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(err_36544,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"given","given",716253602),x,new cljs.core.Keyword(null,"type","type",1174270348),cljs.core.type(x)], null));
}
});

taoensso.timbre.valid_level__GT_int = (function taoensso$timbre$valid_level__GT_int(x){
var or__5162__auto__ = level__GT_int_36545(x);
...
var valid_level__GT_int_36549 = taoensso.timbre.valid_level__GT_int;
/**
 * Implementation detail.
 */
taoensso.timbre.level_GT__EQ_ = (function taoensso$timbre$level_GT__EQ_(x,y){
return ((valid_level__GT_int_36549.cljs$core$IFn$_invoke$arity$1 ? valid_level__GT_int_36549.cljs$core$IFn$_invoke$arity$1(x) : valid_level__GT_int_36549.call(null,x)) >= (valid_level__GT_int_36549.cljs$core$IFn$_invoke$arity$1 ? valid_level__GT_int_36549.cljs$core$IFn$_invoke$arity$1(y) : valid_level__GT_int_36549.call(null,y)));
});
var fn_QMARK__36550 = cljs.core.fn_QMARK_;
var compile_36551 = taoensso.encore.fmemoize((function (x){
return taoensso.encore.compile_str_filter(x);
}));
var conform_QMARK__STAR__36552 = taoensso.encore.fmemoize((function (x,ns){
var fexpr__36194 = compile_36551(x);
return (fexpr__36194.cljs$core$IFn$_invoke$arity$1 ? fexpr__36194.cljs$core$IFn$_invoke$arity$1(ns) : fexpr__36194.call(null,ns));
}));
var conform_QMARK__36553 = (function (ns_filter,ns){
if(cljs.core.truth_((fn_QMARK__36550.cljs$core$IFn$_invoke$arity$1 ? fn_QMARK__36550.cljs$core$IFn$_invoke$arity$1(ns_filter) : fn_QMARK__36550.call(null,ns_filter)))){
return (ns_filter.cljs$core$IFn$_invoke$arity$1 ? ns_filter.cljs$core$IFn$_invoke$arity$1(ns) : ns_filter.call(null,ns));
} else {
return conform_QMARK__STAR__36552(ns_filter,ns);
}
});
/**
 * Implementation detail.
...
if(cljs.core.truth_(conform_QMARK__36553(ns_filter,ns))){
return true;
} else {
return false;
}
...
return taoensso.encore.rsome.cljs$core$IFn$_invoke$arity$2((function (p__36204){
var vec__36205 = p__36204;
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36205,(0),null);
var min_level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36205,(1),null);
if(cljs.core.truth_(conform_QMARK__STAR__36552(ns_pattern,ns))){
...
var valid_level_36556 = taoensso.timbre.valid_level;
var ns__GT__QMARK_min_level_36557 = taoensso.timbre.ns__GT__QMARK_min_level;
taoensso.timbre.get_min_level = (function taoensso$timbre$get_min_level(default$,x,ns){
var G__36214 = (function (){var or__5162__auto__ = ((cljs.core.vector_QMARK_(x))?ns__GT__QMARK_min_level_36557(x,ns):x);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return default$;
...
return (valid_level_36556.cljs$core$IFn$_invoke$arity$1 ? valid_level_36556.cljs$core$IFn$_invoke$arity$1(G__36214) : valid_level_36556.call(null,G__36214));
});
var leglist_36559 = (function (x){
if(cljs.core.truth_(x)){
if(cljs.core.truth_((function (){var fexpr__36218 = cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY,cljs.core.PersistentHashSet.EMPTY]);
return (fexpr__36218.cljs$core$IFn$_invoke$arity$1 ? fexpr__36218.cljs$core$IFn$_invoke$arity$1(x) : fexpr__36218.call(null,x));
})())){
return null;
} else {
return x;
...
var ns_whitelist__$1 = leglist_36559(ns_whitelist);
var ns_blacklist__$1 = leglist_36559(ns_blacklist);
...
var level_GT__EQ__36560 = taoensso.timbre.level_GT__EQ_;
var may_log_ns_QMARK__36561 = taoensso.timbre.may_log_ns_QMARK_;
var get_min_level_36562 = taoensso.timbre.get_min_level;
var legacy_ns_filter_36563 = taoensso.timbre.legacy_ns_filter;
/**
 * Implementation detail.
...
var min_level = (function (){var G__36242 = default_min_level;
var G__36243 = (function (){var or__5162__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"min-level","min-level",1634684919));
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
var G__36244 = _QMARK_ns_str;
return (get_min_level_36562.cljs$core$IFn$_invoke$arity$3 ? get_min_level_36562.cljs$core$IFn$_invoke$arity$3(G__36242,G__36243,G__36244) : get_min_level_36562.call(null,G__36242,G__36243,G__36244));
})();
if(cljs.core.truth_((level_GT__EQ__36560.cljs$core$IFn$_invoke$arity$2 ? level_GT__EQ__36560.cljs$core$IFn$_invoke$arity$2(level,min_level) : level_GT__EQ__36560.call(null,level,min_level)))){
...
var G__36245 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"ns-whitelist","ns-whitelist",-1717299774));
var G__36246 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"ns-blacklist","ns-blacklist",1957763142));
return (legacy_ns_filter_36563.cljs$core$IFn$_invoke$arity$2 ? legacy_ns_filter_36563.cljs$core$IFn$_invoke$arity$2(G__36245,G__36246) : legacy_ns_filter_36563.call(null,G__36245,G__36246));
}
})();
if(cljs.core.truth_(temp__5823__auto__)){
var ns_filter = temp__5823__auto__;
if(cljs.core.truth_((may_log_ns_QMARK__36561.cljs$core$IFn$_invoke$arity$2 ? may_log_ns_QMARK__36561.cljs$core$IFn$_invoke$arity$2(ns_filter,_QMARK_ns_str) : may_log_ns_QMARK__36561.call(null,ns_filter,_QMARK_ns_str)))){
return true;
} else {
return false;
}
...
var min_level_STAR___$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__36269){
var vec__36271 = p__36269;
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36271,(0),null);
var _pattern_min_level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36271,(1),null);
var entry = vec__36271;
...
var min_level_STAR___$2 = (function (){var temp__5823__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(min_level_STAR___$1),(1)))?(function (){var vec__36279 = min_level_STAR___$1;
var vec__36282 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36279,(0),null);
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36282,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36282,(1),null);
...
var map__36294 = timestamp_opts;
var map__36294__$1 = cljs.core.__destructure_map(map__36294);
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36294__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36307__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
var msg_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36307__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36307__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36307__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36307__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36307__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36307__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36307__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36307__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
 ...
 */
taoensso.timbre.default_output_msg_fn = (function taoensso$timbre$default_output_msg_fn(p__36330){
var map__36331 = p__36330;
var map__36331__$1 = cljs.core.__destructure_map(map__36331);
var data = map__36331__$1;
var msg_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36331__$1,new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822));
var _QMARK_msg_fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36331__$1,new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891));
var vargs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36331__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36331__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
var map__36333 = output_opts;
var map__36333__$1 = cljs.core.__destructure_map(map__36333);
var arg__GT_str_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36333__$1,new cljs.core.Keyword(null,"arg->str-fn","arg->str-fn",2064845310),taoensso.timbre.default_arg__GT_str_fn);
var G__36334 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__36334)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__36334)){
return taoensso.timbre.str_join.cljs$core$IFn$_invoke$arity$2(arg__GT_str_fn,vargs);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__36334)){
...
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36334))));
 ...
 */
taoensso.timbre.default_output_error_fn = (function taoensso$timbre$default_output_error_fn(p__36335){
var map__36336 = p__36335;
var map__36336__$1 = cljs.core.__destructure_map(map__36336);
var data = map__36336__$1;
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36336__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36336__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(nl)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(nl)+"Caused by:"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(nl)+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__36338 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data,new cljs.core.Keyword(null,"?err","?err",549653299),c);
return (taoensso.timbre.default_output_error_fn.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.default_output_error_fn.cljs$core$IFn$_invoke$arity$1(G__36338) : taoensso.timbre.default_output_error_fn.call(null,G__36338));
})()));
} else {
return null;
}
...
var vec__36344 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36344,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__36348 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36348,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__36359 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36359,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(fmt_msg_QMARK_)?taoensso.encore.vrest(vargs__$1):vargs__$1);
...
}catch (e36363){var t = e36363;
var map__36364 = data;
var map__36364__$1 = cljs.core.__destructure_map(map__36364);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36364__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36364__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36364__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36364__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
...
var instant_36588 = (new Date());
var context_36589 = taoensso.timbre._STAR_context_STAR_;
var vargs_36590 = cljs.core.deref(vargs_);
var vec__36373_36591 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_36590);
var _QMARK_err_36592__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36373_36591,(0),null);
var _QMARK_meta_36593 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36373_36591,(1),null);
var _QMARK_msg_fmt_36594 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36373_36591,(2),null);
var vargs_36595__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36373_36591,(3),null);
var data_36596 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__5162__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"spying?","spying?",1753444487),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891)],[instant_36588,spying_QMARK_,config,vargs_36595__$1,_QMARK_file,(function (){var fexpr__36379 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null);
return (fexpr__36379.cljs$core$IFn$_invoke$arity$1 ? fexpr__36379.cljs$core$IFn$_invoke$arity$1(level) : fexpr__36379.call(null,level));
})(),_QMARK_ns_str,level,msg_type,_QMARK_err_36592__$1,context_36589,_QMARK_line,(new cljs.core.Delay((function (){
return _QMARK_err_36592__$1;
}),null)),_QMARK_meta_36593,_QMARK_msg_fmt_36594]));
var _QMARK_data_36597 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_36596,cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"middleware","middleware",1462115504)));
var temp__5825__auto___36603 = _QMARK_data_36597;
if(cljs.core.truth_(temp__5825__auto___36603)){
var data_36604__$1 = temp__5825__auto___36603;
var map__36386_36605 = data_36604__$1;
var map__36386_36606__$1 = cljs.core.__destructure_map(map__36386_36605);
var vargs_36607__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36386_36606__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_36608__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_36604__$1,new cljs.core.Keyword(null,"vargs_","vargs_",552132148),(new cljs.core.Delay((function (){
return vargs_36607__$2;
}),null)));
var data_36609__$3 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_36608__$2,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
return taoensso.timbre.protected_fn("Timbre error when calling (msg-fn <data>)",taoensso.timbre.default_output_msg_fn)(data_36608__$2);
...
return cljs.core.hash((function (){var b2__28430__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_36593,new cljs.core.Keyword(null,"id","id",-1388402092));
if(cljs.core.truth_(b2__28430__auto__)){
var id = b2__28430__auto__;
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,callsite_id,level], null);
} else {
var b2__28430__auto____$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_36593,new cljs.core.Keyword(null,"id!","id!",218090956));
if(cljs.core.truth_(b2__28430__auto____$1)){
var id = b2__28430__auto____$1;
return id;
} else {
var b2__28430__auto____$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_36593,new cljs.core.Keyword(null,"hash","hash",-13781596));
if(cljs.core.truth_(b2__28430__auto____$2)){
var h = b2__28430__auto____$2;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [h,callsite_id,_QMARK_msg_fmt_36594,level], null);
} else {
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [vargs_36607__$2,callsite_id,_QMARK_msg_fmt_36594,level], null);
}
}
}
})());
}),null))], 0));
var get_timestamp_delay_36610 = (function (){var get_shared_delay = taoensso.encore.fmemoize((function (opts){
return (new cljs.core.Delay((function (){
return taoensso.timbre.get_timestamp(opts,cljs.core.get.cljs$core$IFn$_invoke$arity$2(data_36609__$3,new cljs.core.Keyword(null,"instant","instant",655498374)));
}),null));
}));
...
var get_output_fn_36611 = (function (){var base_fn = taoensso.encore.fmemoize(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
var base_output_opts_36612 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
...
return cljs.core.not((function (){var G__36400 = cljs.core.force(cljs.core.get.cljs$core$IFn$_invoke$arity$2(data_36609__$3,new cljs.core.Keyword(null,"hash_","hash_",-827203612)));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__36400) : rl_fn.call(null,G__36400));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__36405 = appender;
var map__36405__$1 = cljs.core.__destructure_map(map__36405);
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36405__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36405__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
var timestamp_ = get_timestamp_delay_36610(cljs.core.get.cljs$core$IFn$_invoke$arity$2(appender,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807)));
var output_fn = get_output_fn_36611(cljs.core.get.cljs$core$IFn$_invoke$arity$2(appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539)));
...
return base_output_opts_36612;
}
})();
var output_ = (new cljs.core.Delay((function (){
var G__36407 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(data_36609__$3,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"output-opts","output-opts",-793411325),output_opts], 0));
return (output_fn.cljs$core$IFn$_invoke$arity$1 ? output_fn.cljs$core$IFn$_invoke$arity$1(G__36407) : output_fn.call(null,G__36407));
}),null));
var data__$4 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(data_36609__$3,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325),output_opts,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_], null));
 ...
 */
taoensso.timbre.default_config = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"min-level","min-level",1634684919),new cljs.core.Keyword(null,"debug","debug",-1608172596),new cljs.core.Keyword(null,"ns-filter","ns-filter",108598448),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, ["*",null], null), null),new cljs.core.Keyword(null,"middleware","middleware",1462115504),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807),taoensso.timbre.default_timestamp_opts,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn,new cljs.core.Keyword(null,"appenders","appenders",1245583998),(((typeof window !== 'undefined'))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"console","console",1228072057),(function (){var G__36429 = cljs.core.PersistentArrayMap.EMPTY;
return (taoensso.timbre.console_appender.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.console_appender.cljs$core$IFn$_invoke$arity$1(G__36429) : taoensso.timbre.console_appender.call(null,G__36429));
})()], null):new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"println","println",1920840330),(function (){var G__36430 = cljs.core.PersistentArrayMap.EMPTY;
return (taoensso.timbre.println_appender.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.println_appender.cljs$core$IFn$_invoke$arity$1(G__36430) : taoensso.timbre.println_appender.call(null,G__36430));
})()], null))], null);
...
var args__5903__auto__ = [];
var len__5897__auto___36635 = arguments.length;
var i__5898__auto___36636 = (0);
while(true){
if((i__5898__auto___36636 < len__5897__auto___36635)){
args__5903__auto__.push((arguments[i__5898__auto___36636]));

var G__36637 = (i__5898__auto___36636 + (1));
i__5898__auto___36636 = G__36637;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq36442){
var self__5883__auto__ = this;
return self__5883__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36442));
}));


var ret__5952__auto___36639 = (function (){
taoensso.timbre.with_log_level = (function taoensso$timbre$with_log_level(var_args){
var args__5903__auto__ = [];
var len__5897__auto___36640 = arguments.length;
var i__5898__auto___36641 = (0);
while(true){
if((i__5898__auto___36641 < len__5897__auto___36640)){
args__5903__auto__.push((arguments[i__5898__auto___36641]));

var G__36643 = (i__5898__auto___36641 + (1));
i__5898__auto___36641 = G__36643;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.with_log_level.cljs$lang$applyTo = (function (seq36458){
var G__36459 = cljs.core.first(seq36458);
var seq36458__$1 = cljs.core.next(seq36458);
var G__36460 = cljs.core.first(seq36458__$1);
var seq36458__$2 = cljs.core.next(seq36458__$1);
var G__36461 = cljs.core.first(seq36458__$2);
var seq36458__$3 = cljs.core.next(seq36458__$2);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36459,G__36460,G__36461,seq36458__$3);
}));
...
var ret__5952__auto___36644 = (function (){
taoensso.timbre.with_logging_config = (function taoensso$timbre$with_logging_config(var_args){
var args__5903__auto__ = [];
var len__5897__auto___36645 = arguments.length;
var i__5898__auto___36646 = (0);
while(true){
if((i__5898__auto___36646 < len__5897__auto___36645)){
args__5903__auto__.push((arguments[i__5898__auto___36646]));

var G__36647 = (i__5898__auto___36646 + (1));
i__5898__auto___36646 = G__36647;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.with_logging_config.cljs$lang$applyTo = (function (seq36468){
...
var G__36471 = cljs.core.first(seq36468__$2);
var seq36468__$3 = cljs.core.next(seq36468__$2);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36469,G__36470,G__36471,seq36468__$3);
}));
...
var ret__5952__auto___36652 = (function (){
taoensso.timbre.logp = (function taoensso$timbre$logp(var_args){
var args__5903__auto__ = [];
var len__5897__auto___36653 = arguments.length;
var i__5898__auto___36654 = (0);
while(true){
if((i__5898__auto___36654 < len__5897__auto___36653)){
args__5903__auto__.push((arguments[i__5898__auto___36654]));

var G__36656 = (i__5898__auto___36654 + (1));
i__5898__auto___36654 = G__36656;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.logp.cljs$lang$applyTo = (function (seq36481){
var G__36483 = cljs.core.first(seq36481);
var seq36481__$1 = cljs.core.next(seq36481);
var G__36485 = cljs.core.first(seq36481__$1);
var seq36481__$2 = cljs.core.next(seq36481__$1);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36483,G__36485,seq36481__$2);
}));
...
var ret__5952__auto___36659 = (function (){
...
var ret__5952__auto___36670 = (function (){
/**
 * DEPRECATED, prefer `with-min-level`
 */
taoensso.timbre.with_level = (function taoensso$timbre$with_level(var_args){
var args__5903__auto__ = [];
var len__5897__auto___36672 = arguments.length;
var i__5898__auto___36673 = (0);
while(true){
if((i__5898__auto___36673 < len__5897__auto___36672)){
args__5903__auto__.push((arguments[i__5898__auto___36673]));

var G__36674 = (i__5898__auto___36673 + (1));
i__5898__auto___36673 = G__36674;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.with_level.cljs$lang$applyTo = (function (seq36506){
...
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36507,G__36508,G__36509,seq36506__$3);
}));
