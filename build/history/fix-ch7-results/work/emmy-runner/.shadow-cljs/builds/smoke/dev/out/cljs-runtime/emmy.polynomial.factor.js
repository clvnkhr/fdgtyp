...
var G__39013 = new_m;
var G__39014 = emmy.polynomial.evenly_divide(h,emmy.polynomial.mul(new_m,new_s));
var G__39015 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(tracker,doublefacts,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([singlefacts], 0));
var G__39016 = new_s;
var G__39017 = new_m;
m = G__39013;
h = G__39014;
 ...
 */
emmy.polynomial.factor.simplify_product = emmy.pattern.rule.rule_simplifier.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([emmy.simplify.rules.associative.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Symbol(null,"*","*",345799209,null)], 0)),emmy.simplify.rules.unary_elimination.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Symbol(null,"*","*",345799209,null)], 0)),emmy.simplify.rules.constant_elimination(new cljs.core.Symbol(null,"*","*",345799209,null),(1)),emmy.pattern.rule.rule_STAR_(emmy.pattern.rule.pattern_STAR_.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"*","*",345799209,null),null,(1),null)),emmy.pattern.rule._EQ__GT_),(function (G__38909){
...
var G__38915 = emmy.polynomial.__GT_expression(factor,vars);
return (simplify.cljs$core$IFn$_invoke$arity$1 ? simplify.cljs$core$IFn$_invoke$arity$1(G__38915) : simplify.call(null,G__38915));
}),emmy.polynomial.factor.split_polynomial(p));
var G__38916 = emmy.polynomial.factor.factors__GT_expression(factors);
return (emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1(G__38916) : emmy.polynomial.factor.simplify_product.call(null,G__38916));
}catch (e38913){if((e38913 instanceof Error)){
var _ = e38913;
...
var G__38914 = emmy.polynomial.__GT_expression(p,vars);
return (emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1(G__38914) : emmy.polynomial.factor.simplify_product.call(null,G__38914));
} else {
throw e38913;
...
var cont = (function (p1__38917_SHARP_,p2__38918_SHARP_){
return emmy.polynomial.factor.poly__GT_factored_expression.cljs$core$IFn$_invoke$arity$3(p1__38917_SHARP_,p2__38918_SHARP_,simplify);
});
...
*/
emmy.polynomial.factor.t_emmy$polynomial$factor38922 = (function (symgen,meta38923){
this.symgen = symgen;
this.meta38923 = meta38923;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(emmy.polynomial.factor.t_emmy$polynomial$factor38922.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38924,meta38923__$1){
var self__ = this;
var _38924__$1 = this;
return (new emmy.polynomial.factor.t_emmy$polynomial$factor38922(self__.symgen,meta38923__$1));
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor38922.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38924){
var self__ = this;
var _38924__$1 = this;
return self__.meta38923;
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor38922.prototype.emmy$expression$analyze$ICanonicalize$ = cljs.core.PROTOCOL_SENTINEL);

(emmy.polynomial.factor.t_emmy$polynomial$factor38922.prototype.emmy$expression$analyze$ICanonicalize$expression__GT_$arity$4 = (function (_,expr,cont,v_compare){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.expression__GT_.cljs$core$IFn$_invoke$arity$3(expr,cont,v_compare);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor38922.prototype.emmy$expression$analyze$ICanonicalize$__GT_expression$arity$3 = (function (_,p,vars){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.factor.poly__GT_factored_expression.cljs$core$IFn$_invoke$arity$2(p,vars);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor38922.prototype.emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$arity$2 = (function (_,o){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.analyzer.emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$arity$2(null,o);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor38922.getBasis = (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"symgen","symgen",-880919559,null),new cljs.core.Symbol(null,"meta38923","meta38923",-1568300776,null)], null);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor38922.cljs$lang$type = true);

(emmy.polynomial.factor.t_emmy$polynomial$factor38922.cljs$lang$ctorStr = "emmy.polynomial.factor/t_emmy$polynomial$factor38922");

(emmy.polynomial.factor.t_emmy$polynomial$factor38922.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"emmy.polynomial.factor/t_emmy$polynomial$factor38922");
}));

/**
 * Positional factory function for emmy.polynomial.factor/t_emmy$polynomial$factor38922.
 */
emmy.polynomial.factor.__GT_t_emmy$polynomial$factor38922 = (function emmy$polynomial$factor$__GT_t_emmy$polynomial$factor38922(symgen,meta38923){
return (new emmy.polynomial.factor.t_emmy$polynomial$factor38922(symgen,meta38923));
});
...
return emmy.expression.analyze.make_analyzer.cljs$core$IFn$_invoke$arity$2((new emmy.polynomial.factor.t_emmy$polynomial$factor38922(symgen,cljs.core.PersistentArrayMap.EMPTY)),symgen);
})();
/**
...
var fact_exp = (function (){var G__38939 = cljs.core.first((emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1 ? emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1(expr) : emmy.numsymb.operands.call(null,expr)));
return (emmy.polynomial.factor.factor.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.factor.cljs$core$IFn$_invoke$arity$1(G__38939) : emmy.polynomial.factor.factor.call(null,G__38939));
})();
var expt = emmy.numsymb.symbolic_operator(new cljs.core.Symbol(null,"expt","expt",2123850345,null));
...
var G__38979 = (sqrt.cljs$core$IFn$_invoke$arity$1 ? sqrt.cljs$core$IFn$_invoke$arity$1(odds) : sqrt.call(null,odds));
var G__38980 = evens;
return (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(G__38979,G__38980) : _STAR_.call(null,G__38979,G__38980));
} else {
var vec__38982 = factors;
...
var f = first__38984;
var more = seq__38983__$1;
if(cljs.core.truth_(emmy.numsymb.expt_QMARK_(f))){
var vec__38986 = (emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1 ? emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1(f) : emmy.numsymb.operands.call(null,f));
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38986,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38986,(1),null);
if((!(even_QMARK_(e)))){
var G__39055 = more;
var G__39056 = (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(f,odds) : _STAR_.call(null,f,odds));
var G__39057 = evens;
factors = G__39055;
odds = G__39056;
evens = G__39057;
...
var G__39058 = more;
var G__39059 = odds;
var G__39060 = (function (){var power = cljs.core.quot(e,(2));
if((power > (1))){
var G__38996 = evens;
var G__38997 = (expt.cljs$core$IFn$_invoke$arity$2 ? expt.cljs$core$IFn$_invoke$arity$2(b,power) : expt.call(null,b,power));
return (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(G__38996,G__38997) : _STAR_.call(null,G__38996,G__38997));
} else {
...
var G__39061 = more;
var G__39062 = (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(f,odds) : _STAR_.call(null,f,odds));
var G__39063 = evens;
factors = G__39061;
odds = G__39062;
evens = G__39063;
