...
var G__21390 = seq__21319;
var G__21391 = chunk__21320;
var G__21392 = count__21321;
var G__21393 = (i__21322 + (1));
seq__21319 = G__21390;
chunk__21320 = G__21391;
count__21321 = G__21392;
i__21322 = G__21393;
continue;
} else {
...
var G__21396 = cljs.core.chunk_rest(seq__21319__$1);
var G__21397 = c__5694__auto__;
var G__21398 = cljs.core.count(c__5694__auto__);
var G__21399 = (0);
seq__21319 = G__21396;
chunk__21320 = G__21397;
count__21321 = G__21398;
i__21322 = G__21399;
continue;
} else {
var vec__21343 = cljs.core.first(seq__21319__$1);
var alias = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21343,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21343,(1),null);
if((!(cljs.core.contains_QMARK_(as_aliases,alias)))){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Duplicate :as-alias "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(alias)+", already in use for lib "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(as_aliases,alias))))+"\n"+"(not (contains? as-aliases alias))")));
}
...
var map__21355 = cljs.analyzer.impl.namespaces.check_and_remove_as_alias(libspec);
var map__21355__$1 = cljs.core.__destructure_map(map__21355);
var as_alias = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21355__$1,new cljs.core.Keyword(null,"as-alias","as-alias",82482467));
var libspec__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21355__$1,new cljs.core.Keyword(null,"libspec","libspec",1228503756));
