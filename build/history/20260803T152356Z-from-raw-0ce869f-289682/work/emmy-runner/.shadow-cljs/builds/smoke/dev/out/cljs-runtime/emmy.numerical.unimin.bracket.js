 ...
 */
emmy.numerical.unimin.bracket.parabolic_pieces = (function emmy$numerical$unimin$bracket$parabolic_pieces(p__49165,p__49166,p__49167){
var vec__49168 = p__49165;
var xa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49168,(0),null);
var fa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49168,(1),null);
var vec__49171 = p__49166;
var xb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49171,(0),null);
var fb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49171,(1),null);
var vec__49174 = p__49167;
var xc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49174,(0),null);
var fc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49174,(1),null);
...
if(cljs.core.truth_((function (p1__49164_SHARP_){
return (cljs.core.second(p1__49164_SHARP_) >= (0));
}))){
} else {
throw (new Error("Assert failed: (fn* [p1__49164#] (>= (second p1__49164#) 0))"));
}
 ...
 */
emmy.numerical.unimin.bracket.parabolic_step = (function emmy$numerical$unimin$bracket$parabolic_step(a,p__49177,c){
var vec__49178 = p__49177;
var xb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49178,(0),null);
var b = vec__49178;
var two_eps = (2.0 * 1.0E-21);
var vec__49181 = emmy.numerical.unimin.bracket.parabolic_pieces(a,b,c);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49181,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49181,(1),null);
 ...
 *   the function.
 */
emmy.numerical.unimin.bracket.bracket_step_fn = (function emmy$numerical$unimin$bracket$bracket_step_fn(f,p__49187){
var map__49188 = p__49187;
var map__49188__$1 = cljs.core.__destructure_map(map__49188);
var grow_limit = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49188__$1,new cljs.core.Keyword(null,"grow-limit","grow-limit",2130208943),110.0);
return (function (a,p__49189,p__49190){
var vec__49191 = p__49189;
var xb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49191,(0),null);
var fb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49191,(1),null);
var b = vec__49191;
var vec__49194 = p__49190;
var xc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49194,(0),null);
var fc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49194,(1),null);
var c = vec__49194;
...
(emmy.numerical.unimin.bracket.bracket_min.cljs$core$IFn$_invoke$arity$2 = (function (f,p__49200){
var map__49201 = p__49200;
var map__49201__$1 = cljs.core.__destructure_map(map__49201);
var opts = map__49201__$1;
var xa = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49201__$1,new cljs.core.Keyword(null,"xa","xa",-251918777),0.0);
var xb = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49201__$1,new cljs.core.Keyword(null,"xb","xb",-1641297359),1.0);
var maxiter = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49201__$1,new cljs.core.Keyword(null,"maxiter","maxiter",-1867223754),(1000));
var maxfun = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49201__$1,new cljs.core.Keyword(null,"maxfun","maxfun",-50301814),(1000));
var vec__49202 = emmy.util.counted.cljs$core$IFn$_invoke$arity$1(f);
var f_counter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49202,(0),null);
var f__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49202,(1),null);
var step = emmy.numerical.unimin.bracket.bracket_step_fn(f__$1,opts);
var stop_fn = (function (_,p__49214,p__49215,iteration){
var vec__49216 = p__49214;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49216,(0),null);
var fb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49216,(1),null);
var vec__49219 = p__49215;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49219,(0),null);
var fc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49219,(1),null);
return (((iteration > maxiter)) || ((((cljs.core.deref(f_counter) > maxfun)) || ((fb <= fc)))));
});
var complete = (function (p__49222,b,p__49223,iterations){
var vec__49224 = p__49222;
var xa__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49224,(0),null);
var a = vec__49224;
var vec__49227 = p__49223;
var xc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49227,(0),null);
var c = vec__49227;
...
var vec__49205 = emmy.numerical.unimin.bracket.ascending_by(f__$1,xa,xb);
var vec__49208 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49205,(0),null);
var xb__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49208,(0),null);
var b = vec__49208;
var vec__49211 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49205,(1),null);
var xa__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49211,(0),null);
var a = vec__49211;
...
var G__49233 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,b,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [xc,fc], null)], null);
var vec__49234 = G__49233;
var a__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49234,(0),null);
var b__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49234,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49234,(2),null);
var iteration = (0);
var G__49233__$1 = G__49233;
var iteration__$1 = iteration;
while(true){
var vec__49240 = G__49233__$1;
var a__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49240,(0),null);
var b__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49240,(1),null);
var c__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49240,(2),null);
...
(emmy.numerical.unimin.bracket.bracket_min_scmutils.cljs$core$IFn$_invoke$arity$2 = (function (f,p__49248){
var map__49249 = p__49248;
var map__49249__$1 = cljs.core.__destructure_map(map__49249);
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49249__$1,new cljs.core.Keyword(null,"start","start",-355208981),(0));
var step = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49249__$1,new cljs.core.Keyword(null,"step","step",1288888124),(10));
var maxiter = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49249__$1,new cljs.core.Keyword(null,"maxiter","maxiter",-1867223754),(1000));
var vec__49250 = emmy.util.counted.cljs$core$IFn$_invoke$arity$1(f);
var f_counter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49250,(0),null);
var f__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49250,(1),null);
var stop_fn = (function (p__49262,p__49263,p__49264,iteration){
var vec__49265 = p__49262;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49265,(0),null);
var fa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49265,(1),null);
var vec__49268 = p__49263;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49268,(0),null);
var fb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49268,(1),null);
var vec__49271 = p__49264;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49271,(0),null);
var fc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49271,(1),null);
return (((iteration > maxiter)) || ((fb <= cljs.core.min.cljs$core$IFn$_invoke$arity$2(fa,fc))));
});
var complete = (function (p__49274,b,p__49275,iterations){
...
var run = (function (p__49282,b,p__49283,iter){
while(true){
var vec__49284 = p__49282;
var xa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49284,(0),null);
var a = vec__49284;
var vec__49287 = p__49283;
var xc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49287,(0),null);
var c = vec__49287;
...
var vec__49253 = emmy.numerical.unimin.bracket.ascending_by(f__$1,start,(start + step));
var vec__49256 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49253,(0),null);
var xb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49256,(0),null);
var b = vec__49256;
var vec__49259 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49253,(1),null);
var xa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49259,(0),null);
var a = vec__49259;
var xc = (xb + (xb - xa));
