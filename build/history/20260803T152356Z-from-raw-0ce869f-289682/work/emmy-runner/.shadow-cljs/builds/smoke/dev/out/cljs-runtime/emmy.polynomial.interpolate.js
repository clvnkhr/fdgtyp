...
var build_term = (function (i,p__32715){
var vec__32716 = p__32715;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32716,(0),null);
var fa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32716,(1),null);
var others = (function (){var iter__5649__auto__ = (function emmy$polynomial$interpolate$lagrange_$_iter__32719(s__32720){
return (new cljs.core.LazySeq(null,(function (){
var s__32720__$1 = s__32720;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32720__$1);
if(temp__5825__auto__){
var s__32720__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32720__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32720__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32722 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32721 = (0);
while(true){
if((i__32721 < size__5648__auto__)){
var j = cljs.core._nth(c__5647__auto__,i__32721);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(i,j)){
cljs.core.chunk_append(b__32722,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(points__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,(0)], null)));

var G__32932 = (i__32721 + (1));
i__32721 = G__32932;
continue;
} else {
var G__32933 = (i__32721 + (1));
i__32721 = G__32933;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32722),emmy$polynomial$interpolate$lagrange_$_iter__32719(cljs.core.chunk_rest(s__32720__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32722),null);
}
} else {
var j = cljs.core.first(s__32720__$2);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(i,j)){
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(points__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,(0)], null)),emmy$polynomial$interpolate$lagrange_$_iter__32719(cljs.core.rest(s__32720__$2)));
} else {
var G__32934 = cljs.core.rest(s__32720__$2);
s__32720__$1 = G__32934;
continue;
}
}
} else {
...
var p = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32712_SHARP_){
return emmy.generic._.cljs$core$IFn$_invoke$arity$2(x,p1__32712_SHARP_);
}),others));
var q = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32713_SHARP_){
return emmy.generic._.cljs$core$IFn$_invoke$arity$2(a,p1__32713_SHARP_);
}),others));
...
var vec__32763 = points__$1;
var vec__32766 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32763,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32766,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32766,(1),null);
return y;
} else {
var l_branch = cljs.core.pop(points__$1);
var r_branch = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(points__$1,(1));
var vec__32771 = cljs.core.first(points__$1);
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32771,(0),null);
var vec__32774 = cljs.core.peek(points__$1);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32774,(0),null);
 ...
 *   
 */
emmy.polynomial.interpolate.neville_prepare = (function emmy$polynomial$interpolate$neville_prepare(p__32790){
var vec__32793 = p__32790;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32793,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32793,(1),null);
...
return (function (p__32804,p__32805){
var vec__32809 = p__32804;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32809,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32809,(1),null);
var pl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32809,(2),null);
var vec__32812 = p__32805;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32812,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32812,(1),null);
var pr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32812,(2),null);
...
return (function (p__32858,p__32859){
var vec__32860 = p__32858;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32860,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32860,(1),null);
var pl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32860,(2),null);
var vec__32863 = p__32859;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32863,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32863,(1),null);
var pr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32863,(2),null);
 ...
 */
emmy.polynomial.interpolate.mn_prepare = (function emmy$polynomial$interpolate$mn_prepare(p__32889){
var vec__32890 = p__32889;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32890,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32890,(1),null);
...
return (function (p__32895,p__32896){
var vec__32898 = p__32895;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32898,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32898,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32898,(2),null);
var dl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32898,(3),null);
var vec__32901 = p__32896;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32901,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32901,(1),null);
var cr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32901,(2),null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32901,(3),null);
var diff = (cr - dl);
var den = (xl - xr);
var factor = (diff / den);
var c = (factor * (xl - x));
...
return emmy.util.aggregate.scan.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__32906){
var vec__32907 = p__32906;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32907,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32907,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32907,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32907,(3),null);
return c;
}),row));
});
/**
...
G__33006 = function(prev_row,point){
switch(arguments.length){
case 0:
return G__33006__0.call(this);
case 1:
return G__33006__1.call(this,prev_row);
case 2:
return G__33006__2.call(this,prev_row,point);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__33006.cljs$core$IFn$_invoke$arity$0 = G__33006__0;
...
return cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__32924){
var vec__32925 = p__32924;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32925,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32925,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32925,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32925,(3),null);
return c;
