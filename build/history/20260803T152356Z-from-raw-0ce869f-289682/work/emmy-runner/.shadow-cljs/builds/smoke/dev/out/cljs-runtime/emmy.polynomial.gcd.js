...
var memo_count_38852 = cljs.core.count(cljs.core.deref(emmy.polynomial.gcd.gcd_memo));
if((memo_count_38852 > (0))){
var hits_38859 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_hit);
var misses_38860 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_miss);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [goog.string.format("GCD cache hit rate %.2f%% (%d entries)",((100) * (hits_38859 / (hits_38859 + misses_38860))),memo_count_38852)], null);
...
var len__5897__auto___38863 = arguments.length;
var i__5898__auto___38864 = (0);
while(true){
if((i__5898__auto___38864 < len__5897__auto___38863)){
args__5903__auto__.push((arguments[i__5898__auto___38864]));

var G__38865 = (i__5898__auto___38864 + (1));
i__5898__auto___38864 = G__38865;
continue;
} else {
}
break;
...
/** @this {Function} */
(emmy.polynomial.gcd.dbg.cljs$lang$applyTo = (function (seq38685){
var G__38687 = cljs.core.first(seq38685);
var seq38685__$1 = cljs.core.next(seq38685);
var G__38688 = cljs.core.first(seq38685__$1);
var seq38685__$2 = cljs.core.next(seq38685__$1);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38687,G__38688,seq38685__$2);
}));
...
var vec__38710 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var ticks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38710,(0),null);
var units = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38710,(1),null);
...
var _STAR_poly_gcd_time_limit_STAR__orig_val__38713 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var _STAR_clock_STAR__orig_val__38714 = emmy.polynomial.gcd._STAR_clock_STAR_;
var _STAR_poly_gcd_time_limit_STAR__temp_val__38715 = timeout;
var _STAR_clock_STAR__temp_val__38716 = emmy.util.stopwatch.stopwatch();
(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__temp_val__38715);

(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__temp_val__38716);

try{return (thunk.cljs$core$IFn$_invoke$arity$0 ? thunk.cljs$core$IFn$_invoke$arity$0() : thunk.call(null));
}finally {(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__orig_val__38714);

(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__orig_val__38713);
}});
/**
...
if(cljs.core.truth_(and__5160__auto__)){
var G__38718 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [u,v], null);
var fexpr__38717 = cljs.core.deref(emmy.polynomial.gcd.gcd_memo);
...
var len__5897__auto___38880 = arguments.length;
var i__5898__auto___38881 = (0);
while(true){
if((i__5898__auto___38881 < len__5897__auto___38880)){
args_arr__5922__auto__.push((arguments[i__5898__auto___38881]));

var G__38882 = (i__5898__auto___38881 + (1));
i__5898__auto___38881 = G__38882;
continue;
} else {
}
break;
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$1 = (function (p__38748){
var vec__38751 = p__38748;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38751,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38751,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [u,v], null);
}));

(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$2 = (function (p__38758,f){
var vec__38761 = p__38758;
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$3 = (function (p__38766,f1,f2){
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$variadic = (function (p__38771,f1,f2,more){
var vec__38774 = p__38771;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38774,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38774,(1),null);
var G__38777 = u;
var G__38778 = v;
var G__38779 = (function (u_SINGLEQUOTE_,v_SINGLEQUOTE_){
...
return (f1.cljs$core$IFn$_invoke$arity$3 ? f1.cljs$core$IFn$_invoke$arity$3(G__38777,G__38778,G__38779) : f1.call(null,G__38777,G__38778,G__38779));
}));

/** @this {Function} */
(emmy.polynomial.gcd.cont__GT_.cljs$lang$applyTo = (function (seq38731){
var G__38732 = cljs.core.first(seq38731);
var seq38731__$1 = cljs.core.next(seq38731);
var G__38733 = cljs.core.first(seq38731__$1);
var seq38731__$2 = cljs.core.next(seq38731__$1);
var G__38734 = cljs.core.first(seq38731__$2);
var seq38731__$3 = cljs.core.next(seq38731__$2);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38732,G__38733,G__38734,seq38731__$3);
}));
...
var vec__38784 = emmy.polynomial.gcd.terms__GT_sort_PLUS_unsort(cljs.core.into.cljs$core$IFn$_invoke$arity$2(l_terms,r_terms));
var sort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38784,(0),null);
var unsort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38784,(1),null);
return emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(unsort,(function (){var G__38787 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,u);
var G__38788 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,v);
return (continue$.cljs$core$IFn$_invoke$arity$2 ? continue$.cljs$core$IFn$_invoke$arity$2(G__38787,G__38788) : continue$.call(null,G__38787,G__38788));
})());
} else {
...
var primitive = (cljs.core.truth_(emmy.generic.one_QMARK_.cljs$core$IFn$_invoke$arity$1(content))?p:emmy.polynomial.map_coefficients((function (p1__38789_SHARP_){
return emmy.generic.exact_divide.cljs$core$IFn$_invoke$arity$2(p1__38789_SHARP_,content);
}),p));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [content,primitive], null);
}
});
...
var vec__38792 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(u,gcd);
var ku = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38792,(0),null);
var pu = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38792,(1),null);
var vec__38795 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(v,gcd);
var kv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38795,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38795,(1),null);
...
var vec__38807 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.bare_terms(m),(0));
var mono_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38807,(0),null);
var mono_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38807,(1),null);
...
var vec__38811 = emmy.polynomial.pseudo_remainder(u,v);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38811,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38811,(1),null);
if(cljs.core.truth_(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(r))){
return emmy.generic.abs.cljs$core$IFn$_invoke$arity$1(v);
} else {
var vec__38817 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(r,gcd);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38817,(0),null);
var prim = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38817,(1),null);
var G__38915 = v;
var G__38916 = prim;
u = G__38915;
v = G__38916;
