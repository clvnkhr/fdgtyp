...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__21367){
var map__21368 = p__21367;
var map__21368__$1 = cljs.core.__destructure_map(map__21368);
var ast = map__21368__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21368__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
...
if(cljs.core.truth_((function (){var fexpr__21373 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"var","var",-769682797),null,new cljs.core.Keyword(null,"local","local",-1497766724),null], null), null);
return (fexpr__21373.cljs$core$IFn$_invoke$arity$1 ? fexpr__21373.cljs$core$IFn$_invoke$arity$1(op) : fexpr__21373.call(null,op));
})())){
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__21386_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__21386_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__21389 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"locals","locals",535295783)], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__21389,local);
} else {
return G__21389;
}
});
...
var map__21395 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__21395__$1 = cljs.core.__destructure_map(map__21395);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21395__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21395__$1,new cljs.core.Keyword(null,"name","name",1843675177));
