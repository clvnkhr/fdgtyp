...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(emmy.polynomial.impl.exponents,comparator,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$iter__32537(s__32538){
return (new cljs.core.LazySeq(null,(function (){
var s__32538__$1 = s__32538;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32538__$1);
if(temp__5825__auto__){
var s__32538__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32538__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32538__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32540 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32539 = (0);
while(true){
if((i__32539 < size__5648__auto__)){
var vec__32546 = cljs.core._nth(c__5647__auto__,i__32539);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32546,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32546,(1),null);
...
cljs.core.chunk_append(b__32540,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum));

var G__32691 = (i__32539 + (1));
i__32539 = G__32691;
continue;
} else {
var G__32692 = (i__32539 + (1));
i__32539 = G__32692;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32540),emmy$polynomial$impl$iter__32537(cljs.core.chunk_rest(s__32538__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32540),null);
}
} else {
var vec__32556 = cljs.core.first(s__32538__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32556,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32556,(1),null);
var coef_sum = cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1(emmy.polynomial.impl.coefficient),emmy.generic._PLUS_,terms);
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(coef_sum))){
var expts__$1 = ((cljs.core.vector_QMARK_(expts))?emmy.polynomial.exponent.dense__GT_exponents(expts):((cljs.core.sorted_QMARK_(expts))?expts:((cljs.core.map_QMARK_(expts))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.empty,expts):emmy.util.illegal("Invalid inputs to sparse->terms TODO")
)));
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum),emmy$polynomial$impl$iter__32537(cljs.core.rest(s__32538__$2)));
} else {
var G__32695 = cljs.core.rest(s__32538__$2);
s__32538__$1 = G__32695;
continue;
}
}
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$map_coefficients_$_iter__32560(s__32561){
return (new cljs.core.LazySeq(null,(function (){
var s__32561__$1 = s__32561;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32561__$1);
if(temp__5825__auto__){
var s__32561__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32561__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32561__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32563 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32562 = (0);
while(true){
if((i__32562 < size__5648__auto__)){
var vec__32565 = cljs.core._nth(c__5647__auto__,i__32562);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32565,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32565,(1),null);
...
cljs.core.chunk_append(b__32563,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c));

var G__32703 = (i__32562 + (1));
i__32562 = G__32703;
continue;
} else {
var G__32704 = (i__32562 + (1));
i__32562 = G__32704;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32563),emmy$polynomial$impl$map_coefficients_$_iter__32560(cljs.core.chunk_rest(s__32561__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32563),null);
}
} else {
var vec__32568 = cljs.core.first(s__32561__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32568,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32568,(1),null);
var f_c = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(c) : f.call(null,c));
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(f_c))){
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c),emmy$polynomial$impl$map_coefficients_$_iter__32560(cljs.core.rest(s__32561__$2)));
} else {
var G__32709 = cljs.core.rest(s__32561__$2);
s__32561__$1 = G__32709;
continue;
}
}
} else {
 ...
 */
emmy.polynomial.impl.t_STAR_ts = (function emmy$polynomial$impl$t_STAR_ts(p__32590,v){
var vec__32592 = p__32590;
var tags = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32592,(0),null);
var coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32592,(1),null);
...
var vec__32599 = t;
var tags1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32599,(0),null);
var coeff1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32599,(1),null);
var G__32726 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.mul(tags,tags1),emmy.generic.mul.cljs$core$IFn$_invoke$arity$2(coeff,coeff1)));
var G__32727 = (i + (1));
acc = G__32726;
i = G__32727;
continue;
...
var vec__32640 = cljs.core.peek(v);
var vn_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32640,(0),null);
var vn_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32640,(1),null);
var good_QMARK_ = (function (p1__32639_SHARP_){
return emmy.polynomial.exponent.every_power_QMARK_(cljs.core.pos_QMARK_,p1__32639_SHARP_);
});
...
var vec__32648 = cljs.core.peek(remainder);
var r_exponents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32648,(0),null);
var r_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32648,(1),null);
...
var G__32750 = emmy.polynomial.impl.add(quotient,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_term], null));
var G__32751 = emmy.polynomial.impl.sub(remainder,emmy.polynomial.impl.t_STAR_ts(new_term,v));
quotient = G__32750;
remainder = G__32751;
continue;
} else {
