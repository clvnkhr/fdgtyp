...
if ((coordinateCurvatureChecks.match(/^\(simplify /gm) ?? []).length !== 2
  ...
  throw new Error("chapter008-012 must explain the two explicit simplify calls once, before both checks");
}
