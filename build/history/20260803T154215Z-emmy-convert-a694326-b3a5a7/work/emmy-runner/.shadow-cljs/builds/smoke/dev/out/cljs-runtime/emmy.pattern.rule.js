...
/** @this {Function} */
(emmy.pattern.rule.choice.cljs$lang$applyTo = (function (seq36642){
var G__36643 = cljs.core.first(seq36642);
var seq36642__$1 = cljs.core.next(seq36642);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36643,seq36642__$1);
}));
...
/** @this {Function} */
(emmy.pattern.rule.pipe.cljs$lang$applyTo = (function (seq36669){
var G__36670 = cljs.core.first(seq36669);
var seq36669__$1 = cljs.core.next(seq36669);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36670,seq36669__$1);
}));
...
return emmy.pattern.rule.as_attempt((function (data){
while(true){
var data_STAR_ = (function (){var fexpr__36710 = emmy.pattern.rule.attempt(r);
return (fexpr__36710.cljs$core$IFn$_invoke$arity$1 ? fexpr__36710.cljs$core$IFn$_invoke$arity$1(data) : fexpr__36710.call(null,data));
})();
if(cljs.core.truth_((f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(data,data_STAR_) : f.call(null,data,data_STAR_)))){
return data_STAR_;
} else {
...
return (function (data){
var G__36720_36780 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"in","in",-1531184865),data], null);
(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__36720_36780) : f.call(null,G__36720_36780));

var result = (r.cljs$core$IFn$_invoke$arity$1 ? r.cljs$core$IFn$_invoke$arity$1(data) : r.call(null,data));
var G__36722_36781 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"out","out",-910545517),result], null);
(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__36722_36781) : f.call(null,G__36722_36781));
...
var G__36730 = emmy.pattern.rule.try_subexpressions(emmy$pattern$rule$bottom_up_$_rec,expression);
return (r.cljs$core$IFn$_invoke$arity$1 ? r.cljs$core$IFn$_invoke$arity$1(G__36730) : r.call(null,G__36730));
}));
});
/**
 * Given some rule `the-rule`, returns a new rule that accepts potentially nested
...
var G__36734 = emmy.pattern.rule.try_subexpressions(emmy$pattern$rule$top_down_$_rec,(r.cljs$core$IFn$_invoke$arity$1 ? r.cljs$core$IFn$_invoke$arity$1(expr) : r.call(null,expr)));
return (r.cljs$core$IFn$_invoke$arity$1 ? r.cljs$core$IFn$_invoke$arity$1(G__36734) : r.call(null,G__36734));
}));
});
/**
...
var fexpr__36743 = cljs.core.deref(rec);
return (fexpr__36743.cljs$core$IFn$_invoke$arity$1 ? fexpr__36743.cljs$core$IFn$_invoke$arity$1(answer) : fexpr__36743.call(null,answer));
}
});
