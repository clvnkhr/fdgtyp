...
cljs.analyzer.passes.lite.update_var = (function cljs$analyzer$passes$lite$update_var(p__21292){
var map__21294 = p__21292;
var map__21294__$1 = cljs.core.__destructure_map(map__21294);
var ast = map__21294__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21294__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
return cljs.analyzer.passes.lite.update_var(G__21306);
} else {
return G__21306;
}
});
