...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_22053 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_22053(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_22058 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_22058(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22060 = (function (reader,ch){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22060(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22064 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22064(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22070 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22070(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22073 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22073(reader);
}
});
