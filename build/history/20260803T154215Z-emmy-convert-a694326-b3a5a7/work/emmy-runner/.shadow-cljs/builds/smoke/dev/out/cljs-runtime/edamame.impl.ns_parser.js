...
var len__5897__auto___49559 = arguments.length;
var i__5898__auto___49560 = (0);
while(true){
if((i__5898__auto___49560 < len__5897__auto___49559)){
args__5903__auto__.push((arguments[i__5898__auto___49560]));

var G__49561 = (i__5898__auto___49560 + (1));
i__5898__auto___49560 = G__49561;
continue;
} else {
}
break;
...
/** @this {Function} */
(edamame.impl.ns_parser.load_lib.cljs$lang$applyTo = (function (seq49518){
var G__49519 = cljs.core.first(seq49518);
var seq49518__$1 = cljs.core.next(seq49518);
var G__49520 = cljs.core.first(seq49518__$1);
var seq49518__$2 = cljs.core.next(seq49518__$1);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49519,G__49520,seq49518__$2);
}));
...
var vec__49533 = arg;
var seq__49534 = cljs.core.seq(vec__49533);
var first__49535 = cljs.core.first(seq__49534);
var seq__49534__$1 = cljs.core.next(seq__49534);
var prefix = first__49535;
var args_STAR___$2 = seq__49534__$1;
if((prefix == null)){
...
edamame.impl.ns_parser._ns = (function edamame$impl$ns_parser$_ns(p__49541){
var vec__49542 = p__49541;
var seq__49543 = cljs.core.seq(vec__49542);
var first__49544 = cljs.core.first(seq__49543);
var seq__49543__$1 = cljs.core.next(seq__49543);
var _ns = first__49544;
var first__49544__$1 = cljs.core.first(seq__49543__$1);
var seq__49543__$2 = cljs.core.next(seq__49543__$1);
var name = first__49544__$1;
var references = seq__49543__$2;
...
var requires = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__49536_SHARP_){
return edamame.impl.ns_parser.load_libs(new cljs.core.Keyword(null,"require","require",-468001333),cljs.core.rest(p1__49536_SHARP_));
