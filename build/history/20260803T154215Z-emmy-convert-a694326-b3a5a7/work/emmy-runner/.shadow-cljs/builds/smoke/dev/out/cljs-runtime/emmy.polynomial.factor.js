...
var G__39080 = new_m;
var G__39081 = emmy.polynomial.evenly_divide(h,emmy.polynomial.mul(new_m,new_s));
var G__39082 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(tracker,doublefacts,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([singlefacts], 0));
var G__39083 = new_s;
var G__39084 = new_m;
m = G__39080;
h = G__39081;
 ...
 */
emmy.polynomial.factor.simplify_product = emmy.pattern.rule.rule_simplifier.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([emmy.simplify.rules.associative.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Symbol(null,"*","*",345799209,null)], 0)),emmy.simplify.rules.unary_elimination.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Symbol(null,"*","*",345799209,null)], 0)),emmy.simplify.rules.constant_elimination(new cljs.core.Symbol(null,"*","*",345799209,null),(1)),emmy.pattern.rule.rule_STAR_(emmy.pattern.rule.pattern_STAR_.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"*","*",345799209,null),null,(1),null)),emmy.pattern.rule._EQ__GT_),(function (G__38992){
...
var G__39000 = emmy.polynomial.__GT_expression(factor,vars);
return (simplify.cljs$core$IFn$_invoke$arity$1 ? simplify.cljs$core$IFn$_invoke$arity$1(G__39000) : simplify.call(null,G__39000));
}),emmy.polynomial.factor.split_polynomial(p));
var G__39001 = emmy.polynomial.factor.factors__GT_expression(factors);
return (emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1(G__39001) : emmy.polynomial.factor.simplify_product.call(null,G__39001));
}catch (e38998){if((e38998 instanceof Error)){
var _ = e38998;
...
var G__38999 = emmy.polynomial.__GT_expression(p,vars);
return (emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1(G__38999) : emmy.polynomial.factor.simplify_product.call(null,G__38999));
} else {
throw e38998;
...
var cont = (function (p1__39004_SHARP_,p2__39005_SHARP_){
return emmy.polynomial.factor.poly__GT_factored_expression.cljs$core$IFn$_invoke$arity$3(p1__39004_SHARP_,p2__39005_SHARP_,simplify);
});
...
*/
emmy.polynomial.factor.t_emmy$polynomial$factor39013 = (function (symgen,meta39014){
this.symgen = symgen;
this.meta39014 = meta39014;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(emmy.polynomial.factor.t_emmy$polynomial$factor39013.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39015,meta39014__$1){
var self__ = this;
var _39015__$1 = this;
return (new emmy.polynomial.factor.t_emmy$polynomial$factor39013(self__.symgen,meta39014__$1));
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39013.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39015){
var self__ = this;
var _39015__$1 = this;
return self__.meta39014;
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39013.prototype.emmy$expression$analyze$ICanonicalize$ = cljs.core.PROTOCOL_SENTINEL);

(emmy.polynomial.factor.t_emmy$polynomial$factor39013.prototype.emmy$expression$analyze$ICanonicalize$expression__GT_$arity$4 = (function (_,expr,cont,v_compare){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.expression__GT_.cljs$core$IFn$_invoke$arity$3(expr,cont,v_compare);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39013.prototype.emmy$expression$analyze$ICanonicalize$__GT_expression$arity$3 = (function (_,p,vars){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.factor.poly__GT_factored_expression.cljs$core$IFn$_invoke$arity$2(p,vars);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39013.prototype.emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$arity$2 = (function (_,o){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.analyzer.emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$arity$2(null,o);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39013.getBasis = (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"symgen","symgen",-880919559,null),new cljs.core.Symbol(null,"meta39014","meta39014",-1469041322,null)], null);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39013.cljs$lang$type = true);

(emmy.polynomial.factor.t_emmy$polynomial$factor39013.cljs$lang$ctorStr = "emmy.polynomial.factor/t_emmy$polynomial$factor39013");

(emmy.polynomial.factor.t_emmy$polynomial$factor39013.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"emmy.polynomial.factor/t_emmy$polynomial$factor39013");
}));

/**
 * Positional factory function for emmy.polynomial.factor/t_emmy$polynomial$factor39013.
 */
emmy.polynomial.factor.__GT_t_emmy$polynomial$factor39013 = (function emmy$polynomial$factor$__GT_t_emmy$polynomial$factor39013(symgen,meta39014){
return (new emmy.polynomial.factor.t_emmy$polynomial$factor39013(symgen,meta39014));
});
...
return emmy.expression.analyze.make_analyzer.cljs$core$IFn$_invoke$arity$2((new emmy.polynomial.factor.t_emmy$polynomial$factor39013(symgen,cljs.core.PersistentArrayMap.EMPTY)),symgen);
})();
/**
...
var fact_exp = (function (){var G__39027 = cljs.core.first((emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1 ? emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1(expr) : emmy.numsymb.operands.call(null,expr)));
return (emmy.polynomial.factor.factor.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.factor.cljs$core$IFn$_invoke$arity$1(G__39027) : emmy.polynomial.factor.factor.call(null,G__39027));
})();
var expt = emmy.numsymb.symbolic_operator(new cljs.core.Symbol(null,"expt","expt",2123850345,null));
...
var G__39044 = (sqrt.cljs$core$IFn$_invoke$arity$1 ? sqrt.cljs$core$IFn$_invoke$arity$1(odds) : sqrt.call(null,odds));
var G__39045 = evens;
return (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(G__39044,G__39045) : _STAR_.call(null,G__39044,G__39045));
} else {
var vec__39046 = factors;
var seq__39047 = cljs.core.seq(vec__39046);
var first__39048 = cljs.core.first(seq__39047);
var seq__39047__$1 = cljs.core.next(seq__39047);
var f = first__39048;
var more = seq__39047__$1;
if(cljs.core.truth_(emmy.numsymb.expt_QMARK_(f))){
var vec__39049 = (emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1 ? emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1(f) : emmy.numsymb.operands.call(null,f));
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39049,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39049,(1),null);
if((!(even_QMARK_(e)))){
var G__39105 = more;
var G__39106 = (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(f,odds) : _STAR_.call(null,f,odds));
var G__39107 = evens;
factors = G__39105;
odds = G__39106;
evens = G__39107;
...
var G__39108 = more;
var G__39109 = odds;
var G__39110 = (function (){var power = cljs.core.quot(e,(2));
if((power > (1))){
var G__39052 = evens;
var G__39053 = (expt.cljs$core$IFn$_invoke$arity$2 ? expt.cljs$core$IFn$_invoke$arity$2(b,power) : expt.call(null,b,power));
return (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(G__39052,G__39053) : _STAR_.call(null,G__39052,G__39053));
} else {
...
var G__39111 = more;
var G__39112 = (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(f,odds) : _STAR_.call(null,f,odds));
var G__39113 = evens;
factors = G__39111;
odds = G__39112;
evens = G__39113;
