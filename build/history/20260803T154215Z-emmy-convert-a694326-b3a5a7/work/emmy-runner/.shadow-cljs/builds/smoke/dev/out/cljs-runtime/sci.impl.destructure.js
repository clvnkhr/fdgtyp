...
var G__50301 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__50302 = n;
var G__50303 = cljs.core.nnext(bs);
var G__50305 = true;
ret = G__50301;
n = G__50302;
bs = G__50303;
seen_rest_QMARK_ = G__50305;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__50231_SHARP_,p2__50232_SHARP_,(function (){var fexpr__50278 = cljs.core.val(entry);
return (fexpr__50278.cljs$core$IFn$_invoke$arity$1 ? fexpr__50278.cljs$core$IFn$_invoke$arity$1(p2__50232_SHARP_) : fexpr__50278.call(null,p2__50232_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__50280 = cljs.core.key(entry);
return (fexpr__50280.cljs$core$IFn$_invoke$arity$1 ? fexpr__50280.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__50280.call(null,bes));
})());
...
var G__50337 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__50338 = cljs.core.next(bes);
ret = G__50337;
bes = G__50338;
continue;
} else {
