...
var vec__49321 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.min.cljs$core$IFn$_invoke$arity$2(a,b),cljs.core.max.cljs$core$IFn$_invoke$arity$2(a,b)], null);
var a__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49321,(0),null);
var b__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49321,(1),null);
var vec__49324 = emmy.util.counted.cljs$core$IFn$_invoke$arity$1(f);
var f_counter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49324,(0),null);
var f__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49324,(1),null);
...
var G__49336 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [a__$1,mid,b__$1], null);
var vec__49338 = G__49336;
var a__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49338,(0),null);
var vec__49341 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49338,(1),null);
var xx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49341,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49341,(1),null);
var x = vec__49341;
var b__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49338,(2),null);
var G__49337 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [mid,mid], null);
var vec__49344 = G__49337;
var x2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49344,(0),null);
var x1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49344,(1),null);
var target = (0);
var delta = (0);
var iteration = (0);
var G__49336__$1 = G__49336;
var G__49337__$1 = G__49337;
var target__$1 = target;
var delta__$1 = delta;
var iteration__$1 = iteration;
while(true){
var vec__49372 = G__49336__$1;
var a__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49372,(0),null);
var vec__49375 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49372,(1),null);
var xx__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49375,(0),null);
var fx__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49375,(1),null);
var x__$1 = vec__49375;
var b__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49372,(2),null);
var vec__49378 = G__49337__$1;
var x2__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49378,(0),null);
var x1__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49378,(1),null);
...
var vec__49381 = (((emmy.generic.abs.cljs$core$IFn$_invoke$arity$1(target__$2) <= tol))?emmy.numerical.unimin.brent.golden_section_step(a__$3,xx__$1,b__$3):(function (){var vec__49393 = emmy.numerical.unimin.bracket.parabolic_pieces(x1__$1,x__$1,x2__$1);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49393,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49393,(1),null);
...
var new_target = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49381,(0),null);
var new_delta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49381,(1),null);
...
var vec__49384 = (((xnew < xx__$1))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_pt,x__$1], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x__$1,new_pt], null));
var vec__49387 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49384,(0),null);
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49387,(0),null);
var fl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49387,(1),null);
var l = vec__49387;
var vec__49390 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49384,(1),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49390,(0),null);
var fr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49390,(1),null);
var r = vec__49390;
var G__49415 = (((fl <= fr))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [a__$3,l,xr], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [xl,r,b__$3], null));
var G__49416 = emmy.numerical.unimin.brent.update_history(x2__$1,x1__$1,x__$1,new_pt);
var G__49417 = new_target;
var G__49418 = new_delta;
var G__49419 = (iteration__$2 + (1));
G__49336__$1 = G__49415;
G__49337__$1 = G__49416;
target__$1 = G__49417;
delta__$1 = G__49418;
iteration__$1 = G__49419;
continue;
}
break;
}
