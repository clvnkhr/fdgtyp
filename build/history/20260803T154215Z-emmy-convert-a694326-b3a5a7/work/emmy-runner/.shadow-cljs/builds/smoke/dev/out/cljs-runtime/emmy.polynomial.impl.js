...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(emmy.polynomial.impl.exponents,comparator,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$iter__32820(s__32821){
return (new cljs.core.LazySeq(null,(function (){
var s__32821__$1 = s__32821;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32821__$1);
if(temp__5825__auto__){
var s__32821__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32821__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32821__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32823 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32822 = (0);
while(true){
if((i__32822 < size__5648__auto__)){
var vec__32833 = cljs.core._nth(c__5647__auto__,i__32822);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32833,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32833,(1),null);
...
cljs.core.chunk_append(b__32823,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum));

var G__32964 = (i__32822 + (1));
i__32822 = G__32964;
continue;
} else {
var G__32965 = (i__32822 + (1));
i__32822 = G__32965;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32823),emmy$polynomial$impl$iter__32820(cljs.core.chunk_rest(s__32821__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32823),null);
}
} else {
var vec__32837 = cljs.core.first(s__32821__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32837,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32837,(1),null);
var coef_sum = cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1(emmy.polynomial.impl.coefficient),emmy.generic._PLUS_,terms);
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(coef_sum))){
var expts__$1 = ((cljs.core.vector_QMARK_(expts))?emmy.polynomial.exponent.dense__GT_exponents(expts):((cljs.core.sorted_QMARK_(expts))?expts:((cljs.core.map_QMARK_(expts))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.empty,expts):emmy.util.illegal("Invalid inputs to sparse->terms TODO")
)));
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum),emmy$polynomial$impl$iter__32820(cljs.core.rest(s__32821__$2)));
} else {
var G__32972 = cljs.core.rest(s__32821__$2);
s__32821__$1 = G__32972;
continue;
}
}
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$map_coefficients_$_iter__32842(s__32843){
return (new cljs.core.LazySeq(null,(function (){
var s__32843__$1 = s__32843;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32843__$1);
if(temp__5825__auto__){
var s__32843__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32843__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32843__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32845 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32844 = (0);
while(true){
if((i__32844 < size__5648__auto__)){
var vec__32852 = cljs.core._nth(c__5647__auto__,i__32844);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32852,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32852,(1),null);
...
cljs.core.chunk_append(b__32845,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c));

var G__32978 = (i__32844 + (1));
i__32844 = G__32978;
continue;
} else {
var G__32979 = (i__32844 + (1));
i__32844 = G__32979;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32845),emmy$polynomial$impl$map_coefficients_$_iter__32842(cljs.core.chunk_rest(s__32843__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32845),null);
}
} else {
var vec__32858 = cljs.core.first(s__32843__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32858,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32858,(1),null);
var f_c = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(c) : f.call(null,c));
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(f_c))){
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c),emmy$polynomial$impl$map_coefficients_$_iter__32842(cljs.core.rest(s__32843__$2)));
} else {
var G__32982 = cljs.core.rest(s__32843__$2);
s__32843__$1 = G__32982;
continue;
}
}
} else {
 ...
 */
emmy.polynomial.impl.t_STAR_ts = (function emmy$polynomial$impl$t_STAR_ts(p__32868,v){
var vec__32869 = p__32868;
var tags = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32869,(0),null);
var coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32869,(1),null);
...
var vec__32873 = t;
var tags1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32873,(0),null);
var coeff1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32873,(1),null);
var G__32983 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.mul(tags,tags1),emmy.generic.mul.cljs$core$IFn$_invoke$arity$2(coeff,coeff1)));
var G__32984 = (i + (1));
acc = G__32983;
i = G__32984;
continue;
...
var vec__32886 = cljs.core.peek(v);
var vn_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32886,(0),null);
var vn_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32886,(1),null);
var good_QMARK_ = (function (p1__32883_SHARP_){
return emmy.polynomial.exponent.every_power_QMARK_(cljs.core.pos_QMARK_,p1__32883_SHARP_);
});
...
var vec__32898 = cljs.core.peek(remainder);
var r_exponents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32898,(0),null);
var r_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32898,(1),null);
...
var G__32986 = emmy.polynomial.impl.add(quotient,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_term], null));
var G__32987 = emmy.polynomial.impl.sub(remainder,emmy.polynomial.impl.t_STAR_ts(new_term,v));
quotient = G__32986;
remainder = G__32987;
continue;
} else {
