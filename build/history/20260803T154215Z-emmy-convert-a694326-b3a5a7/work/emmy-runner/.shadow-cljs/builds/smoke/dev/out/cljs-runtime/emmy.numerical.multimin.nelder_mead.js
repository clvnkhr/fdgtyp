...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__48788_SHARP_){
return (s * p1__48788_SHARP_);
}),v);
});
/**
 ...
 */
emmy.numerical.multimin.nelder_mead.initial_simplex = (function emmy$numerical$multimin$nelder_mead$initial_simplex(x0,p__48799){
var map__48800 = p__48799;
var map__48800__$1 = cljs.core.__destructure_map(map__48800);
var nonzero_delta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48800__$1,new cljs.core.Keyword(null,"nonzero-delta","nonzero-delta",-794646863),0.05);
var zero_delta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48800__$1,new cljs.core.Keyword(null,"zero-delta","zero-delta",-2009573292),2.5E-4);
 ...
 */
emmy.numerical.multimin.nelder_mead.sup_norm = (function emmy$numerical$multimin$nelder_mead$sup_norm(p__48820){
var vec__48821 = p__48820;
var x0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48821,(0),null);
var simplex = vec__48821;
var coords = ((cljs.core.sequential_QMARK_(x0))?cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__48804_SHARP_){
return emmy.numerical.multimin.nelder_mead.v_(p1__48804_SHARP_,x0);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([simplex], 0)):cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48806_SHARP_){
return (p1__48806_SHARP_ - x0);
}),simplex));
 ...
 */
emmy.numerical.multimin.nelder_mead.step_defaults = (function emmy$numerical$multimin$nelder_mead$step_defaults(dimension,p__48846){
var map__48847 = p__48846;
var map__48847__$1 = cljs.core.__destructure_map(map__48847);
var m = map__48847__$1;
var adaptive_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48847__$1,new cljs.core.Keyword(null,"adaptive?","adaptive?",-259268570),true);
...
var map__48856 = emmy.numerical.multimin.nelder_mead.step_defaults(dimension,opts);
var map__48856__$1 = cljs.core.__destructure_map(map__48856);
var alpha = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48856__$1,new cljs.core.Keyword(null,"alpha","alpha",-1574982441));
var beta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48856__$1,new cljs.core.Keyword(null,"beta","beta",455605892));
var sigma = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48856__$1,new cljs.core.Keyword(null,"sigma","sigma",-63715703));
var gamma = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48856__$1,new cljs.core.Keyword(null,"gamma","gamma",1883969687));
...
var shrink = (function emmy$numerical$multimin$nelder_mead$step_fn_$_shrink(p__48905){
...
var s0 = first__48908;
var rest = seq__48907__$1;
var scale_toward_s0 = (function (p1__48851_SHARP_){
return emmy.numerical.multimin.nelder_mead.v_PLUS_(s0,emmy.numerical.multimin.nelder_mead.v_STAR_(sigma,emmy.numerical.multimin.nelder_mead.v_(p1__48851_SHARP_,s0)));
});
...
return (function (simplex,p__48913){
var vec__48915 = p__48913;
var f_best = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48915,(0),null);
var f_simplex = vec__48915;
...
if(cljs.core.truth_((function (p1__48852_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._LT__EQ_,cljs.core.second(p1__48852_SHARP_));
}))){
} else {
throw (new Error("Assert failed: (fn* [p1__48852#] (apply <= (second p1__48852#)))"));
}
 ...
 */
emmy.numerical.multimin.nelder_mead.convergence_fn = (function emmy$numerical$multimin$nelder_mead$convergence_fn(p__48941){
var map__48942 = p__48941;
var map__48942__$1 = cljs.core.__destructure_map(map__48942);
var simplex_tolerance = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48942__$1,new cljs.core.Keyword(null,"simplex-tolerance","simplex-tolerance",1524945145),1.0E-4);
var fn_tolerance = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48942__$1,new cljs.core.Keyword(null,"fn-tolerance","fn-tolerance",-1445606164),1.0E-4);
 ...
 */
emmy.numerical.multimin.nelder_mead.stop_fn = (function emmy$numerical$multimin$nelder_mead$stop_fn(f_counter,dimension,p__48955){
var map__48956 = p__48955;
var map__48956__$1 = cljs.core.__destructure_map(map__48956);
var maxiter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48956__$1,new cljs.core.Keyword(null,"maxiter","maxiter",-1867223754));
var maxfun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48956__$1,new cljs.core.Keyword(null,"maxfun","maxfun",-50301814));
 ...
 *   
 */
emmy.numerical.multimin.nelder_mead.nelder_mead = (function emmy$numerical$multimin$nelder_mead$nelder_mead(func,x0,p__48957){
var map__48958 = p__48957;
var map__48958__$1 = cljs.core.__destructure_map(map__48958);
var opts = map__48958__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48958__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
...
var vec__48960 = emmy.numerical.multimin.nelder_mead.counted(func);
var f_counter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48960,(0),null);
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48960,(1),null);
...
var G__48975 = emmy.numerical.multimin.nelder_mead.sort_by_f.cljs$core$IFn$_invoke$arity$3(simplex,f_simplex,dimension);
var vec__48984 = G__48975;
var vec__48987 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48984,(0),null);
var s0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48987,(0),null);
var simplex__$1 = vec__48987;
var vec__48990 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48984,(1),null);
var f0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48990,(0),null);
var f_simplex__$1 = vec__48990;
var iteration = (0);
var G__48975__$1 = G__48975;
var iteration__$1 = iteration;
while(true){
var vec__49022 = G__48975__$1;
var vec__49025 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49022,(0),null);
var s0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49025,(0),null);
var simplex__$2 = vec__49025;
var vec__49028 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49022,(1),null);
var f0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49028,(0),null);
var f_simplex__$2 = vec__49028;
...
var G__49136 = (step.cljs$core$IFn$_invoke$arity$2 ? step.cljs$core$IFn$_invoke$arity$2(simplex__$2,f_simplex__$2) : step.call(null,simplex__$2,f_simplex__$2));
var G__49137 = (iteration__$2 + (1));
G__48975__$1 = G__49136;
iteration__$1 = G__49137;
continue;
}
break;
}
