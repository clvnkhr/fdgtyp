...
if(emmy.expression.literal_QMARK_(expr)){
var G__26896 = emmy.expression.expression_of(expr);
expr = G__26896;
continue;
} else {
...
var f_sym = first__26764;
var args = seq__26763__$1;
...
if(emmy.expression.literal_QMARK_(expr)){
return emmy.expression.fmap((function (p1__26766_SHARP_){
return emmy.expression.substitute.cljs$core$IFn$_invoke$arity$2(p1__26766_SHARP_,s_map);
}),expr);
} else {
...
if((head_compare === (0))){
var G__26918 = cljs.core.rest(l);
var G__26919 = cljs.core.rest(r);
l = G__26918;
r = G__26919;
continue;
} else {
...
return (((!(cljs.core.sequential_QMARK_(xs)))) || (cljs.core.every_QMARK_((function (p__26795){
var vec__26796 = p__26795;
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26796,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26796,(1),null);
