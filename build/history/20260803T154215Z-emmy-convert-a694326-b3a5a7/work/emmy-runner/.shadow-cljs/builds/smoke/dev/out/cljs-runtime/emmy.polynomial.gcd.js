...
var memo_count_38864 = cljs.core.count(cljs.core.deref(emmy.polynomial.gcd.gcd_memo));
if((memo_count_38864 > (0))){
var hits_38865 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_hit);
var misses_38866 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_miss);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [goog.string.format("GCD cache hit rate %.2f%% (%d entries)",((100) * (hits_38865 / (hits_38865 + misses_38866))),memo_count_38864)], null);
...
var len__5897__auto___38871 = arguments.length;
var i__5898__auto___38872 = (0);
while(true){
if((i__5898__auto___38872 < len__5897__auto___38871)){
args__5903__auto__.push((arguments[i__5898__auto___38872]));

var G__38873 = (i__5898__auto___38872 + (1));
i__5898__auto___38872 = G__38873;
continue;
} else {
}
break;
...
/** @this {Function} */
(emmy.polynomial.gcd.dbg.cljs$lang$applyTo = (function (seq38704){
...
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38705,G__38706,seq38704__$2);
}));
...
var vec__38712 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var ticks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38712,(0),null);
var units = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38712,(1),null);
...
var _STAR_poly_gcd_time_limit_STAR__orig_val__38717 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var _STAR_clock_STAR__orig_val__38718 = emmy.polynomial.gcd._STAR_clock_STAR_;
var _STAR_poly_gcd_time_limit_STAR__temp_val__38719 = timeout;
var _STAR_clock_STAR__temp_val__38720 = emmy.util.stopwatch.stopwatch();
(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__temp_val__38719);

(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__temp_val__38720);

try{return (thunk.cljs$core$IFn$_invoke$arity$0 ? thunk.cljs$core$IFn$_invoke$arity$0() : thunk.call(null));
}finally {(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__orig_val__38718);

(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__orig_val__38717);
}});
/**
...
if(cljs.core.truth_(and__5160__auto__)){
var G__38724 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [u,v], null);
var fexpr__38723 = cljs.core.deref(emmy.polynomial.gcd.gcd_memo);
...
var len__5897__auto___38879 = arguments.length;
var i__5898__auto___38880 = (0);
while(true){
if((i__5898__auto___38880 < len__5897__auto___38879)){
args_arr__5922__auto__.push((arguments[i__5898__auto___38880]));

var G__38881 = (i__5898__auto___38880 + (1));
i__5898__auto___38880 = G__38881;
continue;
} else {
}
break;
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$1 = (function (p__38734){
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$2 = (function (p__38738,f){
var vec__38739 = p__38738;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38739,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38739,(1),null);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(u,v) : f.call(null,u,v));
}));

(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$3 = (function (p__38743,f1,f2){
var vec__38744 = p__38743;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38744,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38744,(1),null);
return (f1.cljs$core$IFn$_invoke$arity$3 ? f1.cljs$core$IFn$_invoke$arity$3(u,v,f2) : f1.call(null,u,v,f2));
}));

(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$variadic = (function (p__38747,f1,f2,more){
var vec__38748 = p__38747;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38748,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38748,(1),null);
var G__38751 = u;
var G__38752 = v;
var G__38753 = (function (u_SINGLEQUOTE_,v_SINGLEQUOTE_){
...
return (f1.cljs$core$IFn$_invoke$arity$3 ? f1.cljs$core$IFn$_invoke$arity$3(G__38751,G__38752,G__38753) : f1.call(null,G__38751,G__38752,G__38753));
}));

/** @this {Function} */
(emmy.polynomial.gcd.cont__GT_.cljs$lang$applyTo = (function (seq38728){
var G__38729 = cljs.core.first(seq38728);
var seq38728__$1 = cljs.core.next(seq38728);
var G__38730 = cljs.core.first(seq38728__$1);
var seq38728__$2 = cljs.core.next(seq38728__$1);
var G__38731 = cljs.core.first(seq38728__$2);
var seq38728__$3 = cljs.core.next(seq38728__$2);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38729,G__38730,G__38731,seq38728__$3);
}));
...
var vec__38773 = emmy.polynomial.gcd.terms__GT_sort_PLUS_unsort(cljs.core.into.cljs$core$IFn$_invoke$arity$2(l_terms,r_terms));
var sort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38773,(0),null);
var unsort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38773,(1),null);
return emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(unsort,(function (){var G__38786 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,u);
var G__38787 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,v);
return (continue$.cljs$core$IFn$_invoke$arity$2 ? continue$.cljs$core$IFn$_invoke$arity$2(G__38786,G__38787) : continue$.call(null,G__38786,G__38787));
})());
} else {
...
var vec__38804 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(u,gcd);
var ku = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38804,(0),null);
var pu = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38804,(1),null);
var vec__38807 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(v,gcd);
var kv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38807,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38807,(1),null);
...
var vec__38827 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.bare_terms(m),(0));
var mono_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38827,(0),null);
var mono_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38827,(1),null);
...
var vec__38834 = emmy.polynomial.pseudo_remainder(u,v);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38834,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38834,(1),null);
if(cljs.core.truth_(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(r))){
return emmy.generic.abs.cljs$core$IFn$_invoke$arity$1(v);
} else {
var vec__38839 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(r,gcd);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38839,(0),null);
var prim = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38839,(1),null);
var G__38892 = v;
var G__38893 = prim;
u = G__38892;
v = G__38893;
