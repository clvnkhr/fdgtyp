...
throw (new Error((""+"Could not find instance method: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(method_name))));
} else {
var method = temp__5827__auto__;
var args__$1 = args.map((function (p1__51738_SHARP_){
return sci.impl.types.eval(p1__51738_SHARP_,ctx,bindings);
}));
...
if(sci.impl.interop.fn_eval_allowed_QMARK_){
return (new Function("obj",(""+"return obj."+cljs.core.str.cljs$core$IFn$_invoke$arity$1(parts.join(".")))));
} else {
return (function (obj){
...
return Reflect.construct(constructor$,args.map((function (p1__51764_SHARP_){
return sci.impl.types.eval(p1__51764_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__51772_SHARP_){
return sci.impl.types.eval(p1__51772_SHARP_,ctx,bindings);
})));
});
...
var or__5162__auto__ = (function (){var temp__5823__auto__ = cljs.core.namespace(sym);
...
var or__5162__auto____$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"imports","imports",-1249933394).cljs$core$IFn$_invoke$arity$1(env),sym);
...
var env = cljs.core.deref(new cljs.core.Keyword(null,"env","env",-1815813235).cljs$core$IFn$_invoke$arity$1(ctx));
var class__GT_opts = new cljs.core.Keyword(null,"class->opts","class->opts",2061906477).cljs$core$IFn$_invoke$arity$1(env);
var class_opts = (function (){var or__5162__auto__ = (function (){var temp__5823__auto__ = cljs.core.namespace(sym);
if(cljs.core.truth_(temp__5823__auto__)){
var ns_STAR_ = temp__5823__auto__;
if(("js" === ns_STAR_)){
...
if(cljs.core.truth_(temp__5823__auto__)){
var vec__51807 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51807,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51807,(1),null);
