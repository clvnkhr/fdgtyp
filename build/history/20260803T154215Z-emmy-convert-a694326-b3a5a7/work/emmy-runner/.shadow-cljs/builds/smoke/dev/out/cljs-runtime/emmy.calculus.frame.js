...
var emmy$calculus$frame$IFrame$coords__GT_event$dyn_38920 = (function (this$,coords){
...
return emmy$calculus$frame$IFrame$coords__GT_event$dyn_38920(this$,coords);
}
});

var emmy$calculus$frame$IFrame$event__GT_coords$dyn_38922 = (function (this$,event){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$calculus$frame$IFrame$event__GT_coords$dyn_38922(this$,event);
}
});

var emmy$calculus$frame$IFrame$ancestor_frame$dyn_38925 = (function (_){
...
return emmy$calculus$frame$IFrame$ancestor_frame$dyn_38925(_);
}
});

var emmy$calculus$frame$IFrame$frame_name$dyn_38926 = (function (_){
var x__5519__auto__ = (((_ == null))?null:_);
...
return emmy$calculus$frame$IFrame$frame_name$dyn_38926(_);
}
});

var emmy$calculus$frame$IFrame$params$dyn_38928 = (function (_){
var x__5519__auto__ = (((_ == null))?null:_);
...
return emmy$calculus$frame$IFrame$params$dyn_38928(_);
}
});
...
*/
emmy.calculus.frame.t_emmy$calculus$frame38905 = (function (c__GT_e,e__GT_c,call,name,ancestor_frame,params,meta38906){
...
this.params = params;
this.meta38906 = meta38906;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(emmy.calculus.frame.t_emmy$calculus$frame38905.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38907,meta38906__$1){
var self__ = this;
var _38907__$1 = this;
return (new emmy.calculus.frame.t_emmy$calculus$frame38905(self__.c__GT_e,self__.e__GT_c,self__.call,self__.name,self__.ancestor_frame,self__.params,meta38906__$1));
}));

(emmy.calculus.frame.t_emmy$calculus$frame38905.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38907){
var self__ = this;
var _38907__$1 = this;
return self__.meta38906;
}));

(emmy.calculus.frame.t_emmy$calculus$frame38905.prototype.emmy$calculus$frame$IFrame$ = cljs.core.PROTOCOL_SENTINEL);

(emmy.calculus.frame.t_emmy$calculus$frame38905.prototype.emmy$calculus$frame$IFrame$ancestor_frame$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return self__.ancestor_frame;
}));

(emmy.calculus.frame.t_emmy$calculus$frame38905.prototype.emmy$calculus$frame$IFrame$frame_name$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return self__.name;
}));

(emmy.calculus.frame.t_emmy$calculus$frame38905.prototype.emmy$calculus$frame$IFrame$params$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return self__.params;
}));

(emmy.calculus.frame.t_emmy$calculus$frame38905.prototype.emmy$calculus$frame$IFrame$coords__GT_event$arity$2 = (function (this$,coords){
var self__ = this;
var this$__$1 = this;
...
var event = (function (){var fexpr__38914 = (self__.c__GT_e.cljs$core$IFn$_invoke$arity$3 ? self__.c__GT_e.cljs$core$IFn$_invoke$arity$3(self__.ancestor_frame,this$__$1,self__.params) : self__.c__GT_e.call(null,self__.ancestor_frame,this$__$1,self__.params));
return (fexpr__38914.cljs$core$IFn$_invoke$arity$1 ? fexpr__38914.cljs$core$IFn$_invoke$arity$1(coords) : fexpr__38914.call(null,coords));
})();
...
(emmy.calculus.frame.t_emmy$calculus$frame38905.prototype.emmy$calculus$frame$IFrame$event__GT_coords$arity$2 = (function (this$,event){
var self__ = this;
var this$__$1 = this;
if(cljs.core.truth_(emmy.calculus.frame.event_QMARK_(event))){
} else {
...
var coords = (function (){var fexpr__38915 = (self__.e__GT_c.cljs$core$IFn$_invoke$arity$3 ? self__.e__GT_c.cljs$core$IFn$_invoke$arity$3(self__.ancestor_frame,this$__$1,self__.params) : self__.e__GT_c.call(null,self__.ancestor_frame,this$__$1,self__.params));
return (fexpr__38915.cljs$core$IFn$_invoke$arity$1 ? fexpr__38915.cljs$core$IFn$_invoke$arity$1(event) : fexpr__38915.call(null,event));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(emmy.calculus.frame.frame_owner(coords),this$__$1)){
} else {
throw (new Error("Assert failed: (= (frame-owner coords) this)"));
...
(emmy.calculus.frame.t_emmy$calculus$frame38905.getBasis = (function (){
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"c->e","c->e",366611773,null),new cljs.core.Symbol(null,"e->c","e->c",-1459982439,null),new cljs.core.Symbol(null,"call","call",1120531661,null),new cljs.core.Symbol(null,"name","name",-810760592,null),new cljs.core.Symbol(null,"ancestor-frame","ancestor-frame",-1796645653,null),new cljs.core.Symbol(null,"params","params",-1943919534,null),new cljs.core.Symbol(null,"meta38906","meta38906",-78471939,null)], null);
}));

(emmy.calculus.frame.t_emmy$calculus$frame38905.cljs$lang$type = true);

(emmy.calculus.frame.t_emmy$calculus$frame38905.cljs$lang$ctorStr = "emmy.calculus.frame/t_emmy$calculus$frame38905");

(emmy.calculus.frame.t_emmy$calculus$frame38905.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"emmy.calculus.frame/t_emmy$calculus$frame38905");
}));

/**
 * Positional factory function for emmy.calculus.frame/t_emmy$calculus$frame38905.
 */
emmy.calculus.frame.__GT_t_emmy$calculus$frame38905 = (function emmy$calculus$frame$__GT_t_emmy$calculus$frame38905(c__GT_e,e__GT_c,call,name,ancestor_frame,params,meta38906){
return (new emmy.calculus.frame.t_emmy$calculus$frame38905(c__GT_e,e__GT_c,call,name,ancestor_frame,params,meta38906));
});
...
return (new emmy.calculus.frame.t_emmy$calculus$frame38905(c__GT_e,e__GT_c,emmy$calculus$frame$frame_maker_$_call,name,ancestor_frame,params,cljs.core.PersistentArrayMap.EMPTY));
});
