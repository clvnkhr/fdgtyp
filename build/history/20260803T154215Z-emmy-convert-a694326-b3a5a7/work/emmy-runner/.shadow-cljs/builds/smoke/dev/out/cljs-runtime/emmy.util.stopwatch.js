...
var emmy$util$stopwatch$IStopwatch$running_QMARK_$dyn_36866 = (function (this$){
...
return emmy$util$stopwatch$IStopwatch$running_QMARK_$dyn_36866(this$);
}
});

var emmy$util$stopwatch$IStopwatch$start$dyn_36867 = (function (this$){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$util$stopwatch$IStopwatch$start$dyn_36867(this$);
}
});

var emmy$util$stopwatch$IStopwatch$stop$dyn_36868 = (function (this$){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$util$stopwatch$IStopwatch$stop$dyn_36868(this$);
}
});

var emmy$util$stopwatch$IStopwatch$reset$dyn_36869 = (function (this$){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$util$stopwatch$IStopwatch$reset$dyn_36869(this$);
}
});

var emmy$util$stopwatch$IStopwatch$_elapsed$dyn_36870 = (function (this$,unit){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$util$stopwatch$IStopwatch$_elapsed$dyn_36870(this$,unit);
}
});

var emmy$util$stopwatch$IStopwatch$repr$dyn_36871 = (function (this$){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$util$stopwatch$IStopwatch$repr$dyn_36871(this$);
}
});
...
var __GT_micros_36873 = 1000.0;
var __GT_ms_36874 = (__GT_micros_36873 * 1000.0);
var __GT_s_36875 = (__GT_ms_36874 * 1000.0);
var __GT_m_36876 = (__GT_s_36875 * (60));
var __GT_h_36877 = (__GT_m_36876 * (60));
var __GT_d_36878 = (__GT_h_36877 * (24));
emmy.util.stopwatch.from_nanos = (function emmy$util$stopwatch$from_nanos(ns,unit){
return (ns / (function (){var G__36810 = unit;
...
break;
case "micros":
return __GT_micros_36873;

break;
case "millis":
return __GT_ms_36874;
...
var or__5162__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__36812_SHARP_){
return (p1__36812_SHARP_ > (1));
}),cljs.core.first),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2((function (p1__36811_SHARP_){
return emmy.util.stopwatch.from_nanos(ns,p1__36811_SHARP_);
...
var self__ = this;
var this$__$1 = this;
var vec__36825 = emmy.util.stopwatch.choose_unit(emmy.util.stopwatch.elapsed.cljs$core$IFn$_invoke$arity$2(this$__$1,new cljs.core.Keyword(null,"nanos","nanos",-1777059258)));
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36825,(0),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36825,(1),null);
...
*/
emmy.util.stopwatch.t_emmy$util$stopwatch36834 = (function (stopwatch,sw,meta36835){
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36834.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36836,meta36835__$1){
var self__ = this;
var _36836__$1 = this;
return (new emmy.util.stopwatch.t_emmy$util$stopwatch36834(self__.stopwatch,self__.sw,meta36835__$1));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36834.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36836){
var self__ = this;
var _36836__$1 = this;
return self__.meta36835;
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36834.prototype.emmy$util$stopwatch$IStopwatch$ = cljs.core.PROTOCOL_SENTINEL);

(emmy.util.stopwatch.t_emmy$util$stopwatch36834.prototype.emmy$util$stopwatch$IStopwatch$running_QMARK_$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return emmy.util.stopwatch.running_QMARK_(cljs.core.deref(self__.sw));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36834.prototype.emmy$util$stopwatch$IStopwatch$start$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36834.prototype.emmy$util$stopwatch$IStopwatch$stop$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36834.prototype.emmy$util$stopwatch$IStopwatch$reset$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36834.prototype.emmy$util$stopwatch$IStopwatch$_elapsed$arity$2 = (function (_,unit){
var self__ = this;
var ___$1 = this;
return emmy.util.stopwatch._elapsed(cljs.core.deref(self__.sw),unit);
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36834.prototype.emmy$util$stopwatch$IStopwatch$repr$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return emmy.util.stopwatch.repr(cljs.core.deref(self__.sw));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36834.prototype.toString = (function (){
var self__ = this;
var _ = this;
return emmy.util.stopwatch.repr(cljs.core.deref(self__.sw));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36834.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"stopwatch","stopwatch",-1262782731,null),new cljs.core.Symbol(null,"sw","sw",-1821321856,null),new cljs.core.Symbol(null,"meta36835","meta36835",-872103096,null)], null);
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36834.cljs$lang$type = true);

(emmy.util.stopwatch.t_emmy$util$stopwatch36834.cljs$lang$ctorStr = "emmy.util.stopwatch/t_emmy$util$stopwatch36834");

(emmy.util.stopwatch.t_emmy$util$stopwatch36834.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"emmy.util.stopwatch/t_emmy$util$stopwatch36834");
}));

/**
 * Positional factory function for emmy.util.stopwatch/t_emmy$util$stopwatch36834.
 */
emmy.util.stopwatch.__GT_t_emmy$util$stopwatch36834 = (function emmy$util$stopwatch$__GT_t_emmy$util$stopwatch36834(stopwatch__$1,sw,meta36835){
return (new emmy.util.stopwatch.t_emmy$util$stopwatch36834(stopwatch__$1,sw,meta36835));
});
...
return (new emmy.util.stopwatch.t_emmy$util$stopwatch36834(stopwatch__$1,sw,cljs.core.PersistentArrayMap.EMPTY));
});
/**
...
var map__36865 = p__36850;
var map__36865__$1 = cljs.core.__destructure_map(map__36865);
var started_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36865__$1,new cljs.core.Keyword(null,"started?","started?",-1301062863),true);
