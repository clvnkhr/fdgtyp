...
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59279,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59279,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59279,(2),null);
...
return (function (t){
return emmy.mechanics.rigid.antisymmetric__GT_column_matrix(emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2((function (){var fexpr__59283 = (emmy.calculus.derivative.D.cljs$core$IFn$_invoke$arity$1 ? emmy.calculus.derivative.D.cljs$core$IFn$_invoke$arity$1(M_of_t) : emmy.calculus.derivative.D.call(null,M_of_t));
return (fexpr__59283.cljs$core$IFn$_invoke$arity$1 ? fexpr__59283.cljs$core$IFn$_invoke$arity$1(t) : fexpr__59283.call(null,t));
...
return (function (q){
return (function (t){
return emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2(emmy.matrix.transpose((function (){var G__59284 = (q.cljs$core$IFn$_invoke$arity$1 ? q.cljs$core$IFn$_invoke$arity$1(t) : q.call(null,t));
return (M_of_q.cljs$core$IFn$_invoke$arity$1 ? M_of_q.cljs$core$IFn$_invoke$arity$1(G__59284) : M_of_q.call(null,G__59284));
})()),(function (){var fexpr__59288 = emmy.mechanics.rigid.M_of_q__GT_omega_of_t(M_of_q)(q);
...
return (function (p__59289){
var vec__59290 = p__59289;
var w0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59290,(0),null);
var w1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59290,(1),null);
var w2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59290,(2),null);
...
return emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2((function (){var fexpr__59303 = (emmy.calculus.derivative.D.cljs$core$IFn$_invoke$arity$1 ? emmy.calculus.derivative.D.cljs$core$IFn$_invoke$arity$1(M_on_path) : emmy.calculus.derivative.D.call(null,M_on_path));
return (fexpr__59303.cljs$core$IFn$_invoke$arity$1 ? fexpr__59303.cljs$core$IFn$_invoke$arity$1(t__$1) : fexpr__59303.call(null,t__$1));
 ...
 */
emmy.mechanics.rigid.Euler_state__GT_omega_body = (function emmy$mechanics$rigid$Euler_state__GT_omega_body(p__59309){
var vec__59310 = p__59309;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59310,(0),null);
var vec__59313 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59310,(1),null);
var theta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59313,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59313,(1),null);
var psi = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59313,(2),null);
var vec__59316 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59310,(2),null);
var thetadot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59316,(0),null);
var phidot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59316,(1),null);
var psidot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59316,(2),null);
...
emmy.mechanics.rigid.quaternion_state__GT_omega_body = (function emmy$mechanics$rigid$quaternion_state__GT_omega_body(p__59333){
var vec__59335 = p__59333;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59335,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59335,(1),null);
var qdot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59335,(2),null);
...
var q_COLON_a_59383 = emmy.matrix.by_rows.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(1),(0),(0)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(-1),(0),(0),(0)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0),(1)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(-1),(0)], null)], 0));
var q_COLON_b_59384 = emmy.matrix.by_rows.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(1),(0)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0),(-1)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(-1),(0),(0),(0)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(1),(0),(0)], null)], 0));
var q_COLON_c_59386 = emmy.matrix.by_rows.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0),(1)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(1),(0)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(-1),(0),(0)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(-1),(0),(0),(0)], null)], 0));
emmy.mechanics.rigid.quaternion_state__GT_omega_space = (function emmy$mechanics$rigid$quaternion_state__GT_omega_space(p__59346){
var vec__59347 = p__59346;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59347,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59347,(1),null);
var qdot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59347,(2),null);
...
var omega_STAR__STAR_x = emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2(two_m_STAR__STAR_2_inv,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$variadic(QdotT,q_COLON_a_59383,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([Q], 0)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null)));
var omega_STAR__STAR_y = emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2(two_m_STAR__STAR_2_inv,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$variadic(QdotT,q_COLON_b_59384,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([Q], 0)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null)));
var omega_STAR__STAR_z = emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2(two_m_STAR__STAR_2_inv,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$variadic(QdotT,q_COLON_c_59386,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([Q], 0)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null)));
...
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59357,(1),null);
var omega = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59357,(2),null);
...
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59370,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59370,(1),null);
var qw_state = vec__59370;
...
return (function (p__59377){
var vec__59378 = p__59377;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59378,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59378,(1),null);
var qdot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59378,(2),null);
var Q = emmy.matrix.up__GT_column_matrix(q);
