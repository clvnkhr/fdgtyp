...
var emmy$expression$analyze$ICanonicalize$expression__GT_$dyn_36971 = (function() {
var G__36972 = null;
var G__36972__3 = (function (analyzer,x,continue$){
...
var G__36972__4 = (function (analyzer,x,continue$,compare_fn){
var x__5519__auto__ = (((analyzer == null))?null:analyzer);
var m__5520__auto__ = (emmy.expression.analyze.expression__GT_[goog.typeOf(x__5519__auto__)]);
if((!((m__5520__auto__ == null)))){
...
G__36972 = function(analyzer,x,continue$,compare_fn){
switch(arguments.length){
case 3:
return G__36972__3.call(this,analyzer,x,continue$);
case 4:
return G__36972__4.call(this,analyzer,x,continue$,compare_fn);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__36972.cljs$core$IFn$_invoke$arity$3 = G__36972__3;
G__36972.cljs$core$IFn$_invoke$arity$4 = G__36972__4;
return G__36972;
})()
;
/**
...
return emmy$expression$analyze$ICanonicalize$expression__GT_$dyn_36971(analyzer,x,continue$);
}
}));
...
return emmy$expression$analyze$ICanonicalize$expression__GT_$dyn_36971(analyzer,x,continue$,compare_fn);
}
}));
...
var emmy$expression$analyze$ICanonicalize$__GT_expression$dyn_36980 = (function (analyzer,b,variables){
var x__5519__auto__ = (((analyzer == null))?null:analyzer);
...
return emmy$expression$analyze$ICanonicalize$__GT_expression$dyn_36980(analyzer,b,variables);
}
});

var emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$dyn_36985 = (function (analyzer,x){
var x__5519__auto__ = (((analyzer == null))?null:analyzer);
...
return emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$dyn_36985(analyzer,x);
}
});
...
var expr__GT_var = (function (){var G__36905 = cljs.core.PersistentArrayMap.EMPTY;
return (ref.cljs$core$IFn$_invoke$arity$1 ? ref.cljs$core$IFn$_invoke$arity$1(G__36905) : ref.call(null,G__36905));
})();
var var__GT_expr = (function (){var G__36906 = cljs.core.PersistentArrayMap.EMPTY;
...
return cljs.core.identity((function (){var temp__5823__auto__ = (function (){var fexpr__36935 = cljs.core.deref(expr__GT_var);
return (fexpr__36935.cljs$core$IFn$_invoke$arity$1 ? fexpr__36935.cljs$core$IFn$_invoke$arity$1(expr_k) : fexpr__36935.call(null,expr_k));
})();
...
var vcompare_36993 = emmy.expression.analyze.make_vcompare(emmy.expression.variables_in(expr));
cljs.core.reset_BANG_(compare_fn,vcompare_36993);

return ianalyze(expr);
});
var v_compare = (function emmy$expression$analyze$v_compare(v1,v2){
var fexpr__36941 = cljs.core.deref(compare_fn);
return (fexpr__36941.cljs$core$IFn$_invoke$arity$2 ? fexpr__36941.cljs$core$IFn$_invoke$arity$2(v1,v2) : fexpr__36941.call(null,v1,v2));
});
...
var temp__5823__auto__ = (function (){var fexpr__36943 = cljs.core.deref(expr__GT_var);
return (fexpr__36943.cljs$core$IFn$_invoke$arity$1 ? fexpr__36943.cljs$core$IFn$_invoke$arity$1(analyzed_expr) : fexpr__36943.call(null,analyzed_expr));
})();
if(cljs.core.truth_(temp__5823__auto__)){
var existing_expr = temp__5823__auto__;
return existing_expr;
...
var G__36945_36998 = expr__GT_var;
var G__36946_36999 = cljs.core.PersistentArrayMap.EMPTY;
(ref_set.cljs$core$IFn$_invoke$arity$2 ? ref_set.cljs$core$IFn$_invoke$arity$2(G__36945_36998,G__36946_36999) : ref_set.call(null,G__36945_36998,G__36946_36999));

var G__36947_37000 = var__GT_expr;
var G__36948_37001 = cljs.core.PersistentArrayMap.EMPTY;
(ref_set.cljs$core$IFn$_invoke$arity$2 ? ref_set.cljs$core$IFn$_invoke$arity$2(G__36947_37000,G__36948_37001) : ref_set.call(null,G__36947_37000,G__36948_37001));
...
var _STAR_incremental_simplifier_STAR__orig_val__36949 = emmy.numsymb._STAR_incremental_simplifier_STAR_;
var _STAR_incremental_simplifier_STAR__temp_val__36950 = false;
(emmy.numsymb._STAR_incremental_simplifier_STAR_ = _STAR_incremental_simplifier_STAR__temp_val__36950);

try{return base_simplify(analyze(expr));
}finally {(emmy.numsymb._STAR_incremental_simplifier_STAR_ = _STAR_incremental_simplifier_STAR__orig_val__36949);
}});
...
var temp__5823__auto__ = (function (){var fexpr__36954 = cljs.core.deref(var__GT_expr);
return (fexpr__36954.cljs$core$IFn$_invoke$arity$1 ? fexpr__36954.cljs$core$IFn$_invoke$arity$1(expr) : fexpr__36954.call(null,expr));
})();
if(cljs.core.truth_(temp__5823__auto__)){
