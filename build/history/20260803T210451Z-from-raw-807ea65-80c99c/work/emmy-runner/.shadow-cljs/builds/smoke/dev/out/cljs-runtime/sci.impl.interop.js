...
var args__$1 = args.map((function (p1__51083_SHARP_){
return sci.impl.types.eval(p1__51083_SHARP_,ctx,bindings);
}));
...
return Reflect.construct(constructor$,args.map((function (p1__51115_SHARP_){
...
return Reflect.apply(method,class$,args.map((function (p1__51122_SHARP_){
return sci.impl.types.eval(p1__51122_SHARP_,ctx,bindings);
})));
});
...
if(cljs.core.truth_(temp__5823__auto__)){
var vec__51151 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51151,(0),null);
