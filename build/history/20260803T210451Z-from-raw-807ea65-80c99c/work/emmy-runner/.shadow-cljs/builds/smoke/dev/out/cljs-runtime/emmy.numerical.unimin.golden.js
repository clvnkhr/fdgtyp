 ...
 */
emmy.numerical.unimin.golden.shrink_interval = (function emmy$numerical$unimin$golden$shrink_interval(f,p__49011,p__49012,p__49013,p__49014){
var vec__49016 = p__49011;
var xa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49016,(0),null);
var a = vec__49016;
var vec__49019 = p__49012;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49019,(0),null);
var fl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49019,(1),null);
var l = vec__49019;
var vec__49022 = p__49013;
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49022,(0),null);
var fr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49022,(1),null);
var r = vec__49022;
var vec__49025 = p__49014;
var xb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49025,(0),null);
var b = vec__49025;
...
var G__49153__delegate = function (rest__48946_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._LT_,rest__48946_SHARP_);
};
var G__49153 = function (var_args){
var rest__48946_SHARP_ = null;
...
while (G__49154__i < G__49154__a.length) {G__49154__a[G__49154__i] = arguments[G__49154__i + 0]; ++G__49154__i;}
  rest__48946_SHARP_ = new cljs.core.IndexedSeq(G__49154__a,0,null);
} 
return G__49153__delegate.call(this,rest__48946_SHARP_);};
G__49153.cljs$lang$maxFixedArity = 0;
G__49153.cljs$lang$applyTo = (function (arglist__49155){
var rest__48946_SHARP_ = cljs.core.seq(arglist__49155);
return G__49153__delegate(rest__48946_SHARP_);
});
...
throw (new Error("Assert failed: (fn* [& rest__48946#] (apply < rest__48946#))"));
}
...
/** @this {Function} */
(emmy.numerical.unimin.golden.best_of.cljs$lang$applyTo = (function (seq49052){
var self__5883__auto__ = this;
return self__5883__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq49052));
}));
...
return (function (p__49082,p__49083,p__49084,p__49085,_){
var vec__49086 = p__49082;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49086,(0),null);
var fa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49086,(1),null);
var vec__49089 = p__49083;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49089,(0),null);
var fl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49089,(1),null);
var vec__49092 = p__49084;
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49092,(0),null);
var fr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49092,(1),null);
var vec__49095 = p__49085;
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49095,(0),null);
...
var close_QMARK_ = emmy.value.within(epsilon);
return (function (p__49102,_,___$1,p__49103,___$2){
var vec__49104 = p__49102;
var xa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49104,(0),null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49104,(1),null);
var vec__49107 = p__49103;
var xb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49107,(0),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49107,(1),null);
 ...
 *   false otherwise.
 */
emmy.numerical.unimin.golden.convergence_fn = (function emmy$numerical$unimin$golden$convergence_fn(p__49115){
var map__49116 = p__49115;
var map__49116__$1 = cljs.core.__destructure_map(map__49116);
var converged_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49116__$1,new cljs.core.Keyword(null,"converged?","converged?",1779059976));
var fn_tolerance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49116__$1,new cljs.core.Keyword(null,"fn-tolerance","fn-tolerance",-1445606164));
var arg_tolerance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49116__$1,new cljs.core.Keyword(null,"arg-tolerance","arg-tolerance",1681183780));
return (function() { 
var G__49159__delegate = function (args){
return cljs.core.some((function (p1__49114_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(p1__49114_SHARP_,args);
 ...
 *   
 */
emmy.numerical.unimin.golden.stop_fn = (function emmy$numerical$unimin$golden$stop_fn(p__49118){
var map__49119 = p__49118;
var map__49119__$1 = cljs.core.__destructure_map(map__49119);
var maxiter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49119__$1,new cljs.core.Keyword(null,"maxiter","maxiter",-1867223754));
var maxfun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49119__$1,new cljs.core.Keyword(null,"maxfun","maxfun",-50301814));
var fn_counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49119__$1,new cljs.core.Keyword(null,"fn-counter","fn-counter",-1395388762));
return (function() { 
var G__49162__delegate = function (args){
return cljs.core.some((function (p1__49117_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(p1__49117_SHARP_,args);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function() { 
var G__49163__delegate = function (_){
...
while (G__49164__i < G__49164__a.length) {G__49164__a[G__49164__i] = arguments[G__49164__i + 0]; ++G__49164__i;}
  _ = new cljs.core.IndexedSeq(G__49164__a,0,null);
} 
return G__49163__delegate.call(this,_);};
G__49163.cljs$lang$maxFixedArity = 0;
G__49163.cljs$lang$applyTo = (function (arglist__49165){
var _ = cljs.core.seq(arglist__49165);
return G__49163__delegate(_);
});
...
G__49162.cljs$lang$applyTo = (function (arglist__49167){
...
var G__49182 = emmy.numerical.unimin.golden.shrink_interval(f__$1,a__$2,l__$1,r__$1,b__$2);
var G__49183 = (iteration__$2 + (1));
G__49141__$1 = G__49182;
iteration__$1 = G__49183;
continue;
}
break;
}
