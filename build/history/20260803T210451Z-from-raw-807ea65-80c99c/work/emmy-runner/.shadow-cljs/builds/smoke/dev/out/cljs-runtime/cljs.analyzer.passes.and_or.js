...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__21370){
var map__21371 = p__21370;
var map__21371__$1 = cljs.core.__destructure_map(map__21371);
var ast = map__21371__$1;
...
var G__21393 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"locals","locals",535295783)], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__21393,local);
} else {
return G__21393;
}
});
...
var map__21398 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__21398__$1 = cljs.core.__destructure_map(map__21398);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21398__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21398__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var map__21399 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__21399__$1 = cljs.core.__destructure_map(map__21399);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21399__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21399__$1,new cljs.core.Keyword(null,"name","name",1843675177));
