...
var G__39097 = new_m;
var G__39098 = emmy.polynomial.evenly_divide(h,emmy.polynomial.mul(new_m,new_s));
var G__39099 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(tracker,doublefacts,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([singlefacts], 0));
var G__39100 = new_s;
var G__39101 = new_m;
m = G__39097;
h = G__39098;
 ...
 */
emmy.polynomial.factor.simplify_product = emmy.pattern.rule.rule_simplifier.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([emmy.simplify.rules.associative.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Symbol(null,"*","*",345799209,null)], 0)),emmy.simplify.rules.unary_elimination.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Symbol(null,"*","*",345799209,null)], 0)),emmy.simplify.rules.constant_elimination(new cljs.core.Symbol(null,"*","*",345799209,null),(1)),emmy.pattern.rule.rule_STAR_(emmy.pattern.rule.pattern_STAR_.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"*","*",345799209,null),null,(1),null)),emmy.pattern.rule._EQ__GT_),(function (G__39022){
...
}catch (e39025){if((e39025 instanceof Error)){
var _ = e39025;
...
var G__39029 = emmy.polynomial.__GT_expression(p,vars);
return (emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1(G__39029) : emmy.polynomial.factor.simplify_product.call(null,G__39029));
} else {
throw e39025;
...
var cont = (function (p1__39037_SHARP_,p2__39038_SHARP_){
return emmy.polynomial.factor.poly__GT_factored_expression.cljs$core$IFn$_invoke$arity$3(p1__39037_SHARP_,p2__39038_SHARP_,simplify);
});
...
*/
emmy.polynomial.factor.t_emmy$polynomial$factor39055 = (function (symgen,meta39056){
this.symgen = symgen;
this.meta39056 = meta39056;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(emmy.polynomial.factor.t_emmy$polynomial$factor39055.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39057,meta39056__$1){
var self__ = this;
var _39057__$1 = this;
return (new emmy.polynomial.factor.t_emmy$polynomial$factor39055(self__.symgen,meta39056__$1));
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39055.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39057){
var self__ = this;
var _39057__$1 = this;
return self__.meta39056;
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39055.prototype.emmy$expression$analyze$ICanonicalize$ = cljs.core.PROTOCOL_SENTINEL);

(emmy.polynomial.factor.t_emmy$polynomial$factor39055.prototype.emmy$expression$analyze$ICanonicalize$expression__GT_$arity$4 = (function (_,expr,cont,v_compare){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.expression__GT_.cljs$core$IFn$_invoke$arity$3(expr,cont,v_compare);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39055.prototype.emmy$expression$analyze$ICanonicalize$__GT_expression$arity$3 = (function (_,p,vars){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.factor.poly__GT_factored_expression.cljs$core$IFn$_invoke$arity$2(p,vars);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39055.prototype.emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$arity$2 = (function (_,o){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.analyzer.emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$arity$2(null,o);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39055.getBasis = (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"symgen","symgen",-880919559,null),new cljs.core.Symbol(null,"meta39056","meta39056",-1464191141,null)], null);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor39055.cljs$lang$type = true);

(emmy.polynomial.factor.t_emmy$polynomial$factor39055.cljs$lang$ctorStr = "emmy.polynomial.factor/t_emmy$polynomial$factor39055");

(emmy.polynomial.factor.t_emmy$polynomial$factor39055.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"emmy.polynomial.factor/t_emmy$polynomial$factor39055");
}));

/**
 * Positional factory function for emmy.polynomial.factor/t_emmy$polynomial$factor39055.
 */
emmy.polynomial.factor.__GT_t_emmy$polynomial$factor39055 = (function emmy$polynomial$factor$__GT_t_emmy$polynomial$factor39055(symgen,meta39056){
return (new emmy.polynomial.factor.t_emmy$polynomial$factor39055(symgen,meta39056));
});
...
return emmy.expression.analyze.make_analyzer.cljs$core$IFn$_invoke$arity$2((new emmy.polynomial.factor.t_emmy$polynomial$factor39055(symgen,cljs.core.PersistentArrayMap.EMPTY)),symgen);
})();
/**
...
var fact_exp = (function (){var G__39066 = cljs.core.first((emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1 ? emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1(expr) : emmy.numsymb.operands.call(null,expr)));
return (emmy.polynomial.factor.factor.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.factor.cljs$core$IFn$_invoke$arity$1(G__39066) : emmy.polynomial.factor.factor.call(null,G__39066));
})();
var expt = emmy.numsymb.symbolic_operator(new cljs.core.Symbol(null,"expt","expt",2123850345,null));
...
var G__39084 = (sqrt.cljs$core$IFn$_invoke$arity$1 ? sqrt.cljs$core$IFn$_invoke$arity$1(odds) : sqrt.call(null,odds));
var G__39085 = evens;
return (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(G__39084,G__39085) : _STAR_.call(null,G__39084,G__39085));
} else {
var vec__39087 = factors;
...
var f = first__39089;
var more = seq__39088__$1;
if(cljs.core.truth_(emmy.numsymb.expt_QMARK_(f))){
var vec__39090 = (emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1 ? emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1(f) : emmy.numsymb.operands.call(null,f));
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39090,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39090,(1),null);
if((!(even_QMARK_(e)))){
var G__39109 = more;
var G__39110 = (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(f,odds) : _STAR_.call(null,f,odds));
var G__39111 = evens;
factors = G__39109;
odds = G__39110;
evens = G__39111;
...
var G__39112 = more;
var G__39113 = odds;
var G__39114 = (function (){var power = cljs.core.quot(e,(2));
if((power > (1))){
var G__39093 = evens;
var G__39094 = (expt.cljs$core$IFn$_invoke$arity$2 ? expt.cljs$core$IFn$_invoke$arity$2(b,power) : expt.call(null,b,power));
return (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(G__39093,G__39094) : _STAR_.call(null,G__39093,G__39094));
} else {
