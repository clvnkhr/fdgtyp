...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(emmy.polynomial.impl.exponents,comparator,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$iter__32804(s__32805){
return (new cljs.core.LazySeq(null,(function (){
var s__32805__$1 = s__32805;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32805__$1);
if(temp__5825__auto__){
var s__32805__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32805__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32805__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32807 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32806 = (0);
while(true){
if((i__32806 < size__5648__auto__)){
var vec__32819 = cljs.core._nth(c__5647__auto__,i__32806);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32819,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32819,(1),null);
...
cljs.core.chunk_append(b__32807,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum));

var G__32953 = (i__32806 + (1));
i__32806 = G__32953;
continue;
} else {
var G__32954 = (i__32806 + (1));
i__32806 = G__32954;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32807),emmy$polynomial$impl$iter__32804(cljs.core.chunk_rest(s__32805__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32807),null);
}
} else {
var vec__32824 = cljs.core.first(s__32805__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32824,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32824,(1),null);
var coef_sum = cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1(emmy.polynomial.impl.coefficient),emmy.generic._PLUS_,terms);
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(coef_sum))){
var expts__$1 = ((cljs.core.vector_QMARK_(expts))?emmy.polynomial.exponent.dense__GT_exponents(expts):((cljs.core.sorted_QMARK_(expts))?expts:((cljs.core.map_QMARK_(expts))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.empty,expts):emmy.util.illegal("Invalid inputs to sparse->terms TODO")
)));
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum),emmy$polynomial$impl$iter__32804(cljs.core.rest(s__32805__$2)));
} else {
var G__32960 = cljs.core.rest(s__32805__$2);
s__32805__$1 = G__32960;
continue;
}
}
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$map_coefficients_$_iter__32827(s__32828){
return (new cljs.core.LazySeq(null,(function (){
var s__32828__$1 = s__32828;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32828__$1);
if(temp__5825__auto__){
var s__32828__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32828__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32828__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32830 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32829 = (0);
while(true){
if((i__32829 < size__5648__auto__)){
var vec__32832 = cljs.core._nth(c__5647__auto__,i__32829);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32832,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32832,(1),null);
...
cljs.core.chunk_append(b__32830,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c));

var G__32963 = (i__32829 + (1));
i__32829 = G__32963;
continue;
} else {
var G__32964 = (i__32829 + (1));
i__32829 = G__32964;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32830),emmy$polynomial$impl$map_coefficients_$_iter__32827(cljs.core.chunk_rest(s__32828__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32830),null);
}
} else {
var vec__32843 = cljs.core.first(s__32828__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32843,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32843,(1),null);
var f_c = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(c) : f.call(null,c));
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(f_c))){
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c),emmy$polynomial$impl$map_coefficients_$_iter__32827(cljs.core.rest(s__32828__$2)));
} else {
var G__32967 = cljs.core.rest(s__32828__$2);
s__32828__$1 = G__32967;
continue;
}
}
} else {
 ...
 */
emmy.polynomial.impl.t_STAR_ts = (function emmy$polynomial$impl$t_STAR_ts(p__32873,v){
var vec__32878 = p__32873;
var tags = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32878,(0),null);
var coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32878,(1),null);
...
var vec__32886 = t;
var tags1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32886,(0),null);
var coeff1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32886,(1),null);
var G__32973 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.mul(tags,tags1),emmy.generic.mul.cljs$core$IFn$_invoke$arity$2(coeff,coeff1)));
var G__32974 = (i + (1));
acc = G__32973;
i = G__32974;
continue;
...
var vec__32912 = cljs.core.peek(v);
var vn_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32912,(0),null);
var vn_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32912,(1),null);
var good_QMARK_ = (function (p1__32905_SHARP_){
return emmy.polynomial.exponent.every_power_QMARK_(cljs.core.pos_QMARK_,p1__32905_SHARP_);
});
...
var vec__32932 = cljs.core.peek(remainder);
var r_exponents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32932,(0),null);
var r_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32932,(1),null);
...
var G__32980 = emmy.polynomial.impl.add(quotient,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_term], null));
var G__32981 = emmy.polynomial.impl.sub(remainder,emmy.polynomial.impl.t_STAR_ts(new_term,v));
quotient = G__32980;
remainder = G__32981;
continue;
} else {
