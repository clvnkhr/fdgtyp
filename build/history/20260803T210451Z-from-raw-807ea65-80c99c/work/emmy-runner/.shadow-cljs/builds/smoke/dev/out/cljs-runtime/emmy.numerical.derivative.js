...
return (function (h){
return (((function (){var G__58556 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58556) : f.call(null,G__58556));
})() - fx) / h);
});
}));
...
return (function (h){
return (((function (){var G__58567 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58567) : f.call(null,G__58567));
})() - (function (){var G__58568 = (x - h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58568) : f.call(null,G__58568));
})()) / ((2) * h));
});
});
/**
...
var fx_STAR_2 = ((2) * fx);
return (function (h){
return ((((function (){var G__58578 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58578) : f.call(null,G__58578));
})() + (function (){var G__58581 = (x - h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58581) : f.call(null,G__58581));
})()) - fx_STAR_2) / (h * h));
});
}));
...
return (fx / ((function (){var G__58606 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58606) : f.call(null,G__58606));
})() - fx));
})], null);
...
return (fx / ((function (){var G__58607 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58607) : f.call(null,G__58607));
})() - (function (){var G__58608 = (x - h);
...
return (fx / (fx - (function (){var G__58610 = (x - h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58610) : f.call(null,G__58610));
})()));
})], null);
...
return (((function (){var G__58612 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58612) : f.call(null,G__58612));
})() + (function (){var G__58613 = (x - h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58613) : f.call(null,G__58613));
})()) - ((2) * fx));
})], null);
...
var map__58616 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([defaults,m], 0));
var map__58616__$1 = cljs.core.__destructure_map(map__58616);
var opts = map__58616__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58616__$1,new cljs.core.Keyword(null,"method","method",55703592));
...
var map__58629 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([opts__$1,overrides], 0));
var map__58629__$1 = cljs.core.__destructure_map(map__58629);
var opts__$2 = map__58629__$1;
var maxterms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58629__$1,new cljs.core.Keyword(null,"maxterms","maxterms",951779603));
var tolerance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58629__$1,new cljs.core.Keyword(null,"tolerance","tolerance",406811818));
var initial_h = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58629__$1,new cljs.core.Keyword(null,"initial-h","initial-h",213105060));
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58629__$1,new cljs.core.Keyword(null,"method","method",55703592));
var info_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58629__$1,new cljs.core.Keyword(null,"info?","info?",361925553));
var map__58630 = emmy.numerical.derivative.configs(method,f,x,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x)));
var map__58630__$1 = cljs.core.__destructure_map(map__58630);
var ratio_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58630__$1,new cljs.core.Keyword(null,"ratio-fn","ratio-fn",1226148920));
var function$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58630__$1,new cljs.core.Keyword(null,"function","function",-2127255473));
var p = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58630__$1,new cljs.core.Keyword(null,"p","p",151049309));
var q = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58630__$1,new cljs.core.Keyword(null,"q","q",689001697));
