...
var G__50300 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__50301 = n;
var G__50302 = cljs.core.nnext(bs);
var G__50303 = true;
ret = G__50300;
n = G__50301;
bs = G__50302;
seen_rest_QMARK_ = G__50303;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__50229_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5162__auto__ = mkns;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return cljs.core.namespace(p1__50229_SHARP_);
}
})(),cljs.core.name(p1__50229_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__50230_SHARP_){
return (new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__5162__auto__ = mkns;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return cljs.core.namespace(p1__50230_SHARP_);
}
})(),cljs.core.name(p1__50230_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__50231_SHARP_,p2__50232_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__50231_SHARP_,p2__50232_SHARP_,(function (){var fexpr__50274 = cljs.core.val(entry);
return (fexpr__50274.cljs$core$IFn$_invoke$arity$1 ? fexpr__50274.cljs$core$IFn$_invoke$arity$1(p2__50232_SHARP_) : fexpr__50274.call(null,p2__50232_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__50278 = cljs.core.key(entry);
return (fexpr__50278.cljs$core$IFn$_invoke$arity$1 ? fexpr__50278.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__50278.call(null,bes));
})());
...
var G__50320 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__50321 = cljs.core.next(bes);
ret = G__50320;
bes = G__50321;
continue;
} else {
...
throw (new Error((""+"Unsupported binding form: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(b))));
...
var temp__5823__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50236_SHARP_){
return (cljs.core.first(p1__50236_SHARP_) instanceof cljs.core.Keyword);
}),bents));
if(temp__5823__auto__){
var kwbs = temp__5823__auto__;
throw (new Error((""+"Unsupported binding key: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.ffirst(kwbs)))));
} else {
