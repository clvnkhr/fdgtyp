...
return emmy.expression.__GT_Literal(e.type,(function (){var G__26745 = e.expression;
...
if(emmy.expression.literal_QMARK_(expr)){
var G__26879 = emmy.expression.expression_of(expr);
expr = G__26879;
continue;
} else {
...
var vec__26765 = node;
var seq__26766 = cljs.core.seq(vec__26765);
var first__26767 = cljs.core.first(seq__26766);
var seq__26766__$1 = cljs.core.next(seq__26766);
var f_sym = first__26767;
...
if(emmy.expression.literal_QMARK_(expr)){
return emmy.expression.fmap((function (p1__26768_SHARP_){
return emmy.expression.substitute.cljs$core$IFn$_invoke$arity$2(p1__26768_SHARP_,s_map);
}),expr);
} else {
...
var head_compare = (function (){var G__26791 = cljs.core.first(l);
var G__26792 = cljs.core.first(r);
return (emmy.expression.compare.cljs$core$IFn$_invoke$arity$2 ? emmy.expression.compare.cljs$core$IFn$_invoke$arity$2(G__26791,G__26792) : emmy.expression.compare.call(null,G__26791,G__26792));
})();
if((head_compare === (0))){
var G__26935 = cljs.core.rest(l);
var G__26936 = cljs.core.rest(r);
l = G__26935;
r = G__26936;
continue;
} else {
...
return (((!(cljs.core.sequential_QMARK_(xs)))) || (cljs.core.every_QMARK_((function (p__26798){
var vec__26799 = p__26798;
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26799,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26799,(1),null);
