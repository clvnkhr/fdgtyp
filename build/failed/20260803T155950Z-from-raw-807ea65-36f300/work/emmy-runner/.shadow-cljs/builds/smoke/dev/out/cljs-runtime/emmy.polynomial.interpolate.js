...
var build_term = (function (i,p__32667){
var vec__32668 = p__32667;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32668,(0),null);
var fa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32668,(1),null);
var others = (function (){var iter__5649__auto__ = (function emmy$polynomial$interpolate$lagrange_$_iter__32671(s__32672){
return (new cljs.core.LazySeq(null,(function (){
var s__32672__$1 = s__32672;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32672__$1);
if(temp__5825__auto__){
var s__32672__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32672__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32672__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32674 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32673 = (0);
while(true){
if((i__32673 < size__5648__auto__)){
var j = cljs.core._nth(c__5647__auto__,i__32673);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(i,j)){
cljs.core.chunk_append(b__32674,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(points__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,(0)], null)));

var G__32911 = (i__32673 + (1));
i__32673 = G__32911;
continue;
} else {
var G__32912 = (i__32673 + (1));
i__32673 = G__32912;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32674),emmy$polynomial$interpolate$lagrange_$_iter__32671(cljs.core.chunk_rest(s__32672__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32674),null);
}
} else {
var j = cljs.core.first(s__32672__$2);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(i,j)){
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(points__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,(0)], null)),emmy$polynomial$interpolate$lagrange_$_iter__32671(cljs.core.rest(s__32672__$2)));
} else {
var G__32917 = cljs.core.rest(s__32672__$2);
s__32672__$1 = G__32917;
continue;
}
}
} else {
...
var p = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32662_SHARP_){
return emmy.generic._.cljs$core$IFn$_invoke$arity$2(x,p1__32662_SHARP_);
}),others));
var q = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32663_SHARP_){
return emmy.generic._.cljs$core$IFn$_invoke$arity$2(a,p1__32663_SHARP_);
}),others));
...
var vec__32697 = points__$1;
var vec__32700 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32697,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32700,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32700,(1),null);
return y;
} else {
var l_branch = cljs.core.pop(points__$1);
var r_branch = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(points__$1,(1));
var vec__32705 = cljs.core.first(points__$1);
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32705,(0),null);
var vec__32708 = cljs.core.peek(points__$1);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32708,(0),null);
 ...
 *   
 */
emmy.polynomial.interpolate.neville_prepare = (function emmy$polynomial$interpolate$neville_prepare(p__32724){
var vec__32726 = p__32724;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32726,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32726,(1),null);
...
return (function (p__32734,p__32735){
var vec__32736 = p__32734;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32736,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32736,(1),null);
var pl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32736,(2),null);
var vec__32739 = p__32735;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32739,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32739,(1),null);
var pr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32739,(2),null);
...
return (function (p__32790,p__32791){
var vec__32792 = p__32790;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32792,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32792,(1),null);
var pl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32792,(2),null);
var vec__32795 = p__32791;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32795,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32795,(1),null);
var pr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32795,(2),null);
 ...
 */
emmy.polynomial.interpolate.mn_prepare = (function emmy$polynomial$interpolate$mn_prepare(p__32816){
var vec__32817 = p__32816;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32817,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32817,(1),null);
...
return (function (p__32822,p__32823){
var vec__32824 = p__32822;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32824,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32824,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32824,(2),null);
var dl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32824,(3),null);
var vec__32827 = p__32823;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32827,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32827,(1),null);
var cr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32827,(2),null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32827,(3),null);
var diff = (cr - dl);
var den = (xl - xr);
var factor = (diff / den);
var c = (factor * (xl - x));
...
return emmy.util.aggregate.scan.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__32836){
var vec__32837 = p__32836;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32837,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32837,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32837,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32837,(3),null);
return c;
}),row));
});
/**
...
G__32954 = function(prev_row,point){
switch(arguments.length){
case 0:
return G__32954__0.call(this);
case 1:
return G__32954__1.call(this,prev_row);
case 2:
return G__32954__2.call(this,prev_row,point);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__32954.cljs$core$IFn$_invoke$arity$0 = G__32954__0;
...
return cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__32849){
var vec__32850 = p__32849;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32850,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32850,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32850,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32850,(3),null);
return c;
