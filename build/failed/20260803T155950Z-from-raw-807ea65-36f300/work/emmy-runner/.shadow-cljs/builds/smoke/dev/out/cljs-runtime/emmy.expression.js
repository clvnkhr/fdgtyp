...
return emmy.expression.__GT_Literal(e.type,(function (){var G__28155 = e.expression;
...
if(emmy.expression.literal_QMARK_(expr)){
var G__28220 = emmy.expression.expression_of(expr);
expr = G__28220;
continue;
} else {
...
var f_sym = first__28164;
var args = seq__28163__$1;
...
if(emmy.expression.literal_QMARK_(expr)){
return emmy.expression.fmap((function (p1__28166_SHARP_){
return emmy.expression.substitute.cljs$core$IFn$_invoke$arity$2(p1__28166_SHARP_,s_map);
}),expr);
} else {
...
var head_compare = (function (){var G__28175 = cljs.core.first(l);
var G__28176 = cljs.core.first(r);
return (emmy.expression.compare.cljs$core$IFn$_invoke$arity$2 ? emmy.expression.compare.cljs$core$IFn$_invoke$arity$2(G__28175,G__28176) : emmy.expression.compare.call(null,G__28175,G__28176));
})();
if((head_compare === (0))){
var G__28235 = cljs.core.rest(l);
var G__28236 = cljs.core.rest(r);
l = G__28235;
r = G__28236;
continue;
} else {
...
return (((!(cljs.core.sequential_QMARK_(xs)))) || (cljs.core.every_QMARK_((function (p__28178){
var vec__28179 = p__28178;
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28179,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28179,(1),null);
