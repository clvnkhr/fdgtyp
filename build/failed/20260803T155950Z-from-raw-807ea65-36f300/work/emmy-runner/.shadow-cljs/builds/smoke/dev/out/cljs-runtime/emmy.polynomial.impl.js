...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(emmy.polynomial.impl.exponents,comparator,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$iter__32862(s__32863){
return (new cljs.core.LazySeq(null,(function (){
var s__32863__$1 = s__32863;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32863__$1);
if(temp__5825__auto__){
var s__32863__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32863__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32863__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32865 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32864 = (0);
while(true){
if((i__32864 < size__5648__auto__)){
var vec__32878 = cljs.core._nth(c__5647__auto__,i__32864);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32878,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32878,(1),null);
...
cljs.core.chunk_append(b__32865,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum));

var G__32998 = (i__32864 + (1));
i__32864 = G__32998;
continue;
} else {
var G__32999 = (i__32864 + (1));
i__32864 = G__32999;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32865),emmy$polynomial$impl$iter__32862(cljs.core.chunk_rest(s__32863__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32865),null);
}
} else {
var vec__32904 = cljs.core.first(s__32863__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32904,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32904,(1),null);
var coef_sum = cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1(emmy.polynomial.impl.coefficient),emmy.generic._PLUS_,terms);
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(coef_sum))){
var expts__$1 = ((cljs.core.vector_QMARK_(expts))?emmy.polynomial.exponent.dense__GT_exponents(expts):((cljs.core.sorted_QMARK_(expts))?expts:((cljs.core.map_QMARK_(expts))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.empty,expts):emmy.util.illegal("Invalid inputs to sparse->terms TODO")
)));
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum),emmy$polynomial$impl$iter__32862(cljs.core.rest(s__32863__$2)));
} else {
var G__33003 = cljs.core.rest(s__32863__$2);
s__32863__$1 = G__33003;
continue;
}
}
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$map_coefficients_$_iter__32918(s__32919){
return (new cljs.core.LazySeq(null,(function (){
var s__32919__$1 = s__32919;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32919__$1);
if(temp__5825__auto__){
var s__32919__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32919__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32919__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32921 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32920 = (0);
while(true){
if((i__32920 < size__5648__auto__)){
var vec__32926 = cljs.core._nth(c__5647__auto__,i__32920);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32926,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32926,(1),null);
...
cljs.core.chunk_append(b__32921,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c));

var G__33006 = (i__32920 + (1));
i__32920 = G__33006;
continue;
} else {
var G__33007 = (i__32920 + (1));
i__32920 = G__33007;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32921),emmy$polynomial$impl$map_coefficients_$_iter__32918(cljs.core.chunk_rest(s__32919__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32921),null);
}
} else {
var vec__32932 = cljs.core.first(s__32919__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32932,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32932,(1),null);
var f_c = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(c) : f.call(null,c));
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(f_c))){
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c),emmy$polynomial$impl$map_coefficients_$_iter__32918(cljs.core.rest(s__32919__$2)));
} else {
var G__33008 = cljs.core.rest(s__32919__$2);
s__32919__$1 = G__33008;
continue;
}
}
} else {
 ...
 */
emmy.polynomial.impl.t_STAR_ts = (function emmy$polynomial$impl$t_STAR_ts(p__32940,v){
var vec__32942 = p__32940;
var tags = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32942,(0),null);
var coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32942,(1),null);
...
var vec__32945 = t;
var tags1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32945,(0),null);
var coeff1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32945,(1),null);
var G__33030 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.mul(tags,tags1),emmy.generic.mul.cljs$core$IFn$_invoke$arity$2(coeff,coeff1)));
var G__33031 = (i + (1));
acc = G__33030;
i = G__33031;
continue;
...
var vec__32961 = cljs.core.peek(v);
var vn_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32961,(0),null);
var vn_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32961,(1),null);
var good_QMARK_ = (function (p1__32957_SHARP_){
return emmy.polynomial.exponent.every_power_QMARK_(cljs.core.pos_QMARK_,p1__32957_SHARP_);
});
...
var vec__32975 = cljs.core.peek(remainder);
var r_exponents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32975,(0),null);
var r_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32975,(1),null);
...
var G__33033 = emmy.polynomial.impl.add(quotient,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_term], null));
var G__33034 = emmy.polynomial.impl.sub(remainder,emmy.polynomial.impl.t_STAR_ts(new_term,v));
quotient = G__33033;
remainder = G__33034;
continue;
} else {
