...
var emmy$expression$analyze$ICanonicalize$expression__GT_$dyn_36988 = (function() {
var G__36989 = null;
var G__36989__3 = (function (analyzer,x,continue$){
...
var G__36989__4 = (function (analyzer,x,continue$,compare_fn){
var x__5519__auto__ = (((analyzer == null))?null:analyzer);
var m__5520__auto__ = (emmy.expression.analyze.expression__GT_[goog.typeOf(x__5519__auto__)]);
if((!((m__5520__auto__ == null)))){
...
G__36989 = function(analyzer,x,continue$,compare_fn){
switch(arguments.length){
case 3:
return G__36989__3.call(this,analyzer,x,continue$);
case 4:
return G__36989__4.call(this,analyzer,x,continue$,compare_fn);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__36989.cljs$core$IFn$_invoke$arity$3 = G__36989__3;
G__36989.cljs$core$IFn$_invoke$arity$4 = G__36989__4;
return G__36989;
})()
;
/**
...
return emmy$expression$analyze$ICanonicalize$expression__GT_$dyn_36988(analyzer,x,continue$);
}
}));
...
return emmy$expression$analyze$ICanonicalize$expression__GT_$dyn_36988(analyzer,x,continue$,compare_fn);
}
}));
...
var emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$dyn_36998 = (function (analyzer,x){
var x__5519__auto__ = (((analyzer == null))?null:analyzer);
...
return emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$dyn_36998(analyzer,x);
}
});
...
var vcompare_37004 = emmy.expression.analyze.make_vcompare(emmy.expression.variables_in(expr));
cljs.core.reset_BANG_(compare_fn,vcompare_37004);
...
var G__36949_37007 = expr__GT_var;
var G__36950_37008 = cljs.core.PersistentArrayMap.EMPTY;
(ref_set.cljs$core$IFn$_invoke$arity$2 ? ref_set.cljs$core$IFn$_invoke$arity$2(G__36949_37007,G__36950_37008) : ref_set.call(null,G__36949_37007,G__36950_37008));

var G__36951_37009 = var__GT_expr;
var G__36952_37010 = cljs.core.PersistentArrayMap.EMPTY;
(ref_set.cljs$core$IFn$_invoke$arity$2 ? ref_set.cljs$core$IFn$_invoke$arity$2(G__36951_37009,G__36952_37010) : ref_set.call(null,G__36951_37009,G__36952_37010));

return null;
});
var base_simplify = (function emmy$expression$analyze$base_simplify(expr){
if(cljs.core.truth_(unquoted_list_QMARK_(expr))){
return emmy.expression.analyze.expression__GT_(backend,expr,(function (p1__36901_SHARP_,p2__36902_SHARP_){
return emmy.expression.analyze.__GT_expression(backend,p1__36901_SHARP_,p2__36902_SHARP_);
}),v_compare);
} else {
return expr;
}
...
var _STAR_incremental_simplifier_STAR__orig_val__36956 = emmy.numsymb._STAR_incremental_simplifier_STAR_;
var _STAR_incremental_simplifier_STAR__temp_val__36957 = false;
(emmy.numsymb._STAR_incremental_simplifier_STAR_ = _STAR_incremental_simplifier_STAR__temp_val__36957);

try{return base_simplify(analyze(expr));
}finally {(emmy.numsymb._STAR_incremental_simplifier_STAR_ = _STAR_incremental_simplifier_STAR__orig_val__36956);
}});
