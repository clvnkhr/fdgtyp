...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__48770_SHARP_){
return (s * p1__48770_SHARP_);
}),v);
});
/**
 ...
 */
emmy.numerical.multimin.nelder_mead.initial_simplex = (function emmy$numerical$multimin$nelder_mead$initial_simplex(x0,p__48773){
var map__48774 = p__48773;
var map__48774__$1 = cljs.core.__destructure_map(map__48774);
var nonzero_delta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48774__$1,new cljs.core.Keyword(null,"nonzero-delta","nonzero-delta",-794646863),0.05);
var zero_delta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48774__$1,new cljs.core.Keyword(null,"zero-delta","zero-delta",-2009573292),2.5E-4);
 ...
 */
emmy.numerical.multimin.nelder_mead.sup_norm = (function emmy$numerical$multimin$nelder_mead$sup_norm(p__48778){
var vec__48779 = p__48778;
var x0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48779,(0),null);
var simplex = vec__48779;
var coords = ((cljs.core.sequential_QMARK_(x0))?cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__48775_SHARP_){
return emmy.numerical.multimin.nelder_mead.v_(p1__48775_SHARP_,x0);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([simplex], 0)):cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48776_SHARP_){
return (p1__48776_SHARP_ - x0);
}),simplex));
 ...
 */
emmy.numerical.multimin.nelder_mead.step_defaults = (function emmy$numerical$multimin$nelder_mead$step_defaults(dimension,p__48825){
var map__48826 = p__48825;
var map__48826__$1 = cljs.core.__destructure_map(map__48826);
var m = map__48826__$1;
var adaptive_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48826__$1,new cljs.core.Keyword(null,"adaptive?","adaptive?",-259268570),true);
...
var map__48833 = emmy.numerical.multimin.nelder_mead.step_defaults(dimension,opts);
var map__48833__$1 = cljs.core.__destructure_map(map__48833);
var alpha = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48833__$1,new cljs.core.Keyword(null,"alpha","alpha",-1574982441));
var beta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48833__$1,new cljs.core.Keyword(null,"beta","beta",455605892));
var sigma = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48833__$1,new cljs.core.Keyword(null,"sigma","sigma",-63715703));
var gamma = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48833__$1,new cljs.core.Keyword(null,"gamma","gamma",1883969687));
...
var shrink = (function emmy$numerical$multimin$nelder_mead$step_fn_$_shrink(p__48849){
...
var s0 = first__48852;
var rest = seq__48851__$1;
var scale_toward_s0 = (function (p1__48831_SHARP_){
return emmy.numerical.multimin.nelder_mead.v_PLUS_(s0,emmy.numerical.multimin.nelder_mead.v_STAR_(sigma,emmy.numerical.multimin.nelder_mead.v_(p1__48831_SHARP_,s0)));
});
...
return (function (simplex,p__48854){
var vec__48855 = p__48854;
var f_best = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48855,(0),null);
var f_simplex = vec__48855;
...
if(cljs.core.truth_((function (p1__48832_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._LT__EQ_,cljs.core.second(p1__48832_SHARP_));
}))){
} else {
throw (new Error("Assert failed: (fn* [p1__48832#] (apply <= (second p1__48832#)))"));
}
 ...
 */
emmy.numerical.multimin.nelder_mead.convergence_fn = (function emmy$numerical$multimin$nelder_mead$convergence_fn(p__48900){
var map__48901 = p__48900;
var map__48901__$1 = cljs.core.__destructure_map(map__48901);
var simplex_tolerance = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48901__$1,new cljs.core.Keyword(null,"simplex-tolerance","simplex-tolerance",1524945145),1.0E-4);
var fn_tolerance = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48901__$1,new cljs.core.Keyword(null,"fn-tolerance","fn-tolerance",-1445606164),1.0E-4);
 ...
 */
emmy.numerical.multimin.nelder_mead.stop_fn = (function emmy$numerical$multimin$nelder_mead$stop_fn(f_counter,dimension,p__48902){
var map__48903 = p__48902;
var map__48903__$1 = cljs.core.__destructure_map(map__48903);
var maxiter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48903__$1,new cljs.core.Keyword(null,"maxiter","maxiter",-1867223754));
var maxfun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48903__$1,new cljs.core.Keyword(null,"maxfun","maxfun",-50301814));
 ...
 *   
 */
emmy.numerical.multimin.nelder_mead.nelder_mead = (function emmy$numerical$multimin$nelder_mead$nelder_mead(func,x0,p__48904){
var map__48905 = p__48904;
var map__48905__$1 = cljs.core.__destructure_map(map__48905);
var opts = map__48905__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48905__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
...
var vec__48906 = emmy.numerical.multimin.nelder_mead.counted(func);
var f_counter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48906,(0),null);
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48906,(1),null);
...
var G__48918 = emmy.numerical.multimin.nelder_mead.sort_by_f.cljs$core$IFn$_invoke$arity$3(simplex,f_simplex,dimension);
var vec__48919 = G__48918;
var vec__48922 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48919,(0),null);
var s0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48922,(0),null);
var simplex__$1 = vec__48922;
var vec__48925 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48919,(1),null);
var f0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48925,(0),null);
var f_simplex__$1 = vec__48925;
var iteration = (0);
var G__48918__$1 = G__48918;
var iteration__$1 = iteration;
while(true){
var vec__48944 = G__48918__$1;
var vec__48947 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48944,(0),null);
var s0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48947,(0),null);
var simplex__$2 = vec__48947;
var vec__48950 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48944,(1),null);
var f0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48950,(0),null);
var f_simplex__$2 = vec__48950;
...
var G__48976 = (step.cljs$core$IFn$_invoke$arity$2 ? step.cljs$core$IFn$_invoke$arity$2(simplex__$2,f_simplex__$2) : step.call(null,simplex__$2,f_simplex__$2));
var G__48977 = (iteration__$2 + (1));
G__48918__$1 = G__48976;
iteration__$1 = G__48977;
continue;
}
break;
}
