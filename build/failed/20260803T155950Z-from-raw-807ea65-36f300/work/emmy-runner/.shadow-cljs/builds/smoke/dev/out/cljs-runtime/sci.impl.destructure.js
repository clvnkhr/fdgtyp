...
var G__50284 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__50285 = n;
var G__50286 = cljs.core.nnext(bs);
var G__50287 = true;
ret = G__50284;
n = G__50285;
bs = G__50286;
seen_rest_QMARK_ = G__50287;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__50231_SHARP_,p2__50232_SHARP_,(function (){var fexpr__50252 = cljs.core.val(entry);
return (fexpr__50252.cljs$core$IFn$_invoke$arity$1 ? fexpr__50252.cljs$core$IFn$_invoke$arity$1(p2__50232_SHARP_) : fexpr__50252.call(null,p2__50232_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__50253 = cljs.core.key(entry);
return (fexpr__50253.cljs$core$IFn$_invoke$arity$1 ? fexpr__50253.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__50253.call(null,bes));
})());
...
var G__50304 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__50305 = cljs.core.next(bes);
ret = G__50304;
bes = G__50305;
continue;
} else {
...
var temp__5823__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50234_SHARP_){
return (cljs.core.first(p1__50234_SHARP_) instanceof cljs.core.Keyword);
}),bents));
