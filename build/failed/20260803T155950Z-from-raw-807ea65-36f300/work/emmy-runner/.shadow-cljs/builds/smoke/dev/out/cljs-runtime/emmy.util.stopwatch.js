...
var emmy$util$stopwatch$IStopwatch$running_QMARK_$dyn_36846 = (function (this$){
...
return emmy$util$stopwatch$IStopwatch$running_QMARK_$dyn_36846(this$);
}
});

var emmy$util$stopwatch$IStopwatch$start$dyn_36849 = (function (this$){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$util$stopwatch$IStopwatch$start$dyn_36849(this$);
}
});

var emmy$util$stopwatch$IStopwatch$stop$dyn_36850 = (function (this$){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$util$stopwatch$IStopwatch$stop$dyn_36850(this$);
}
});

var emmy$util$stopwatch$IStopwatch$reset$dyn_36851 = (function (this$){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$util$stopwatch$IStopwatch$reset$dyn_36851(this$);
}
});

var emmy$util$stopwatch$IStopwatch$_elapsed$dyn_36852 = (function (this$,unit){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$util$stopwatch$IStopwatch$_elapsed$dyn_36852(this$,unit);
}
});

var emmy$util$stopwatch$IStopwatch$repr$dyn_36853 = (function (this$){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$util$stopwatch$IStopwatch$repr$dyn_36853(this$);
}
});
...
var __GT_micros_36867 = 1000.0;
var __GT_ms_36868 = (__GT_micros_36867 * 1000.0);
var __GT_s_36869 = (__GT_ms_36868 * 1000.0);
var __GT_m_36870 = (__GT_s_36869 * (60));
var __GT_h_36871 = (__GT_m_36870 * (60));
var __GT_d_36872 = (__GT_h_36871 * (24));
emmy.util.stopwatch.from_nanos = (function emmy$util$stopwatch$from_nanos(ns,unit){
return (ns / (function (){var G__36784 = unit;
...
break;
case "micros":
return __GT_micros_36867;

break;
case "millis":
return __GT_ms_36868;
...
var or__5162__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__36786_SHARP_){
return (p1__36786_SHARP_ > (1));
}),cljs.core.first),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2((function (p1__36785_SHARP_){
return emmy.util.stopwatch.from_nanos(ns,p1__36785_SHARP_);
...
var self__ = this;
var this$__$1 = this;
var vec__36799 = emmy.util.stopwatch.choose_unit(emmy.util.stopwatch.elapsed.cljs$core$IFn$_invoke$arity$2(this$__$1,new cljs.core.Keyword(null,"nanos","nanos",-1777059258)));
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36799,(0),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36799,(1),null);
...
*/
emmy.util.stopwatch.t_emmy$util$stopwatch36804 = (function (stopwatch,sw,meta36805){
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36804.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36806,meta36805__$1){
var self__ = this;
var _36806__$1 = this;
return (new emmy.util.stopwatch.t_emmy$util$stopwatch36804(self__.stopwatch,self__.sw,meta36805__$1));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36804.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36806){
var self__ = this;
var _36806__$1 = this;
return self__.meta36805;
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36804.prototype.emmy$util$stopwatch$IStopwatch$ = cljs.core.PROTOCOL_SENTINEL);

(emmy.util.stopwatch.t_emmy$util$stopwatch36804.prototype.emmy$util$stopwatch$IStopwatch$running_QMARK_$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return emmy.util.stopwatch.running_QMARK_(cljs.core.deref(self__.sw));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36804.prototype.emmy$util$stopwatch$IStopwatch$start$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36804.prototype.emmy$util$stopwatch$IStopwatch$stop$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36804.prototype.emmy$util$stopwatch$IStopwatch$reset$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36804.prototype.emmy$util$stopwatch$IStopwatch$_elapsed$arity$2 = (function (_,unit){
var self__ = this;
var ___$1 = this;
return emmy.util.stopwatch._elapsed(cljs.core.deref(self__.sw),unit);
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36804.prototype.emmy$util$stopwatch$IStopwatch$repr$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return emmy.util.stopwatch.repr(cljs.core.deref(self__.sw));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36804.prototype.toString = (function (){
var self__ = this;
var _ = this;
return emmy.util.stopwatch.repr(cljs.core.deref(self__.sw));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36804.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"stopwatch","stopwatch",-1262782731,null),new cljs.core.Symbol(null,"sw","sw",-1821321856,null),new cljs.core.Symbol(null,"meta36805","meta36805",-1924176140,null)], null);
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36804.cljs$lang$type = true);

(emmy.util.stopwatch.t_emmy$util$stopwatch36804.cljs$lang$ctorStr = "emmy.util.stopwatch/t_emmy$util$stopwatch36804");

(emmy.util.stopwatch.t_emmy$util$stopwatch36804.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"emmy.util.stopwatch/t_emmy$util$stopwatch36804");
}));

/**
 * Positional factory function for emmy.util.stopwatch/t_emmy$util$stopwatch36804.
 */
emmy.util.stopwatch.__GT_t_emmy$util$stopwatch36804 = (function emmy$util$stopwatch$__GT_t_emmy$util$stopwatch36804(stopwatch__$1,sw,meta36805){
return (new emmy.util.stopwatch.t_emmy$util$stopwatch36804(stopwatch__$1,sw,meta36805));
});
...
return (new emmy.util.stopwatch.t_emmy$util$stopwatch36804(stopwatch__$1,sw,cljs.core.PersistentArrayMap.EMPTY));
});
/**
...
var len__5897__auto___36880 = arguments.length;
var i__5898__auto___36881 = (0);
while(true){
if((i__5898__auto___36881 < len__5897__auto___36880)){
args__5903__auto__.push((arguments[i__5898__auto___36881]));

var G__36882 = (i__5898__auto___36881 + (1));
i__5898__auto___36881 = G__36882;
continue;
} else {
}
break;
...
(emmy.util.stopwatch.stopwatch.cljs$core$IFn$_invoke$arity$variadic = (function (p__36836){
var map__36839 = p__36836;
var map__36839__$1 = cljs.core.__destructure_map(map__36839);
var started_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36839__$1,new cljs.core.Keyword(null,"started?","started?",-1301062863),true);
...
/** @this {Function} */
(emmy.util.stopwatch.stopwatch.cljs$lang$applyTo = (function (seq36831){
var self__5883__auto__ = this;
return self__5883__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36831));
}));
