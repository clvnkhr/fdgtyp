...
var arg_count_52738 = (cljs.core.count(expr) - (1));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((2),arg_count_52738)){
} else {
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2((""+"Wrong number of args ("+cljs.core.str.cljs$core$IFn$_invoke$arity$1(arg_count_52738)+") passed to: clojure.core/for"),expr);
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__52576){
var vec__52582 = p__52576;
...
var err = (function() { 
var G__52739__delegate = function (msg){
throw (new Error(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,msg)));
};
var G__52739 = function (var_args){
var msg = null;
if (arguments.length > 0) {
var G__52744__i = 0, G__52744__a = new Array(arguments.length -  0);
while (G__52744__i < G__52744__a.length) {G__52744__a[G__52744__i] = arguments[G__52744__i + 0]; ++G__52744__i;}
  msg = new cljs.core.IndexedSeq(G__52744__a,0,null);
} 
return G__52739__delegate.call(this,msg);};
G__52739.cljs$lang$maxFixedArity = 0;
G__52739.cljs$lang$applyTo = (function (arglist__52745){
var msg = cljs.core.seq(arglist__52745);
return G__52739__delegate(msg);
});
G__52739.cljs$core$IFn$_invoke$arity$variadic = G__52739__delegate;
return G__52739;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__52594){
var vec__52596 = p__52594;
var seq__52597 = cljs.core.seq(vec__52596);
var first__52598 = cljs.core.first(seq__52597);
var seq__52597__$1 = cljs.core.next(seq__52597);
var vec__52599 = first__52598;
var seq__52600 = cljs.core.seq(vec__52599);
var first__52601 = cljs.core.first(seq__52600);
var seq__52600__$1 = cljs.core.next(seq__52600);
var bind = first__52601;
var first__52601__$1 = cljs.core.first(seq__52600__$1);
var seq__52600__$2 = cljs.core.next(seq__52600__$1);
var expr__$1 = first__52601__$1;
var mod_pairs = seq__52600__$2;
var vec__52602 = seq__52597__$1;
var vec__52605 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52602,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52605,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52605,(1),null);
var next_groups = vec__52602;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__52610){
var vec__52613 = p__52610;
...
var vec__52616 = first__52615;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52616,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52616,(1),null);
var pair = vec__52616;
var etc = seq__52614__$1;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__52546__auto__","iterys__52546__auto__",-392905411,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__52547__auto__","fs__52547__auto__",620905175,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__52546__auto__","iterys__52546__auto__",-392905411,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__52547__auto__","fs__52547__auto__",620905175,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__52547__auto__","fs__52547__auto__",620905175,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__52658){
var vec__52663 = p__52658;
var seq__52664 = cljs.core.seq(vec__52663);
var first__52665 = cljs.core.first(seq__52664);
var seq__52664__$1 = cljs.core.next(seq__52664);
var vec__52666 = first__52665;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52666,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52666,(1),null);
var pair = vec__52666;
var etc = seq__52664__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k,new cljs.core.Keyword(null,"let","let",-1282412701))){
