...
var G__50276 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__50277 = n;
var G__50278 = cljs.core.nnext(bs);
var G__50279 = true;
ret = G__50276;
n = G__50277;
bs = G__50278;
seen_rest_QMARK_ = G__50279;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__50253_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5162__auto__ = mkns;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return cljs.core.namespace(p1__50253_SHARP_);
}
})(),cljs.core.name(p1__50253_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__50254_SHARP_){
...
return cljs.core.namespace(p1__50254_SHARP_);
}
})(),cljs.core.name(p1__50254_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__50255_SHARP_,p2__50256_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__50255_SHARP_,p2__50256_SHARP_,(function (){var fexpr__50268 = cljs.core.val(entry);
return (fexpr__50268.cljs$core$IFn$_invoke$arity$1 ? fexpr__50268.cljs$core$IFn$_invoke$arity$1(p2__50256_SHARP_) : fexpr__50268.call(null,p2__50256_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__50269 = cljs.core.key(entry);
return (fexpr__50269.cljs$core$IFn$_invoke$arity$1 ? fexpr__50269.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__50269.call(null,bes));
})());
...
var G__50289 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__50290 = cljs.core.next(bes);
ret = G__50289;
bes = G__50290;
continue;
} else {
...
var temp__5823__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50259_SHARP_){
return (cljs.core.first(p1__50259_SHARP_) instanceof cljs.core.Keyword);
}),bents));
