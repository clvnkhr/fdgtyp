...
var emmy$util$stopwatch$IStopwatch$running_QMARK_$dyn_36859 = (function (this$){
...
return emmy$util$stopwatch$IStopwatch$running_QMARK_$dyn_36859(this$);
}
});
...
var or__5162__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__36804_SHARP_){
return (p1__36804_SHARP_ > (1));
}),cljs.core.first),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2((function (p1__36803_SHARP_){
return emmy.util.stopwatch.from_nanos(ns,p1__36803_SHARP_);
...
var self__ = this;
var this$__$1 = this;
var vec__36823 = emmy.util.stopwatch.choose_unit(emmy.util.stopwatch.elapsed.cljs$core$IFn$_invoke$arity$2(this$__$1,new cljs.core.Keyword(null,"nanos","nanos",-1777059258)));
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36823,(0),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36823,(1),null);
...
*/
emmy.util.stopwatch.t_emmy$util$stopwatch36838 = (function (stopwatch,sw,meta36839){
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36838.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36840,meta36839__$1){
var self__ = this;
var _36840__$1 = this;
return (new emmy.util.stopwatch.t_emmy$util$stopwatch36838(self__.stopwatch,self__.sw,meta36839__$1));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36838.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36840){
var self__ = this;
var _36840__$1 = this;
return self__.meta36839;
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36838.prototype.emmy$util$stopwatch$IStopwatch$ = cljs.core.PROTOCOL_SENTINEL);

(emmy.util.stopwatch.t_emmy$util$stopwatch36838.prototype.emmy$util$stopwatch$IStopwatch$running_QMARK_$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return emmy.util.stopwatch.running_QMARK_(cljs.core.deref(self__.sw));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36838.prototype.emmy$util$stopwatch$IStopwatch$start$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36838.prototype.emmy$util$stopwatch$IStopwatch$stop$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36838.prototype.emmy$util$stopwatch$IStopwatch$reset$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
...
(emmy.util.stopwatch.t_emmy$util$stopwatch36838.prototype.emmy$util$stopwatch$IStopwatch$_elapsed$arity$2 = (function (_,unit){
var self__ = this;
var ___$1 = this;
return emmy.util.stopwatch._elapsed(cljs.core.deref(self__.sw),unit);
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36838.prototype.emmy$util$stopwatch$IStopwatch$repr$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return emmy.util.stopwatch.repr(cljs.core.deref(self__.sw));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36838.prototype.toString = (function (){
var self__ = this;
var _ = this;
return emmy.util.stopwatch.repr(cljs.core.deref(self__.sw));
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36838.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"stopwatch","stopwatch",-1262782731,null),new cljs.core.Symbol(null,"sw","sw",-1821321856,null),new cljs.core.Symbol(null,"meta36839","meta36839",742655550,null)], null);
}));

(emmy.util.stopwatch.t_emmy$util$stopwatch36838.cljs$lang$type = true);

(emmy.util.stopwatch.t_emmy$util$stopwatch36838.cljs$lang$ctorStr = "emmy.util.stopwatch/t_emmy$util$stopwatch36838");

(emmy.util.stopwatch.t_emmy$util$stopwatch36838.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"emmy.util.stopwatch/t_emmy$util$stopwatch36838");
}));

/**
 * Positional factory function for emmy.util.stopwatch/t_emmy$util$stopwatch36838.
 */
emmy.util.stopwatch.__GT_t_emmy$util$stopwatch36838 = (function emmy$util$stopwatch$__GT_t_emmy$util$stopwatch36838(stopwatch__$1,sw,meta36839){
return (new emmy.util.stopwatch.t_emmy$util$stopwatch36838(stopwatch__$1,sw,meta36839));
});
...
return (new emmy.util.stopwatch.t_emmy$util$stopwatch36838(stopwatch__$1,sw,cljs.core.PersistentArrayMap.EMPTY));
});
/**
...
var len__5897__auto___36875 = arguments.length;
var i__5898__auto___36876 = (0);
while(true){
if((i__5898__auto___36876 < len__5897__auto___36875)){
args__5903__auto__.push((arguments[i__5898__auto___36876]));

var G__36877 = (i__5898__auto___36876 + (1));
i__5898__auto___36876 = G__36877;
continue;
} else {
}
break;
...
(emmy.util.stopwatch.stopwatch.cljs$core$IFn$_invoke$arity$variadic = (function (p__36848){
var map__36849 = p__36848;
var map__36849__$1 = cljs.core.__destructure_map(map__36849);
var started_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36849__$1,new cljs.core.Keyword(null,"started?","started?",-1301062863),true);
...
/** @this {Function} */
(emmy.util.stopwatch.stopwatch.cljs$lang$applyTo = (function (seq36843){
var self__5883__auto__ = this;
return self__5883__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36843));
}));
