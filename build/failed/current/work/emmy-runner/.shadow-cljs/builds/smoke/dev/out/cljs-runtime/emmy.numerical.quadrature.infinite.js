...
var map__56258 = emmy.numerical.quadrature.infinite.fill_defaults(opts);
var map__56258__$1 = cljs.core.__destructure_map(map__56258);
var opts__$1 = map__56258__$1;
var infinite_breakpoint = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56258__$1,new cljs.core.Keyword(null,"infinite-breakpoint","infinite-breakpoint",1403428770));
...
var l_break = (- r_break);
var ocr_56264 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,b], null);
try{if(((cljs.core.vector_QMARK_(ocr_56264)) && ((cljs.core.count(ocr_56264) === 2)))){
try{var ocr_56264_0__56286 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56264,(0));
if((ocr_56264_0__56286 === -Infinity)){
try{var ocr_56264_1__56287 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56264,(1));
if((ocr_56264_1__56287 === -Infinity)){
...
}catch (e56378){if((e56378 instanceof Error)){
var e__31517__auto__ = e56378;
...
}catch (e56322){if((e56322 instanceof Error)){
var e__31517__auto__ = e56322;
if((e__31517__auto__ === cljs.core.match.backtrack)){
try{var ocr_56264_0__56286 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56264,(0));
if((ocr_56264_0__56286 === Infinity)){
try{var ocr_56264_1__56287 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56264,(1));
...
var e__31517__auto____$1 = e56368;
...
var e__31517__auto____$1 = e56324;
if((e__31517__auto____$1 === cljs.core.match.backtrack)){
try{var ocr_56264_0__56286 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56264,(0));
if((ocr_56264_0__56286 === -Infinity)){
try{var ocr_56264_1__56287 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56264,(1));
...
}catch (e56367){if((e56367 instanceof Error)){
var e__31517__auto____$2 = e56367;
...
}catch (e56325){if((e56325 instanceof Error)){
var e__31517__auto____$2 = e56325;
if((e__31517__auto____$2 === cljs.core.match.backtrack)){
try{var ocr_56264_0__56286 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56264,(0));
if((ocr_56264_0__56286 === Infinity)){
try{var ocr_56264_1__56287 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56264,(1));
...
var e__31517__auto____$3 = e56358;
if((e__31517__auto____$3 === cljs.core.match.backtrack)){
throw cljs.core.match.backtrack;
} else {
throw e__31517__auto____$3;
}
} else {
throw e56358;
...
var e__31517__auto____$3 = e56326;
if((e__31517__auto____$3 === cljs.core.match.backtrack)){
try{var ocr_56264_0__56286 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56264,(0));
if((ocr_56264_0__56286 === -Infinity)){
try{var ocr_56264_1__56287 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56264,(1));
...
var e__31517__auto____$4 = e56344;
if((e__31517__auto____$4 === cljs.core.match.backtrack)){
if((b <= l_break)){
...
var e__31517__auto____$4 = e56328;
if((e__31517__auto____$4 === cljs.core.match.backtrack)){
try{var ocr_56264_1__56287 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_56264,(1));
if((ocr_56264_1__56287 === Infinity)){
if((a >= r_break)){
...
var e__31517__auto____$5 = e56329;
if((e__31517__auto____$5 === cljs.core.match.backtrack)){
throw cljs.core.match.backtrack;
} else {
throw e__31517__auto____$5;
}
} else {
throw e56329;
...
}catch (e56321){if((e56321 instanceof Error)){
var e__31517__auto__ = e56321;
if((e__31517__auto__ === cljs.core.match.backtrack)){
