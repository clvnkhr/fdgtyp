...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_22120 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_22120(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_22121 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_22121(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22126 = (function (reader,ch){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22126(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22127 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22127(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22129 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22129(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22130 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22130(reader);
}
});
...
var G__22217 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__22218 = s.append(c);
c = G__22217;
s = G__22218;
continue;
}
