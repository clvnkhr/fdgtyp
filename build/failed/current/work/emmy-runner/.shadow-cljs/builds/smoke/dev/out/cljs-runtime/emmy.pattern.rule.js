...
var answer = (function (){var fexpr__36632 = cljs.core.first(rules__$1);
return (fexpr__36632.cljs$core$IFn$_invoke$arity$1 ? fexpr__36632.cljs$core$IFn$_invoke$arity$1(data) : fexpr__36632.call(null,data));
})();
...
/** @this {Function} */
(emmy.pattern.rule.choice.cljs$lang$applyTo = (function (seq36634){
var G__36635 = cljs.core.first(seq36634);
var seq36634__$1 = cljs.core.next(seq36634);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36635,seq36634__$1);
}));
...
/** @this {Function} */
(emmy.pattern.rule.pipe.cljs$lang$applyTo = (function (seq36645){
var G__36646 = cljs.core.first(seq36645);
var seq36645__$1 = cljs.core.next(seq36645);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36646,seq36645__$1);
}));
...
return emmy.pattern.rule.as_attempt((function (data){
while(true){
var data_STAR_ = (function (){var fexpr__36664 = emmy.pattern.rule.attempt(r);
return (fexpr__36664.cljs$core$IFn$_invoke$arity$1 ? fexpr__36664.cljs$core$IFn$_invoke$arity$1(data) : fexpr__36664.call(null,data));
})();
if(cljs.core.truth_((f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(data,data_STAR_) : f.call(null,data,data_STAR_)))){
return data_STAR_;
} else {
...
return (function (data){
var G__36671_36777 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"in","in",-1531184865),data], null);
(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__36671_36777) : f.call(null,G__36671_36777));

var result = (r.cljs$core$IFn$_invoke$arity$1 ? r.cljs$core$IFn$_invoke$arity$1(data) : r.call(null,data));
var G__36672_36778 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"out","out",-910545517),result], null);
(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__36672_36778) : f.call(null,G__36672_36778));
...
var G__36681 = emmy.pattern.rule.try_subexpressions(emmy$pattern$rule$bottom_up_$_rec,expression);
return (r.cljs$core$IFn$_invoke$arity$1 ? r.cljs$core$IFn$_invoke$arity$1(G__36681) : r.call(null,G__36681));
}));
});
/**
 * Given some rule `the-rule`, returns a new rule that accepts potentially nested
...
var G__36686 = emmy.pattern.rule.try_subexpressions(emmy$pattern$rule$top_down_$_rec,(r.cljs$core$IFn$_invoke$arity$1 ? r.cljs$core$IFn$_invoke$arity$1(expr) : r.call(null,expr)));
return (r.cljs$core$IFn$_invoke$arity$1 ? r.cljs$core$IFn$_invoke$arity$1(G__36686) : r.call(null,G__36686));
}));
});
/**
...
var fexpr__36701 = cljs.core.deref(rec);
return (fexpr__36701.cljs$core$IFn$_invoke$arity$1 ? fexpr__36701.cljs$core$IFn$_invoke$arity$1(answer) : fexpr__36701.call(null,answer));
}
});
...
var fexpr__36706 = cljs.core.deref(rec);
return (fexpr__36706.cljs$core$IFn$_invoke$arity$1 ? fexpr__36706.cljs$core$IFn$_invoke$arity$1(answer__$1) : fexpr__36706.call(null,answer__$1));
}
} else {
var fexpr__36707 = cljs.core.deref(rec);
return (fexpr__36707.cljs$core$IFn$_invoke$arity$1 ? fexpr__36707.cljs$core$IFn$_invoke$arity$1(answer) : fexpr__36707.call(null,answer));
}
});
cljs.core.reset_BANG_(rec,cljs.core.memoize(rec_STAR_));
...
/** @this {Function} */
(emmy.pattern.rule.ruleset_STAR_.cljs$lang$applyTo = (function (seq36710){
var self__5883__auto__ = this;
return self__5883__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36710));
}));
...
var rules = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36713_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(emmy.pattern.rule.compile_rule,p1__36713_SHARP_);
}),inputs);
...
/** @this {Function} */
(emmy.pattern.rule.ruleset.cljs$lang$applyTo = (function (seq36716){
...
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36717,G__36718,seq36716__$2);
}));
...
/** @this {Function} */
(emmy.pattern.rule.rule_simplifier.cljs$lang$applyTo = (function (seq36723){
var self__5883__auto__ = this;
return self__5883__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36723));
}));
...
var G__36793 = (i__5898__auto___36792 + (1));
i__5898__auto___36792 = G__36793;
continue;
} else {
}
break;
...
/** @this {Function} */
(emmy.pattern.rule.term_rewriting.cljs$lang$applyTo = (function (seq36730){
var self__5883__auto__ = this;
return self__5883__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36730));
}));
