...
(emmy.numerical.quadrature.romberg.open_sequence.cljs$core$IFn$_invoke$arity$4 = (function (f,a,b,p__56973){
var map__56974 = p__56973;
var map__56974__$1 = cljs.core.__destructure_map(map__56974);
var opts = map__56974__$1;
var n = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56974__$1,new cljs.core.Keyword(null,"n","n",562130025),(1));
if(typeof n === 'number'){
} else {
...
(emmy.numerical.quadrature.romberg.closed_sequence.cljs$core$IFn$_invoke$arity$4 = (function (f,a,b,p__56998){
var map__56999 = p__56998;
var map__56999__$1 = cljs.core.__destructure_map(map__56999);
var opts = map__56999__$1;
var n = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56999__$1,new cljs.core.Keyword(null,"n","n",562130025),(1));
if(typeof n === 'number'){
} else {
throw (new Error("Assert failed: (number? n)"));
}
