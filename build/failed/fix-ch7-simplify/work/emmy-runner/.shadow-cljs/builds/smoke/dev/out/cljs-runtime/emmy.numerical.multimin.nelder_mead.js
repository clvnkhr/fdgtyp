...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__48996_SHARP_){
return (s * p1__48996_SHARP_);
}),v);
});
/**
 ...
 */
emmy.numerical.multimin.nelder_mead.initial_simplex = (function emmy$numerical$multimin$nelder_mead$initial_simplex(x0,p__48998){
var map__48999 = p__48998;
var map__48999__$1 = cljs.core.__destructure_map(map__48999);
var nonzero_delta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48999__$1,new cljs.core.Keyword(null,"nonzero-delta","nonzero-delta",-794646863),0.05);
var zero_delta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48999__$1,new cljs.core.Keyword(null,"zero-delta","zero-delta",-2009573292),2.5E-4);
 ...
 */
emmy.numerical.multimin.nelder_mead.sup_norm = (function emmy$numerical$multimin$nelder_mead$sup_norm(p__49002){
var vec__49003 = p__49002;
var x0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49003,(0),null);
var simplex = vec__49003;
var coords = ((cljs.core.sequential_QMARK_(x0))?cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__49000_SHARP_){
return emmy.numerical.multimin.nelder_mead.v_(p1__49000_SHARP_,x0);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([simplex], 0)):cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49001_SHARP_){
return (p1__49001_SHARP_ - x0);
}),simplex));
 ...
 */
emmy.numerical.multimin.nelder_mead.step_defaults = (function emmy$numerical$multimin$nelder_mead$step_defaults(dimension,p__49054){
var map__49055 = p__49054;
var map__49055__$1 = cljs.core.__destructure_map(map__49055);
var m = map__49055__$1;
var adaptive_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49055__$1,new cljs.core.Keyword(null,"adaptive?","adaptive?",-259268570),true);
...
var map__49062 = emmy.numerical.multimin.nelder_mead.step_defaults(dimension,opts);
var map__49062__$1 = cljs.core.__destructure_map(map__49062);
var alpha = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49062__$1,new cljs.core.Keyword(null,"alpha","alpha",-1574982441));
var beta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49062__$1,new cljs.core.Keyword(null,"beta","beta",455605892));
var sigma = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49062__$1,new cljs.core.Keyword(null,"sigma","sigma",-63715703));
var gamma = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49062__$1,new cljs.core.Keyword(null,"gamma","gamma",1883969687));
...
var shrink = (function emmy$numerical$multimin$nelder_mead$step_fn_$_shrink(p__49096){
var vec__49097 = p__49096;
var seq__49098 = cljs.core.seq(vec__49097);
var first__49099 = cljs.core.first(seq__49098);
var seq__49098__$1 = cljs.core.next(seq__49098);
var s0 = first__49099;
var rest = seq__49098__$1;
var scale_toward_s0 = (function (p1__49058_SHARP_){
return emmy.numerical.multimin.nelder_mead.v_PLUS_(s0,emmy.numerical.multimin.nelder_mead.v_STAR_(sigma,emmy.numerical.multimin.nelder_mead.v_(p1__49058_SHARP_,s0)));
});
...
return (function (simplex,p__49100){
var vec__49101 = p__49100;
var f_best = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49101,(0),null);
var f_simplex = vec__49101;
...
if(cljs.core.truth_((function (p1__49059_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._LT__EQ_,cljs.core.second(p1__49059_SHARP_));
}))){
} else {
throw (new Error("Assert failed: (fn* [p1__49059#] (apply <= (second p1__49059#)))"));
}
 ...
 */
emmy.numerical.multimin.nelder_mead.convergence_fn = (function emmy$numerical$multimin$nelder_mead$convergence_fn(p__49104){
var map__49105 = p__49104;
var map__49105__$1 = cljs.core.__destructure_map(map__49105);
var simplex_tolerance = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49105__$1,new cljs.core.Keyword(null,"simplex-tolerance","simplex-tolerance",1524945145),1.0E-4);
var fn_tolerance = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49105__$1,new cljs.core.Keyword(null,"fn-tolerance","fn-tolerance",-1445606164),1.0E-4);
 ...
 */
emmy.numerical.multimin.nelder_mead.stop_fn = (function emmy$numerical$multimin$nelder_mead$stop_fn(f_counter,dimension,p__49112){
 ...
 *   
 */
emmy.numerical.multimin.nelder_mead.nelder_mead = (function emmy$numerical$multimin$nelder_mead$nelder_mead(func,x0,p__49117){
var map__49118 = p__49117;
var map__49118__$1 = cljs.core.__destructure_map(map__49118);
var opts = map__49118__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49118__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
...
var vec__49121 = emmy.numerical.multimin.nelder_mead.counted(func);
var f_counter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49121,(0),null);
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49121,(1),null);
...
var G__49138 = emmy.numerical.multimin.nelder_mead.sort_by_f.cljs$core$IFn$_invoke$arity$3(simplex,f_simplex,dimension);
var vec__49139 = G__49138;
var vec__49142 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49139,(0),null);
var s0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49142,(0),null);
var simplex__$1 = vec__49142;
var vec__49145 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49139,(1),null);
var f0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49145,(0),null);
var f_simplex__$1 = vec__49145;
var iteration = (0);
var G__49138__$1 = G__49138;
var iteration__$1 = iteration;
while(true){
var vec__49157 = G__49138__$1;
var vec__49160 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49157,(0),null);
var s0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49160,(0),null);
var simplex__$2 = vec__49160;
var vec__49163 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49157,(1),null);
var f0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49163,(0),null);
var f_simplex__$2 = vec__49163;
...
var G__49183 = (step.cljs$core$IFn$_invoke$arity$2 ? step.cljs$core$IFn$_invoke$arity$2(simplex__$2,f_simplex__$2) : step.call(null,simplex__$2,f_simplex__$2));
var G__49184 = (iteration__$2 + (1));
G__49138__$1 = G__49183;
iteration__$1 = G__49184;
continue;
}
break;
}
