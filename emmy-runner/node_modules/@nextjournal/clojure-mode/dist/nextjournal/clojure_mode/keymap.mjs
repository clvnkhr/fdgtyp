...
const temp__23951__auto__1 = squint_core.get(m, k);
if ((temp__23951__auto__1 == null)) {
return squint_core.dissoc(m, k);} else {
const existing2 = temp__23951__auto__1;
return squint_core.assoc(m, k, squint_core.get(f, existing2));}
}), m, updates);
};
...
return squint_core.reduce((function (out, p__209) {
const map__12 = p__209;
const cmd3 = map__12;
const run4 = squint_core.get(map__12, "run");
