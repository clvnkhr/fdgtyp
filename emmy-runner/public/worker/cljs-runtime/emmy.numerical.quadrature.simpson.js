...
goog.provide('emmy.numerical.quadrature.simpson');
/**
...
break;
case 4:
return emmy.numerical.quadrature.simpson.simpson_sequence.cljs$core$IFn$_invoke$arity$4((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]));
...
(emmy.numerical.quadrature.simpson.simpson_sequence.cljs$core$IFn$_invoke$arity$3 = (function (f,a,b){
...
(emmy.numerical.quadrature.simpson.simpson_sequence.cljs$core$IFn$_invoke$arity$4 = (function (f,a,b,p__76197){
var map__76198 = p__76197;
var map__76198__$1 = cljs.core.__destructure_map(map__76198);
var n = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__76198__$1,new cljs.core.Keyword(null,"n","n",562130025),(1));
if(typeof n === 'number'){
} else {
throw (new Error("Assert failed: (number? n)"));
}

return emmy.polynomial.richardson.richardson_column.cljs$core$IFn$_invoke$arity$5(emmy.numerical.quadrature.trapezoid.trapezoid_sequence.cljs$core$IFn$_invoke$arity$4(f,a,b,n),(1),(2),(2),(2));
}));

(emmy.numerical.quadrature.simpson.simpson_sequence.cljs$lang$maxFixedArity = 4);
 ...
 */
emmy.numerical.quadrature.simpson.integral = emmy.numerical.quadrature.common.make_integrator_fn(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.first,emmy.numerical.quadrature.simpson.simpson_sequence),emmy.numerical.quadrature.simpson.simpson_sequence);

//# sourceMappingURL=emmy.numerical.quadrature.simpson.js.map
