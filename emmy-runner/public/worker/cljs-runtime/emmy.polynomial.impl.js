...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(emmy.polynomial.impl.exponents,comparator,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$iter__67493(s__67494){
return (new cljs.core.LazySeq(null,(function (){
var s__67494__$1 = s__67494;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__67494__$1);
if(temp__5825__auto__){
var s__67494__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__67494__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__67494__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__67496 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__67495 = (0);
while(true){
if((i__67495 < size__5648__auto__)){
var vec__67499 = cljs.core._nth(c__5647__auto__,i__67495);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67499,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67499,(1),null);
...
cljs.core.chunk_append(b__67496,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum));

var G__67605 = (i__67495 + (1));
i__67495 = G__67605;
continue;
} else {
var G__67606 = (i__67495 + (1));
i__67495 = G__67606;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__67496),emmy$polynomial$impl$iter__67493(cljs.core.chunk_rest(s__67494__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__67496),null);
}
} else {
var vec__67506 = cljs.core.first(s__67494__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67506,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67506,(1),null);
var coef_sum = cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1(emmy.polynomial.impl.coefficient),emmy.generic._PLUS_,terms);
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(coef_sum))){
var expts__$1 = ((cljs.core.vector_QMARK_(expts))?emmy.polynomial.exponent.dense__GT_exponents(expts):((cljs.core.sorted_QMARK_(expts))?expts:((cljs.core.map_QMARK_(expts))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.empty,expts):emmy.util.illegal("Invalid inputs to sparse->terms TODO")
)));
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum),emmy$polynomial$impl$iter__67493(cljs.core.rest(s__67494__$2)));
} else {
var G__67613 = cljs.core.rest(s__67494__$2);
s__67494__$1 = G__67613;
continue;
}
}
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.impl.empty_terms,(function (){var iter__5649__auto__ = (function emmy$polynomial$impl$map_coefficients_$_iter__67509(s__67510){
return (new cljs.core.LazySeq(null,(function (){
var s__67510__$1 = s__67510;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__67510__$1);
if(temp__5825__auto__){
var s__67510__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__67510__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__67510__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__67512 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__67511 = (0);
while(true){
if((i__67511 < size__5648__auto__)){
var vec__67513 = cljs.core._nth(c__5647__auto__,i__67511);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67513,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67513,(1),null);
...
cljs.core.chunk_append(b__67512,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c));

var G__67620 = (i__67511 + (1));
i__67511 = G__67620;
continue;
} else {
var G__67621 = (i__67511 + (1));
i__67511 = G__67621;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__67512),emmy$polynomial$impl$map_coefficients_$_iter__67509(cljs.core.chunk_rest(s__67510__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__67512),null);
}
} else {
var vec__67516 = cljs.core.first(s__67510__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67516,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67516,(1),null);
var f_c = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(c) : f.call(null,c));
if(cljs.core.not(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(f_c))){
return cljs.core.cons(emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c),emmy$polynomial$impl$map_coefficients_$_iter__67509(cljs.core.rest(s__67510__$2)));
} else {
var G__67626 = cljs.core.rest(s__67510__$2);
s__67510__$1 = G__67626;
continue;
}
}
} else {
 ...
 */
emmy.polynomial.impl.t_STAR_ts = (function emmy$polynomial$impl$t_STAR_ts(p__67521,v){
var vec__67522 = p__67521;
var tags = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67522,(0),null);
var coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67522,(1),null);
...
var vec__67526 = t;
var tags1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67526,(0),null);
var coeff1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67526,(1),null);
var G__67632 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,emmy.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.exponent.mul(tags,tags1),emmy.generic.mul.cljs$core$IFn$_invoke$arity$2(coeff,coeff1)));
var G__67633 = (i + (1));
acc = G__67632;
i = G__67633;
continue;
...
var vec__67546 = cljs.core.peek(v);
var vn_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67546,(0),null);
var vn_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67546,(1),null);
var good_QMARK_ = (function (p1__67545_SHARP_){
return emmy.polynomial.exponent.every_power_QMARK_(cljs.core.pos_QMARK_,p1__67545_SHARP_);
});
...
var vec__67564 = cljs.core.peek(remainder);
var r_exponents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67564,(0),null);
var r_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67564,(1),null);
...
var G__67646 = emmy.polynomial.impl.add(quotient,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_term], null));
var G__67647 = emmy.polynomial.impl.sub(remainder,emmy.polynomial.impl.t_STAR_ts(new_term,v));
quotient = G__67646;
remainder = G__67647;
continue;
} else {
