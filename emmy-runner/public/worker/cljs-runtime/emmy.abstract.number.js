...
var newexp = (function (){var G__71524 = emmy.expression.expression_of(a);
return (op.cljs$core$IFn$_invoke$arity$1 ? op.cljs$core$IFn$_invoke$arity$1(G__71524) : op.call(null,G__71524));
})();
...
if(cljs.core.truth_(temp__5823__auto__)){
var op = temp__5823__auto__;
var seq__71526 = cljs.core.seq(pairs);
var chunk__71527 = null;
var count__71528 = (0);
var i__71529 = (0);
while(true){
if((i__71529 < count__71528)){
var vec__71541 = chunk__71527.cljs$core$IIndexed$_nth$arity$2(null,i__71529);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71541,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71541,(1),null);
generic_op.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [l,r], null),((function (seq__71526,chunk__71527,count__71528,i__71529,vec__71541,l,r,op,temp__5823__auto__,pairs){
return (function (a,b){
var newexp = (function (){var G__71544 = emmy.expression.expression_of(a);
var G__71545 = emmy.expression.expression_of(b);
return (op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(G__71544,G__71545) : op.call(null,G__71544,G__71545));
})();
return emmy.abstract$.number.literal_number((function (){var temp__5823__auto____$1 = emmy.numsymb._STAR_incremental_simplifier_STAR_;
if(cljs.core.truth_(temp__5823__auto____$1)){
var simplify = temp__5823__auto____$1;
...
});})(seq__71526,chunk__71527,count__71528,i__71529,vec__71541,l,r,op,temp__5823__auto__,pairs))
);


var G__71572 = seq__71526;
var G__71573 = chunk__71527;
var G__71574 = count__71528;
var G__71575 = (i__71529 + (1));
seq__71526 = G__71572;
chunk__71527 = G__71573;
count__71528 = G__71574;
i__71529 = G__71575;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__71526);
if(temp__5825__auto__){
var seq__71526__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__71526__$1)){
var c__5694__auto__ = cljs.core.chunk_first(seq__71526__$1);
var G__71576 = cljs.core.chunk_rest(seq__71526__$1);
var G__71577 = c__5694__auto__;
var G__71578 = cljs.core.count(c__5694__auto__);
var G__71579 = (0);
seq__71526 = G__71576;
chunk__71527 = G__71577;
count__71528 = G__71578;
i__71529 = G__71579;
continue;
} else {
var vec__71546 = cljs.core.first(seq__71526__$1);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71546,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71546,(1),null);
generic_op.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [l,r], null),((function (seq__71526,chunk__71527,count__71528,i__71529,vec__71546,l,r,seq__71526__$1,temp__5825__auto__,op,temp__5823__auto__,pairs){
return (function (a,b){
var newexp = (function (){var G__71549 = emmy.expression.expression_of(a);
var G__71550 = emmy.expression.expression_of(b);
return (op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(G__71549,G__71550) : op.call(null,G__71549,G__71550));
})();
return emmy.abstract$.number.literal_number((function (){var temp__5823__auto____$1 = emmy.numsymb._STAR_incremental_simplifier_STAR_;
if(cljs.core.truth_(temp__5823__auto____$1)){
var simplify = temp__5823__auto____$1;
...
});})(seq__71526,chunk__71527,count__71528,i__71529,vec__71546,l,r,seq__71526__$1,temp__5825__auto__,op,temp__5823__auto__,pairs))
);


var G__71580 = cljs.core.next(seq__71526__$1);
var G__71581 = null;
var G__71582 = (0);
var G__71583 = (0);
seq__71526 = G__71580;
chunk__71527 = G__71581;
count__71528 = G__71582;
i__71529 = G__71583;
continue;
}
} else {
...
var seq__71551 = cljs.core.seq(pairs);
var chunk__71552 = null;
var count__71553 = (0);
var i__71554 = (0);
while(true){
if((i__71554 < count__71553)){
var vec__71561 = chunk__71552.cljs$core$IIndexed$_nth$arity$2(null,i__71554);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71561,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71561,(1),null);
generic_op.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [l,r], null),((function (seq__71551,chunk__71552,count__71553,i__71554,vec__71561,l,r,temp__5823__auto__,pairs){
return (function (a,b){
...
});})(seq__71551,chunk__71552,count__71553,i__71554,vec__71561,l,r,temp__5823__auto__,pairs))
);


var G__71584 = seq__71551;
var G__71585 = chunk__71552;
var G__71586 = count__71553;
var G__71587 = (i__71554 + (1));
seq__71551 = G__71584;
chunk__71552 = G__71585;
count__71553 = G__71586;
i__71554 = G__71587;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__71551);
if(temp__5825__auto__){
var seq__71551__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__71551__$1)){
var c__5694__auto__ = cljs.core.chunk_first(seq__71551__$1);
var G__71588 = cljs.core.chunk_rest(seq__71551__$1);
var G__71589 = c__5694__auto__;
var G__71590 = cljs.core.count(c__5694__auto__);
var G__71591 = (0);
seq__71551 = G__71588;
chunk__71552 = G__71589;
count__71553 = G__71590;
i__71554 = G__71591;
continue;
} else {
var vec__71564 = cljs.core.first(seq__71551__$1);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71564,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71564,(1),null);
generic_op.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [l,r], null),((function (seq__71551,chunk__71552,count__71553,i__71554,vec__71564,l,r,seq__71551__$1,temp__5825__auto__,temp__5823__auto__,pairs){
return (function (a,b){
return emmy.expression.literal_apply(new cljs.core.Keyword("emmy.expression","numeric","emmy.expression/numeric",-181475924),op_sym,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,b], null));
});})(seq__71551,chunk__71552,count__71553,i__71554,vec__71564,l,r,seq__71551__$1,temp__5825__auto__,temp__5823__auto__,pairs))
);


var G__71592 = cljs.core.next(seq__71551__$1);
var G__71593 = null;
var G__71594 = (0);
var G__71595 = (0);
seq__71551 = G__71592;
chunk__71552 = G__71593;
count__71553 = G__71594;
i__71554 = G__71595;
continue;
}
} else {
...
var log_71596 = emmy.numsymb.symbolic_operator(new cljs.core.Symbol(null,"log","log",45015523,null));
var div_71597 = emmy.numsymb.symbolic_operator(new cljs.core.Symbol(null,"/","/",-1371932971,null));
...
return emmy.abstract$.number.literal_number((function (){var G__71567 = (log_71596.cljs$core$IFn$_invoke$arity$1 ? log_71596.cljs$core$IFn$_invoke$arity$1(a__$1) : log_71596.call(null,a__$1));
var G__71568 = (log_71596.cljs$core$IFn$_invoke$arity$1 ? log_71596.cljs$core$IFn$_invoke$arity$1((2)) : log_71596.call(null,(2)));
return (div_71597.cljs$core$IFn$_invoke$arity$2 ? div_71597.cljs$core$IFn$_invoke$arity$2(G__71567,G__71568) : div_71597.call(null,G__71567,G__71568));
})());
}));
...
var a__$1 = emmy.expression.expression_of(a);
return emmy.abstract$.number.literal_number((function (){var G__71569 = (log_71596.cljs$core$IFn$_invoke$arity$1 ? log_71596.cljs$core$IFn$_invoke$arity$1(a__$1) : log_71596.call(null,a__$1));
var G__71570 = (log_71596.cljs$core$IFn$_invoke$arity$1 ? log_71596.cljs$core$IFn$_invoke$arity$1((10)) : log_71596.call(null,(10)));
return (div_71597.cljs$core$IFn$_invoke$arity$2 ? div_71597.cljs$core$IFn$_invoke$arity$2(G__71569,G__71570) : div_71597.call(null,G__71569,G__71570));
})());
}));
