...
var G__72366 = clojure.zip.node(loc);
var fexpr__72365 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__72365.cljs$core$IFn$_invoke$arity$1 ? fexpr__72365.cljs$core$IFn$_invoke$arity$1(G__72366) : fexpr__72365.call(null,G__72366));
});
/**
...
var G__72368 = clojure.zip.node(loc);
var fexpr__72367 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__72367.cljs$core$IFn$_invoke$arity$1 ? fexpr__72367.cljs$core$IFn$_invoke$arity$1(G__72368) : fexpr__72367.call(null,G__72368));
} else {
...
var fexpr__72369 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__72369.cljs$core$IFn$_invoke$arity$2 ? fexpr__72369.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__72369.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__72370 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72370,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72370,(1),null);
var vec__72373 = clojure.zip.children(loc);
var seq__72374 = cljs.core.seq(vec__72373);
var first__72375 = cljs.core.first(seq__72374);
var seq__72374__$1 = cljs.core.next(seq__72374);
var c = first__72375;
var cnext = seq__72374__$1;
var cs = vec__72373;
...
var vec__72376 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72376,(0),null);
var map__72379 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72376,(1),null);
var map__72379__$1 = cljs.core.__destructure_map(map__72379);
var path = map__72379__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72379__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72379__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72379__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72379__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72379__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__72390 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72390,(0),null);
var map__72393 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72390,(1),null);
var map__72393__$1 = cljs.core.__destructure_map(map__72393);
var path = map__72393__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72393__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__72394 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72393__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__72395 = cljs.core.seq(vec__72394);
var first__72396 = cljs.core.first(seq__72395);
var seq__72395__$1 = cljs.core.next(seq__72395);
var r = first__72396;
var rnext = seq__72395__$1;
var rs = vec__72394;
...
var vec__72405 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72405,(0),null);
var map__72408 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72405,(1),null);
var map__72408__$1 = cljs.core.__destructure_map(map__72408);
var path = map__72408__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72408__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72408__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5160__auto__ = path;
if(cljs.core.truth_(and__5160__auto__)){
return r;
} else {
...
var vec__72413 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72413,(0),null);
var map__72416 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72413,(1),null);
var map__72416__$1 = cljs.core.__destructure_map(map__72416);
var path = map__72416__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72416__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72416__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5160__auto__ = path;
if(cljs.core.truth_(and__5160__auto__)){
...
var vec__72422 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72422,(0),null);
var map__72425 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72422,(1),null);
var map__72425__$1 = cljs.core.__destructure_map(map__72425);
var path = map__72425__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72425__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72425__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5160__auto__ = path;
if(cljs.core.truth_(and__5160__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__72426 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72426,(0),null);
...
var path = map__72429__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72429__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__72430 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72430,(0),null);
var map__72433 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72430,(1),null);
var map__72433__$1 = cljs.core.__destructure_map(map__72433);
var path = map__72433__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72433__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72435,(1),null);
...
var len__5897__auto___72459 = arguments.length;
var i__5898__auto___72460 = (0);
while(true){
if((i__5898__auto___72460 < len__5897__auto___72459)){
args__5903__auto__.push((arguments[i__5898__auto___72460]));

var G__72461 = (i__5898__auto___72460 + (1));
i__5898__auto___72460 = G__72461;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq72439){
var G__72441 = cljs.core.first(seq72439);
var seq72439__$1 = cljs.core.next(seq72439);
var G__72442 = cljs.core.first(seq72439__$1);
var seq72439__$2 = cljs.core.next(seq72439__$1);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__72441,G__72442,seq72439__$2);
}));
...
var G__72463 = clojure.zip.rightmost(child);
loc__$1 = G__72463;
continue;
} else {
return loc__$1;
...
var vec__72445 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72445,(0),null);
var map__72448 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72445,(1),null);
var map__72448__$1 = cljs.core.__destructure_map(map__72448);
var path = map__72448__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72448__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72448__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72448__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72448__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__72464 = clojure.zip.rightmost(child);
loc__$1 = G__72464;
continue;
} else {
return loc__$1;
