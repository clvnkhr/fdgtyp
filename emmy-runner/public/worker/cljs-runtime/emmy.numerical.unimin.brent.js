...
import "./emmy.numerical.unimin.bracket.js";
 ...
 *   
 */
emmy.numerical.unimin.brent.update_history = (function emmy$numerical$unimin$brent$update_history(p__73050,p__73051,p__73052,p__73053){
var vec__73054 = p__73050;
var xx2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73054,(0),null);
var fx2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73054,(1),null);
var x2 = vec__73054;
var vec__73057 = p__73051;
var xx1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73057,(0),null);
var fx1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73057,(1),null);
var x1 = vec__73057;
var vec__73060 = p__73052;
var xx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73060,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73060,(1),null);
var x = vec__73060;
var vec__73063 = p__73053;
var xnew = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73063,(0),null);
var fnew = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73063,(1),null);
if((fnew <= fx)){
...
(emmy.numerical.unimin.brent.brent_min.cljs$core$IFn$_invoke$arity$4 = (function (f,a,b,p__73068){
var map__73069 = p__73068;
var map__73069__$1 = cljs.core.__destructure_map(map__73069);
var relative_threshold = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__73069__$1,new cljs.core.Keyword(null,"relative-threshold","relative-threshold",-1866138970),1.0E-11);
var absolute_threshold = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__73069__$1,new cljs.core.Keyword(null,"absolute-threshold","absolute-threshold",842199714),emmy.numerical.unimin.brent.default_absolute_threshold);
var initial_guess = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__73069__$1,new cljs.core.Keyword(null,"initial-guess","initial-guess",-1883142405),emmy.numerical.unimin.brent.initial_brent_guess(a,b));
var maxiter = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__73069__$1,new cljs.core.Keyword(null,"maxiter","maxiter",-1867223754),(1000));
var maxfun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73069__$1,new cljs.core.Keyword(null,"maxfun","maxfun",-50301814));
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__73069__$1,new cljs.core.Keyword(null,"callback","callback",-705136228),cljs.core.constantly(null));
...
var vec__73070 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.min.cljs$core$IFn$_invoke$arity$2(a,b),cljs.core.max.cljs$core$IFn$_invoke$arity$2(a,b)], null);
var a__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73070,(0),null);
var b__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73070,(1),null);
var vec__73073 = emmy.util.counted.cljs$core$IFn$_invoke$arity$1(f);
var f_counter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73073,(0),null);
var f__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73073,(1),null);
...
var G__73086 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [a__$1,mid,b__$1], null);
var vec__73088 = G__73086;
var a__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73088,(0),null);
var vec__73091 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73088,(1),null);
var xx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73091,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73091,(1),null);
var x = vec__73091;
var b__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73088,(2),null);
var G__73087 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [mid,mid], null);
var vec__73094 = G__73087;
var x2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73094,(0),null);
var x1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73094,(1),null);
var target = (0);
var delta = (0);
var iteration = (0);
var G__73086__$1 = G__73086;
var G__73087__$1 = G__73087;
var target__$1 = target;
var delta__$1 = delta;
var iteration__$1 = iteration;
while(true){
var vec__73124 = G__73086__$1;
var a__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73124,(0),null);
var vec__73127 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73124,(1),null);
var xx__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73127,(0),null);
var fx__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73127,(1),null);
var x__$1 = vec__73127;
var b__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73124,(2),null);
var vec__73130 = G__73087__$1;
var x2__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73130,(0),null);
var x1__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73130,(1),null);
...
var vec__73134 = (((emmy.generic.abs.cljs$core$IFn$_invoke$arity$1(target__$2) <= tol))?emmy.numerical.unimin.brent.golden_section_step(a__$3,xx__$1,b__$3):(function (){var vec__73146 = emmy.numerical.unimin.bracket.parabolic_pieces(x1__$1,x__$1,x2__$1);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73146,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73146,(1),null);
...
var new_target = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73134,(0),null);
var new_delta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73134,(1),null);
...
var vec__73137 = (((xnew < xx__$1))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_pt,x__$1], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x__$1,new_pt], null));
var vec__73140 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73137,(0),null);
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73140,(0),null);
var fl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73140,(1),null);
var l = vec__73140;
var vec__73143 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73137,(1),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73143,(0),null);
var fr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73143,(1),null);
var r = vec__73143;
var G__73182 = (((fl <= fr))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [a__$3,l,xr], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [xl,r,b__$3], null));
var G__73183 = emmy.numerical.unimin.brent.update_history(x2__$1,x1__$1,x__$1,new_pt);
var G__73184 = new_target;
var G__73185 = new_delta;
var G__73186 = (iteration__$2 + (1));
G__73086__$1 = G__73182;
G__73087__$1 = G__73183;
target__$1 = G__73184;
delta__$1 = G__73185;
iteration__$1 = G__73186;
continue;
}
break;
}
