...
var G__71397 = new_m;
var G__71398 = emmy.polynomial.evenly_divide(h,emmy.polynomial.mul(new_m,new_s));
var G__71399 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(tracker,doublefacts,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([singlefacts], 0));
var G__71400 = new_s;
var G__71401 = new_m;
m = G__71397;
h = G__71398;
 ...
 */
emmy.polynomial.factor.simplify_product = emmy.pattern.rule.rule_simplifier.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([emmy.simplify.rules.associative.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Symbol(null,"*","*",345799209,null)], 0)),emmy.simplify.rules.unary_elimination.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Symbol(null,"*","*",345799209,null)], 0)),emmy.simplify.rules.constant_elimination(new cljs.core.Symbol(null,"*","*",345799209,null),(1)),emmy.pattern.rule.rule_STAR_(emmy.pattern.rule.pattern_STAR_.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"*","*",345799209,null),null,(1),null)),emmy.pattern.rule._EQ__GT_),(function (G__71278){
...
var G__71286 = emmy.polynomial.__GT_expression(factor,vars);
return (simplify.cljs$core$IFn$_invoke$arity$1 ? simplify.cljs$core$IFn$_invoke$arity$1(G__71286) : simplify.call(null,G__71286));
}),emmy.polynomial.factor.split_polynomial(p));
var G__71288 = emmy.polynomial.factor.factors__GT_expression(factors);
return (emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1(G__71288) : emmy.polynomial.factor.simplify_product.call(null,G__71288));
}catch (e71284){if((e71284 instanceof Error)){
var _ = e71284;
...
}),null)),null,-692331218,null);

var G__71285 = emmy.polynomial.__GT_expression(p,vars);
return (emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.simplify_product.cljs$core$IFn$_invoke$arity$1(G__71285) : emmy.polynomial.factor.simplify_product.call(null,G__71285));
} else {
throw e71284;
...
var cont = (function (p1__71289_SHARP_,p2__71290_SHARP_){
return emmy.polynomial.factor.poly__GT_factored_expression.cljs$core$IFn$_invoke$arity$3(p1__71289_SHARP_,p2__71290_SHARP_,simplify);
});
...
*/
emmy.polynomial.factor.t_emmy$polynomial$factor71302 = (function (symgen,meta71303){
this.symgen = symgen;
this.meta71303 = meta71303;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(emmy.polynomial.factor.t_emmy$polynomial$factor71302.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_71304,meta71303__$1){
var self__ = this;
var _71304__$1 = this;
return (new emmy.polynomial.factor.t_emmy$polynomial$factor71302(self__.symgen,meta71303__$1));
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor71302.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_71304){
var self__ = this;
var _71304__$1 = this;
return self__.meta71303;
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor71302.prototype.emmy$expression$analyze$ICanonicalize$ = cljs.core.PROTOCOL_SENTINEL);

(emmy.polynomial.factor.t_emmy$polynomial$factor71302.prototype.emmy$expression$analyze$ICanonicalize$expression__GT_$arity$4 = (function (_,expr,cont,v_compare){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.expression__GT_.cljs$core$IFn$_invoke$arity$3(expr,cont,v_compare);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor71302.prototype.emmy$expression$analyze$ICanonicalize$__GT_expression$arity$3 = (function (_,p,vars){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.factor.poly__GT_factored_expression.cljs$core$IFn$_invoke$arity$2(p,vars);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor71302.prototype.emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$arity$2 = (function (_,o){
var self__ = this;
var ___$1 = this;
return emmy.polynomial.analyzer.emmy$expression$analyze$ICanonicalize$known_operation_QMARK_$arity$2(null,o);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor71302.getBasis = (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"symgen","symgen",-880919559,null),new cljs.core.Symbol(null,"meta71303","meta71303",605672790,null)], null);
}));

(emmy.polynomial.factor.t_emmy$polynomial$factor71302.cljs$lang$type = true);

(emmy.polynomial.factor.t_emmy$polynomial$factor71302.cljs$lang$ctorStr = "emmy.polynomial.factor/t_emmy$polynomial$factor71302");

(emmy.polynomial.factor.t_emmy$polynomial$factor71302.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"emmy.polynomial.factor/t_emmy$polynomial$factor71302");
}));

/**
 * Positional factory function for emmy.polynomial.factor/t_emmy$polynomial$factor71302.
 */
emmy.polynomial.factor.__GT_t_emmy$polynomial$factor71302 = (function emmy$polynomial$factor$__GT_t_emmy$polynomial$factor71302(symgen,meta71303){
return (new emmy.polynomial.factor.t_emmy$polynomial$factor71302(symgen,meta71303));
});
...
return emmy.expression.analyze.make_analyzer.cljs$core$IFn$_invoke$arity$2((new emmy.polynomial.factor.t_emmy$polynomial$factor71302(symgen,cljs.core.PersistentArrayMap.EMPTY)),symgen);
})();
/**
...
var fact_exp = (function (){var G__71314 = cljs.core.first((emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1 ? emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1(expr) : emmy.numsymb.operands.call(null,expr)));
return (emmy.polynomial.factor.factor.cljs$core$IFn$_invoke$arity$1 ? emmy.polynomial.factor.factor.cljs$core$IFn$_invoke$arity$1(G__71314) : emmy.polynomial.factor.factor.call(null,G__71314));
})();
var expt = emmy.numsymb.symbolic_operator(new cljs.core.Symbol(null,"expt","expt",2123850345,null));
...
var G__71348 = (sqrt.cljs$core$IFn$_invoke$arity$1 ? sqrt.cljs$core$IFn$_invoke$arity$1(odds) : sqrt.call(null,odds));
var G__71349 = evens;
return (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(G__71348,G__71349) : _STAR_.call(null,G__71348,G__71349));
} else {
var vec__71350 = factors;
...
var f = first__71352;
var more = seq__71351__$1;
if(cljs.core.truth_(emmy.numsymb.expt_QMARK_(f))){
var vec__71355 = (emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1 ? emmy.numsymb.operands.cljs$core$IFn$_invoke$arity$1(f) : emmy.numsymb.operands.call(null,f));
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71355,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71355,(1),null);
if((!(even_QMARK_(e)))){
var G__71419 = more;
var G__71420 = (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(f,odds) : _STAR_.call(null,f,odds));
var G__71421 = evens;
factors = G__71419;
odds = G__71420;
evens = G__71421;
...
var G__71422 = more;
var G__71423 = odds;
var G__71424 = (function (){var power = cljs.core.quot(e,(2));
if((power > (1))){
var G__71358 = evens;
var G__71359 = (expt.cljs$core$IFn$_invoke$arity$2 ? expt.cljs$core$IFn$_invoke$arity$2(b,power) : expt.call(null,b,power));
return (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(G__71358,G__71359) : _STAR_.call(null,G__71358,G__71359));
} else {
...
var G__71425 = more;
var G__71426 = (_STAR_.cljs$core$IFn$_invoke$arity$2 ? _STAR_.cljs$core$IFn$_invoke$arity$2(f,odds) : _STAR_.call(null,f,odds));
var G__71427 = evens;
factors = G__71425;
odds = G__71426;
evens = G__71427;
