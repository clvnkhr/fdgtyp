...
var build_term = (function (i,p__67532){
var vec__67533 = p__67532;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67533,(0),null);
var fa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67533,(1),null);
var others = (function (){var iter__5649__auto__ = (function emmy$polynomial$interpolate$lagrange_$_iter__67540(s__67541){
return (new cljs.core.LazySeq(null,(function (){
var s__67541__$1 = s__67541;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__67541__$1);
if(temp__5825__auto__){
var s__67541__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__67541__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__67541__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__67543 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__67542 = (0);
while(true){
if((i__67542 < size__5648__auto__)){
var j = cljs.core._nth(c__5647__auto__,i__67542);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(i,j)){
cljs.core.chunk_append(b__67543,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(points__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,(0)], null)));

var G__67748 = (i__67542 + (1));
i__67542 = G__67748;
continue;
} else {
var G__67749 = (i__67542 + (1));
i__67542 = G__67749;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__67543),emmy$polynomial$interpolate$lagrange_$_iter__67540(cljs.core.chunk_rest(s__67541__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__67543),null);
}
} else {
var j = cljs.core.first(s__67541__$2);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(i,j)){
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(points__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,(0)], null)),emmy$polynomial$interpolate$lagrange_$_iter__67540(cljs.core.rest(s__67541__$2)));
} else {
var G__67756 = cljs.core.rest(s__67541__$2);
s__67541__$1 = G__67756;
continue;
}
}
} else {
...
var p = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67525_SHARP_){
return emmy.generic._.cljs$core$IFn$_invoke$arity$2(x,p1__67525_SHARP_);
}),others));
var q = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67529_SHARP_){
return emmy.generic._.cljs$core$IFn$_invoke$arity$2(a,p1__67529_SHARP_);
}),others));
...
var vec__67607 = points__$1;
var vec__67610 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67607,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67610,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67610,(1),null);
return y;
} else {
var l_branch = cljs.core.pop(points__$1);
var r_branch = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(points__$1,(1));
var vec__67614 = cljs.core.first(points__$1);
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67614,(0),null);
var vec__67617 = cljs.core.peek(points__$1);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67617,(0),null);
 ...
 *   
 */
emmy.polynomial.interpolate.neville_prepare = (function emmy$polynomial$interpolate$neville_prepare(p__67648){
var vec__67653 = p__67648;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67653,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67653,(1),null);
...
return (function (p__67657,p__67658){
var vec__67659 = p__67657;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67659,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67659,(1),null);
var pl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67659,(2),null);
var vec__67662 = p__67658;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67662,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67662,(1),null);
var pr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67662,(2),null);
...
return (function (p__67674,p__67675){
var vec__67678 = p__67674;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67678,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67678,(1),null);
var pl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67678,(2),null);
var vec__67681 = p__67675;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67681,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67681,(1),null);
var pr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67681,(2),null);
 ...
 */
emmy.polynomial.interpolate.mn_prepare = (function emmy$polynomial$interpolate$mn_prepare(p__67693){
var vec__67694 = p__67693;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67694,(0),null);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67694,(1),null);
...
return (function (p__67698,p__67699){
var vec__67700 = p__67698;
var xl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67700,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67700,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67700,(2),null);
var dl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67700,(3),null);
var vec__67703 = p__67699;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67703,(0),null);
var xr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67703,(1),null);
var cr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67703,(2),null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67703,(3),null);
var diff = (cr - dl);
var den = (xl - xr);
var factor = (diff / den);
var c = (factor * (xl - x));
...
return emmy.util.aggregate.scan.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__67706){
var vec__67707 = p__67706;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67707,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67707,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67707,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67707,(3),null);
return c;
}),row));
});
/**
...
G__67779 = function(prev_row,point){
switch(arguments.length){
case 0:
return G__67779__0.call(this);
case 1:
return G__67779__1.call(this,prev_row);
case 2:
return G__67779__2.call(this,prev_row,point);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__67779.cljs$core$IFn$_invoke$arity$0 = G__67779__0;
G__67779.cljs$core$IFn$_invoke$arity$1 = G__67779__1;
G__67779.cljs$core$IFn$_invoke$arity$2 = G__67779__2;
return G__67779;
})()
});
/**
...
return cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__67719){
var vec__67722 = p__67719;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67722,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67722,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67722,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67722,(3),null);
return c;
