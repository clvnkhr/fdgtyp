...
import "./goog.i18n.datetimesymbols.js";
import "./goog.i18n.dayperiodsymbols.js";
import "./goog.i18n.localefeature.js";
import "./goog.i18n.nativelocaledigits.js";
import "./goog.i18n.timezone.js";
...
goog.scope(function() {
  ...
  goog.i18n.DateTimeFormat.Format = {FULL_DATE:0, LONG_DATE:1, MEDIUM_DATE:2, SHORT_DATE:3, FULL_TIME:4, LONG_TIME:5, MEDIUM_TIME:6, SHORT_TIME:7, FULL_DATETIME:8, LONG_DATETIME:9, MEDIUM_DATETIME:10, SHORT_DATETIME:11, WEEKDAY_MONTH_DAY_FULL:12, MONTH_DAY_MEDIUM:13};
  ...
  goog.i18n.DateTimeFormat.prototype.applyStandardPattern_ = function(formatType) {
    ...
    if (formatType < 4) {
      ...
      pattern = this.removeYearFormatFromPattern_(this.dateTimeSymbols_.DATEFORMATS[2]);
    } else {
