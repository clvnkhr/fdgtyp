...
import "./edamame.core.js";
import "./edamame.impl.parser.js";
import "./sci.impl.callstack.js";
import "./sci.impl.interpreter.js";
import "./sci.impl.io.js";
import "./sci.impl.load.js";
import "./sci.impl.macros.js";
import "./sci.impl.namespaces.js";
import "./sci.impl.opts.js";
import "./sci.impl.parser.js";
...
var G__77312 = sci.core.new_var.cljs$core$IFn$_invoke$arity$3(name,null,null);
sci.impl.vars.unbind(G__77312);
...
var G__77320 = sci.core.new_dynamic_var.cljs$core$IFn$_invoke$arity$3(name,null,null);
sci.impl.vars.unbind(G__77320);
...
var new_m = (function (){var G__77335 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),sci_ns,new cljs.core.Keyword(null,"name","name",1843675177),nm], null);
var G__77335__$1 = (cljs.core.truth_(macro)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__77335,new cljs.core.Keyword(null,"macro","macro",-867863404),true):G__77335);
var G__77335__$2 = (cljs.core.truth_(doc)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__77335__$1,new cljs.core.Keyword(null,"doc","doc",1913296891),doc):G__77335__$1);
var G__77335__$3 = (cljs.core.truth_(arglists)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__77335__$2,new cljs.core.Keyword(null,"arglists","arglists",1661989754),arglists):G__77335__$2);
if(cljs.core.truth_(dynamic)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__77335__$3,new cljs.core.Keyword(null,"dynamic","dynamic",704819571),dynamic);
} else {
return G__77335__$3;
}
})();
...
var len__5897__auto___77422 = arguments.length;
var i__5898__auto___77423 = (0);
while(true){
if((i__5898__auto___77423 < len__5897__auto___77422)){
args_arr__5922__auto__.push((arguments[i__5898__auto___77423]));

var G__77425 = (i__5898__auto___77423 + (1));
i__5898__auto___77423 = G__77425;
continue;
} else {
}
break;
...
return sci.core.alter_var_root.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5923__auto__);

}
});

(sci.core.alter_var_root.cljs$core$IFn$_invoke$arity$2 = (function (v,f){
var _STAR_unrestricted_STAR__orig_val__77359 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__77360 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__77360);

try{return sci.impl.vars.alter_var_root.cljs$core$IFn$_invoke$arity$2(v,f);
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__77359);
}}));

(sci.core.alter_var_root.cljs$core$IFn$_invoke$arity$variadic = (function (v,f,args){
var _STAR_unrestricted_STAR__orig_val__77361 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__77362 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__77362);

try{return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.vars.alter_var_root,v,f,args);
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__77361);
}}));

/** @this {Function} */
(sci.core.alter_var_root.cljs$lang$applyTo = (function (seq77352){
var G__77353 = cljs.core.first(seq77352);
var seq77352__$1 = cljs.core.next(seq77352);
var G__77354 = cljs.core.first(seq77352__$1);
var seq77352__$2 = cljs.core.next(seq77352__$1);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__77353,G__77354,seq77352__$2);
}));
...
var or__5162__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
var ctx__$1 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ctx,new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__5162__auto__ = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(ctx);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
var G__77379 = ex;
var G__77379__$1 = (((G__77379 == null))?null:cljs.core.ex_data(G__77379));
var G__77379__$2 = (((G__77379__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__77379__$1));
if((G__77379__$2 == null)){
return null;
} else {
return sci.impl.callstack.stacktrace(G__77379__$2);
}
});
/**
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns_map,p__77384){
var vec__77385 = p__77384;
var var_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77385,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77385,(1),null);
...
sci.core.process_publics = (function sci$core$process_publics(publics,p__77391){
var map__77393 = p__77391;
var map__77393__$1 = cljs.core.__destructure_map(map__77393);
var exclude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77393__$1,new cljs.core.Keyword(null,"exclude","exclude",-1230250334));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns_map,p__77396){
var vec__77397 = p__77396;
var var_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77397,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77397,(1),null);
...
return (function (p1__77400_SHARP_){
return sci.core.normalize_meta(cljs.core.select_keys(p1__77400_SHARP_,opts));
});
} else {
return (function (p1__77401_SHARP_){
return sci.core.normalize_meta(cljs.core.select_keys(p1__77401_SHARP_,new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"no-doc","no-doc",1559921891),new cljs.core.Keyword(null,"macro","macro",-867863404),new cljs.core.Keyword("sci","macro","sci/macro",-868536151),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"dynamic","dynamic",704819571)], null)));
});
...
var G__77404 = ctx;
var G__77405 = cljs.core.PersistentArrayMap.EMPTY;
var G__77406 = sym;
var fexpr__77403 = cljs.core.deref(sci.impl.utils.eval_resolve_state);
return (fexpr__77403.cljs$core$IFn$_invoke$arity$3 ? fexpr__77403.cljs$core$IFn$_invoke$arity$3(G__77404,G__77405,G__77406) : fexpr__77403.call(null,G__77404,G__77405,G__77406));
});
/**
