...
var i_29143 = (self__.level + (1));
while(true){
if((i_29143 <= (new_level + (1)))){
(update[i_29143] = self__.header);

var G__29144 = (i_29143 + (1));
i_29143 = G__29144;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_29145 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29145[i]));
} else {
x__$2.forward.push((((i < links_29145.length))?(links_29145[i]):null));
}

if((i < links_29145.length)){
(links_29145[i] = x__$2);
} else {
links_29145.push(x__$2);
}
...
var i_29147 = (0);
while(true){
if((i_29147 <= self__.level)){
var links_29148 = (update[i_29147]).forward;
if((x__$1 === (((i_29147 < links_29148.length))?(links_29148[i_29147]):null))){
(links_29148[i_29147] = (x__$1.forward[i_29147]));

var G__29149 = (i_29147 + (1));
i_29147 = G__29149;
continue;
} else {
var G__29150 = (i_29147 + (1));
i_29147 = G__29150;
continue;
}
} else {
...
var G__29152 = nx;
var G__29153 = (level__$1 - (1));
x = G__29152;
level__$1 = G__29153;
continue;
} else {
var G__29154 = x;
var G__29155 = (level__$1 - (1));
x = G__29154;
level__$1 = G__29155;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__29158 = nx;
var G__29159 = (level__$1 - (1));
x = G__29158;
level__$1 = G__29159;
continue;
} else {
var G__29160 = x;
var G__29161 = (level__$1 - (1));
x = G__29160;
level__$1 = G__29161;
continue;
}
