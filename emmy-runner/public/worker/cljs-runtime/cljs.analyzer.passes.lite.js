...
cljs.analyzer.passes.lite.update_var = (function cljs$analyzer$passes$lite$update_var(p__61423){
var map__61425 = p__61423;
var map__61425__$1 = cljs.core.__destructure_map(map__61425);
var ast = map__61425__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61425__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
return cljs.analyzer.passes.lite.update_var(G__61439);
} else {
return G__61439;
}
});
