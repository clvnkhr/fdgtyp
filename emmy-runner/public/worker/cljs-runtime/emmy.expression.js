...
return emmy.expression.__GT_Literal(e.type,(function (){var G__66387 = e.expression;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__66387) : f.call(null,G__66387));
})(),e.m);
});
/**
...
if(emmy.expression.literal_QMARK_(expr)){
var G__66455 = emmy.expression.expression_of(expr);
expr = G__66455;
continue;
} else {
...
var vec__66412 = node;
var seq__66413 = cljs.core.seq(vec__66412);
var first__66414 = cljs.core.first(seq__66413);
var seq__66413__$1 = cljs.core.next(seq__66413);
var f_sym = first__66414;
var args = seq__66413__$1;
...
if(emmy.expression.literal_QMARK_(expr)){
return emmy.expression.fmap((function (p1__66418_SHARP_){
return emmy.expression.substitute.cljs$core$IFn$_invoke$arity$2(p1__66418_SHARP_,s_map);
}),expr);
} else {
...
var head_compare = (function (){var G__66426 = cljs.core.first(l);
var G__66427 = cljs.core.first(r);
return (emmy.expression.compare.cljs$core$IFn$_invoke$arity$2 ? emmy.expression.compare.cljs$core$IFn$_invoke$arity$2(G__66426,G__66427) : emmy.expression.compare.call(null,G__66426,G__66427));
})();
if((head_compare === (0))){
var G__66470 = cljs.core.rest(l);
var G__66471 = cljs.core.rest(r);
l = G__66470;
r = G__66471;
continue;
} else {
...
return (((!(cljs.core.sequential_QMARK_(xs)))) || (cljs.core.every_QMARK_((function (p__66430){
var vec__66431 = p__66430;
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66431,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66431,(1),null);
