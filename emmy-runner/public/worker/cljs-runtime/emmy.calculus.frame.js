...
var emmy$calculus$frame$IFrame$coords__GT_event$dyn_71271 = (function (this$,coords){
...
return emmy$calculus$frame$IFrame$coords__GT_event$dyn_71271(this$,coords);
}
});

var emmy$calculus$frame$IFrame$event__GT_coords$dyn_71276 = (function (this$,event){
var x__5519__auto__ = (((this$ == null))?null:this$);
...
return emmy$calculus$frame$IFrame$event__GT_coords$dyn_71276(this$,event);
}
});

var emmy$calculus$frame$IFrame$ancestor_frame$dyn_71277 = (function (_){
...
return emmy$calculus$frame$IFrame$ancestor_frame$dyn_71277(_);
}
});

var emmy$calculus$frame$IFrame$frame_name$dyn_71279 = (function (_){
var x__5519__auto__ = (((_ == null))?null:_);
...
return emmy$calculus$frame$IFrame$frame_name$dyn_71279(_);
}
});

var emmy$calculus$frame$IFrame$params$dyn_71281 = (function (_){
var x__5519__auto__ = (((_ == null))?null:_);
...
return emmy$calculus$frame$IFrame$params$dyn_71281(_);
}
});
...
*/
emmy.calculus.frame.t_emmy$calculus$frame71258 = (function (c__GT_e,e__GT_c,call,name,ancestor_frame,params,meta71259){
...
this.params = params;
this.meta71259 = meta71259;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(emmy.calculus.frame.t_emmy$calculus$frame71258.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_71260,meta71259__$1){
var self__ = this;
var _71260__$1 = this;
return (new emmy.calculus.frame.t_emmy$calculus$frame71258(self__.c__GT_e,self__.e__GT_c,self__.call,self__.name,self__.ancestor_frame,self__.params,meta71259__$1));
}));

(emmy.calculus.frame.t_emmy$calculus$frame71258.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_71260){
var self__ = this;
var _71260__$1 = this;
return self__.meta71259;
}));

(emmy.calculus.frame.t_emmy$calculus$frame71258.prototype.emmy$calculus$frame$IFrame$ = cljs.core.PROTOCOL_SENTINEL);

(emmy.calculus.frame.t_emmy$calculus$frame71258.prototype.emmy$calculus$frame$IFrame$ancestor_frame$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return self__.ancestor_frame;
}));

(emmy.calculus.frame.t_emmy$calculus$frame71258.prototype.emmy$calculus$frame$IFrame$frame_name$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return self__.name;
}));

(emmy.calculus.frame.t_emmy$calculus$frame71258.prototype.emmy$calculus$frame$IFrame$params$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return self__.params;
}));

(emmy.calculus.frame.t_emmy$calculus$frame71258.prototype.emmy$calculus$frame$IFrame$coords__GT_event$arity$2 = (function (this$,coords){
var self__ = this;
var this$__$1 = this;
...
var event = (function (){var fexpr__71261 = (self__.c__GT_e.cljs$core$IFn$_invoke$arity$3 ? self__.c__GT_e.cljs$core$IFn$_invoke$arity$3(self__.ancestor_frame,this$__$1,self__.params) : self__.c__GT_e.call(null,self__.ancestor_frame,this$__$1,self__.params));
return (fexpr__71261.cljs$core$IFn$_invoke$arity$1 ? fexpr__71261.cljs$core$IFn$_invoke$arity$1(coords) : fexpr__71261.call(null,coords));
})();
...
(emmy.calculus.frame.t_emmy$calculus$frame71258.prototype.emmy$calculus$frame$IFrame$event__GT_coords$arity$2 = (function (this$,event){
var self__ = this;
var this$__$1 = this;
if(cljs.core.truth_(emmy.calculus.frame.event_QMARK_(event))){
} else {
...
var coords = (function (){var fexpr__71262 = (self__.e__GT_c.cljs$core$IFn$_invoke$arity$3 ? self__.e__GT_c.cljs$core$IFn$_invoke$arity$3(self__.ancestor_frame,this$__$1,self__.params) : self__.e__GT_c.call(null,self__.ancestor_frame,this$__$1,self__.params));
return (fexpr__71262.cljs$core$IFn$_invoke$arity$1 ? fexpr__71262.cljs$core$IFn$_invoke$arity$1(event) : fexpr__71262.call(null,event));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(emmy.calculus.frame.frame_owner(coords),this$__$1)){
} else {
throw (new Error("Assert failed: (= (frame-owner coords) this)"));
...
(emmy.calculus.frame.t_emmy$calculus$frame71258.getBasis = (function (){
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"c->e","c->e",366611773,null),new cljs.core.Symbol(null,"e->c","e->c",-1459982439,null),new cljs.core.Symbol(null,"call","call",1120531661,null),new cljs.core.Symbol(null,"name","name",-810760592,null),new cljs.core.Symbol(null,"ancestor-frame","ancestor-frame",-1796645653,null),new cljs.core.Symbol(null,"params","params",-1943919534,null),new cljs.core.Symbol(null,"meta71259","meta71259",-1556671748,null)], null);
}));

(emmy.calculus.frame.t_emmy$calculus$frame71258.cljs$lang$type = true);

(emmy.calculus.frame.t_emmy$calculus$frame71258.cljs$lang$ctorStr = "emmy.calculus.frame/t_emmy$calculus$frame71258");

(emmy.calculus.frame.t_emmy$calculus$frame71258.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"emmy.calculus.frame/t_emmy$calculus$frame71258");
}));

/**
 * Positional factory function for emmy.calculus.frame/t_emmy$calculus$frame71258.
 */
emmy.calculus.frame.__GT_t_emmy$calculus$frame71258 = (function emmy$calculus$frame$__GT_t_emmy$calculus$frame71258(c__GT_e,e__GT_c,call,name,ancestor_frame,params,meta71259){
return (new emmy.calculus.frame.t_emmy$calculus$frame71258(c__GT_e,e__GT_c,call,name,ancestor_frame,params,meta71259));
});
...
return (new emmy.calculus.frame.t_emmy$calculus$frame71258(c__GT_e,e__GT_c,emmy$calculus$frame$frame_maker_$_call,name,ancestor_frame,params,cljs.core.PersistentArrayMap.EMPTY));
});
