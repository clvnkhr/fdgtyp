...
var namespaces__$1 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(cljs.core.merge,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var or__5162__auto__ = env_nss;
...
var len__5897__auto___77223 = arguments.length;
var i__5898__auto___77224 = (0);
while(true){
if((i__5898__auto___77224 < len__5897__auto___77223)){
args__5903__auto__.push((arguments[i__5898__auto___77224]));

var G__77225 = (i__5898__auto___77224 + (1));
i__5898__auto___77224 = G__77225;
continue;
} else {
}
break;
...
return sci.impl.opts.process_permissions.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5904__auto__);
});
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq77201){
var G__77202 = cljs.core.first(seq77201);
var seq77201__$1 = cljs.core.next(seq77201);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__77202,seq77201__$1);
}));
...
var G__77229 = null;
var G__77229__1 = (function (msg){
return (new Error(msg));
});
var G__77229__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__77229__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__77229 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__77229__1.call(this,msg);
case 2:
return G__77229__2.call(this,msg,filename);
case 3:
return G__77229__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__77229.cljs$core$IFn$_invoke$arity$1 = G__77229__1;
G__77229.cljs$core$IFn$_invoke$arity$2 = G__77229__2;
G__77229.cljs$core$IFn$_invoke$arity$3 = G__77229__3;
return G__77229;
})()
], null),new cljs.core.Symbol(null,"cljs.core.PersistentQueue.EMPTY","cljs.core.PersistentQueue.EMPTY",399917828,null),cljs.core.PersistentQueue.EMPTY,new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__77203_SHARP_){
return (new goog.string.StringBuffer(p1__77203_SHARP_));
...
if(cljs.core.truth_(temp__5823__auto__)){
var vec__77204 = temp__5823__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77204,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77204,(1),null);
var G__77233 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__77234 = cljs.core.rest(kvs);
class__GT_opts = G__77233;
kvs = G__77234;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__77207){
var map__77208 = p__77207;
var map__77208__$1 = cljs.core.__destructure_map(map__77208);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var ns_aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821));
var js_libs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"js-libs","js-libs",-502933721));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var async_load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var proxy_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"proxy-fn","proxy-fn",1116677438));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77208__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
var env__$1 = (function (){var or__5162__auto__ = env;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
var map__77211 = opts;
var map__77211__$1 = cljs.core.__destructure_map(map__77211);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var ns_aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821));
var js_libs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"js-libs","js-libs",-502933721));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__77211__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334),new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334).cljs$core$IFn$_invoke$arity$1(env));
var async_load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__77211__$1,new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029),new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029).cljs$core$IFn$_invoke$arity$1(env));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77211__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var ctx__$1 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(sci.impl.opts.__GT_ctx(cljs.core.PersistentArrayMap.EMPTY,_BANG_env,features,readers,(function (){var or__5162__auto__ = new cljs.core.Keyword(null,"check-permissions","check-permissions",669054317).cljs$core$IFn$_invoke$arity$1(ctx);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
var or__5162__auto____$1 = allow;
