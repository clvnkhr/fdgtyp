...
import "./emmy.polynomial.richardson.js";
...
return (function (h){
return (((function (){var G__77771 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77771) : f.call(null,G__77771));
})() - fx) / h);
});
}));
...
return (function (h){
return ((fx - (function (){var G__77780 = (x - h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77780) : f.call(null,G__77780));
})()) / h);
});
}));
...
return (function (h){
return (((function (){var G__77787 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77787) : f.call(null,G__77787));
})() - (function (){var G__77788 = (x - h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77788) : f.call(null,G__77788));
})()) / ((2) * h));
});
});
/**
...
var fx_STAR_2 = ((2) * fx);
return (function (h){
return ((((function (){var G__77799 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77799) : f.call(null,G__77799));
})() + (function (){var G__77815 = (x - h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77815) : f.call(null,G__77815));
})()) - fx_STAR_2) / (h * h));
});
}));
...
var G__77835 = method;
var G__77835__$1 = (((G__77835 instanceof cljs.core.Keyword))?G__77835.fqn:null);
switch (G__77835__$1) {
case "forward":
...
return (fx / ((function (){var G__77836 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77836) : f.call(null,G__77836));
})() - fx));
})], null);
...
return (fx / ((function (){var G__77837 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77837) : f.call(null,G__77837));
})() - (function (){var G__77838 = (x - h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77838) : f.call(null,G__77838));
})()));
})], null);
...
return (fx / (fx - (function (){var G__77839 = (x - h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77839) : f.call(null,G__77839));
})()));
})], null);
...
return (((function (){var G__77842 = (x + h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77842) : f.call(null,G__77842));
})() + (function (){var G__77843 = (x - h);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__77843) : f.call(null,G__77843));
})()) - ((2) * fx));
})], null);
...
var map__77844 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([defaults,m], 0));
var map__77844__$1 = cljs.core.__destructure_map(map__77844);
var opts = map__77844__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77844__$1,new cljs.core.Keyword(null,"method","method",55703592));
...
var map__77857 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([opts__$1,overrides], 0));
var map__77857__$1 = cljs.core.__destructure_map(map__77857);
var opts__$2 = map__77857__$1;
var maxterms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77857__$1,new cljs.core.Keyword(null,"maxterms","maxterms",951779603));
var tolerance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77857__$1,new cljs.core.Keyword(null,"tolerance","tolerance",406811818));
var initial_h = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77857__$1,new cljs.core.Keyword(null,"initial-h","initial-h",213105060));
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77857__$1,new cljs.core.Keyword(null,"method","method",55703592));
var info_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77857__$1,new cljs.core.Keyword(null,"info?","info?",361925553));
var map__77858 = emmy.numerical.derivative.configs(method,f,x,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x)));
var map__77858__$1 = cljs.core.__destructure_map(map__77858);
var ratio_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77858__$1,new cljs.core.Keyword(null,"ratio-fn","ratio-fn",1226148920));
var function$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77858__$1,new cljs.core.Keyword(null,"function","function",-2127255473));
var p = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77858__$1,new cljs.core.Keyword(null,"p","p",151049309));
var q = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77858__$1,new cljs.core.Keyword(null,"q","q",689001697));
