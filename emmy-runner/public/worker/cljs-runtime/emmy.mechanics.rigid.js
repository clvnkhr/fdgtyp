...
import "./emmy.quaternion.js";
import "./emmy.structure.js";
goog.provide('emmy.mechanics.rigid');
emmy.mechanics.rigid.three_vector_components__GT_antisymmetric = (function emmy$mechanics$rigid$three_vector_components__GT_antisymmetric(p__77998){
var vec__77999 = p__77998;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77999,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77999,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77999,(2),null);
...
return (function (t){
return emmy.mechanics.rigid.antisymmetric__GT_column_matrix(emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2((function (){var fexpr__78004 = (emmy.calculus.derivative.D.cljs$core$IFn$_invoke$arity$1 ? emmy.calculus.derivative.D.cljs$core$IFn$_invoke$arity$1(M_of_t) : emmy.calculus.derivative.D.call(null,M_of_t));
return (fexpr__78004.cljs$core$IFn$_invoke$arity$1 ? fexpr__78004.cljs$core$IFn$_invoke$arity$1(t) : fexpr__78004.call(null,t));
...
return (function (q){
return (function (t){
return emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2(emmy.matrix.transpose((function (){var G__78008 = (q.cljs$core$IFn$_invoke$arity$1 ? q.cljs$core$IFn$_invoke$arity$1(t) : q.call(null,t));
return (M_of_q.cljs$core$IFn$_invoke$arity$1 ? M_of_q.cljs$core$IFn$_invoke$arity$1(G__78008) : M_of_q.call(null,G__78008));
})()),(function (){var fexpr__78009 = emmy.mechanics.rigid.M_of_q__GT_omega_of_t(M_of_q)(q);
return (fexpr__78009.cljs$core$IFn$_invoke$arity$1 ? fexpr__78009.cljs$core$IFn$_invoke$arity$1(t) : fexpr__78009.call(null,t));
})());
});
});
});
...
return (function (p__78010){
var vec__78011 = p__78010;
var w0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78011,(0),null);
var w1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78011,(1),null);
var w2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78011,(2),null);
...
return (function (p__78014){
var vec__78015 = p__78014;
var w0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78015,(0),null);
var w1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78015,(1),null);
var w2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78015,(2),null);
...
return emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2((function (){var fexpr__78024 = (emmy.calculus.derivative.D.cljs$core$IFn$_invoke$arity$1 ? emmy.calculus.derivative.D.cljs$core$IFn$_invoke$arity$1(M_on_path) : emmy.calculus.derivative.D.call(null,M_on_path));
return (fexpr__78024.cljs$core$IFn$_invoke$arity$1 ? fexpr__78024.cljs$core$IFn$_invoke$arity$1(t__$1) : fexpr__78024.call(null,t__$1));
 ...
 */
emmy.mechanics.rigid.Euler_state__GT_omega_body = (function emmy$mechanics$rigid$Euler_state__GT_omega_body(p__78025){
var vec__78029 = p__78025;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78029,(0),null);
var vec__78032 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78029,(1),null);
var theta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78032,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78032,(1),null);
var psi = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78032,(2),null);
var vec__78035 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78029,(2),null);
var thetadot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78035,(0),null);
var phidot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78035,(1),null);
var psidot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78035,(2),null);
...
emmy.mechanics.rigid.quaternion_state__GT_omega_body = (function emmy$mechanics$rigid$quaternion_state__GT_omega_body(p__78057){
var vec__78058 = p__78057;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78058,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78058,(1),null);
var qdot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78058,(2),null);
...
var q_COLON_a_78166 = emmy.matrix.by_rows.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(1),(0),(0)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(-1),(0),(0),(0)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0),(1)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(-1),(0)], null)], 0));
var q_COLON_b_78167 = emmy.matrix.by_rows.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(1),(0)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0),(-1)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(-1),(0),(0),(0)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(1),(0),(0)], null)], 0));
...
emmy.mechanics.rigid.quaternion_state__GT_omega_space = (function emmy$mechanics$rigid$quaternion_state__GT_omega_space(p__78064){
var vec__78065 = p__78064;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78065,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78065,(1),null);
var qdot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78065,(2),null);
...
var omega_STAR__STAR_x = emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2(two_m_STAR__STAR_2_inv,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$variadic(QdotT,q_COLON_a_78166,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([Q], 0)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null)));
var omega_STAR__STAR_y = emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2(two_m_STAR__STAR_2_inv,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$variadic(QdotT,q_COLON_b_78167,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([Q], 0)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null)));
var omega_STAR__STAR_z = emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$2(two_m_STAR__STAR_2_inv,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(emmy.generic._STAR_.cljs$core$IFn$_invoke$arity$variadic(QdotT,q_COLON_c_78168,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([Q], 0)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null)));
...
return (function (p__78070){
var vec__78072 = p__78070;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78072,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78072,(1),null);
var omega = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78072,(2),null);
...
return (function (p__78078){
var vec__78079 = p__78078;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78079,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78079,(1),null);
var qw_state = vec__78079;
...
return (function (p__78100){
var vec__78101 = p__78100;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78101,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78101,(1),null);
var qdot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78101,(2),null);
var Q = emmy.matrix.up__GT_column_matrix(q);
