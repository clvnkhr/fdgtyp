...
var m = (function (){var or__5162__auto__ = cljs.core.meta(expr);
...
var f = (cljs.core.truth_(cljs.core.seqable_QMARK_(expr))?cljs.core.first(expr):null);
var fm = (function (){var or__5162__auto__ = new cljs.core.Keyword("sci.impl","f-meta","sci.impl/f-meta",-1735495322).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
var G__73582 = f;
...
return cljs.core.meta(G__73582);
}
}
})();
...
var data__$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__73588,entry){
var vec__73589 = p__73588;
var acc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73589,(0),null);
var last_file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73589,(1),null);
var last_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73589,(2),null);
var last_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73589,(3),null);
var new_last_name = (function (){var or__5162__auto__ = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(entry);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return last_name;
...
var new_last_file = (function (){var or__5162__auto__ = new cljs.core.Keyword(null,"file","file",-1269645878).cljs$core$IFn$_invoke$arity$1(entry);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return last_file;
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(clojure.string.join.cljs$core$IFn$_invoke$arity$1(cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n__$1," "))));
});
sci.impl.callstack.format_stacktrace = (function sci$impl$callstack$format_stacktrace(st){
var st__$1 = cljs.core.force(st);
var data = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__73595){
var map__73596 = p__73595;
var map__73596__$1 = cljs.core.__destructure_map(map__73596);
var nom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73596__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73596__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73596__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73596__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73596__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var built_in = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73596__$1,new cljs.core.Keyword("sci","built-in","sci/built-in",1244659599));
var local = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73596__$1,new cljs.core.Keyword(null,"local","local",-1497766724));
if(cljs.core.truth_((function (){var or__5162__auto__ = line;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return built_in;
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(nom)?(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(ns)+"/"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(nom)):ns))+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(local)?(""+"#"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(local)):null))),new cljs.core.Keyword(null,"loc","loc",-584284901),(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__5162__auto__ = file;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
})())+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(line)?(""+":"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)+":"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(column)):null)))], null);
} else {
return null;
}
}),st__$1);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__73599){
var map__73600 = p__73599;
var map__73600__$1 = cljs.core.__destructure_map(map__73600);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73600__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var loc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73600__$1,new cljs.core.Keyword(null,"loc","loc",-584284901));
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sci.impl.callstack.right_pad(name,max_name))+" - "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(loc));
}),data);
});
