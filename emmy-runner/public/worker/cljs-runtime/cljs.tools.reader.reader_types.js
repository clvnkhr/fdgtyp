...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_62000 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_62000(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_62002 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_62002(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_62004 = (function (reader,ch){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_62004(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_62006 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_62006(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_62012 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_62012(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_62014 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_62014(reader);
}
});
...
var G__62073 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__62074 = s.append(c);
c = G__62073;
s = G__62074;
continue;
}
