...
var len__5897__auto___73250 = arguments.length;
var i__5898__auto___73251 = (0);
while(true){
if((i__5898__auto___73251 < len__5897__auto___73250)){
args__5903__auto__.push((arguments[i__5898__auto___73251]));

var G__73252 = (i__5898__auto___73251 + (1));
i__5898__auto___73251 = G__73252;
continue;
} else {
}
break;
...
/** @this {Function} */
(edamame.impl.ns_parser.load_lib.cljs$lang$applyTo = (function (seq73239){
var G__73240 = cljs.core.first(seq73239);
var seq73239__$1 = cljs.core.next(seq73239);
var G__73241 = cljs.core.first(seq73239__$1);
var seq73239__$2 = cljs.core.next(seq73239__$1);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__73240,G__73241,seq73239__$2);
}));
...
var vec__73242 = arg;
var seq__73243 = cljs.core.seq(vec__73242);
var first__73244 = cljs.core.first(seq__73243);
var seq__73243__$1 = cljs.core.next(seq__73243);
var prefix = first__73244;
var args_STAR___$2 = seq__73243__$1;
if((prefix == null)){
...
edamame.impl.ns_parser._ns = (function edamame$impl$ns_parser$_ns(p__73246){
var vec__73247 = p__73246;
var seq__73248 = cljs.core.seq(vec__73247);
var first__73249 = cljs.core.first(seq__73248);
var seq__73248__$1 = cljs.core.next(seq__73248);
var _ns = first__73249;
var first__73249__$1 = cljs.core.first(seq__73248__$1);
var seq__73248__$2 = cljs.core.next(seq__73248__$1);
var name = first__73249__$1;
var references = seq__73248__$2;
...
var requires = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__73245_SHARP_){
return edamame.impl.ns_parser.load_libs(new cljs.core.Keyword(null,"require","require",-468001333),cljs.core.rest(p1__73245_SHARP_));
