...
var memo_count_71195 = cljs.core.count(cljs.core.deref(emmy.polynomial.gcd.gcd_memo));
if((memo_count_71195 > (0))){
var hits_71196 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_hit);
var misses_71197 = cljs.core.deref(emmy.polynomial.gcd.gcd_cache_miss);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [goog.string.format("GCD cache hit rate %.2f%% (%d entries)",((100) * (hits_71196 / (hits_71196 + misses_71197))),memo_count_71195)], null);
}),null)),null,392627684,null);
} else {
}
...
var len__5897__auto___71198 = arguments.length;
var i__5898__auto___71199 = (0);
while(true){
if((i__5898__auto___71199 < len__5897__auto___71198)){
args__5903__auto__.push((arguments[i__5898__auto___71199]));

var G__71200 = (i__5898__auto___71199 + (1));
i__5898__auto___71199 = G__71200;
continue;
} else {
}
break;
...
/** @this {Function} */
(emmy.polynomial.gcd.dbg.cljs$lang$applyTo = (function (seq71016){
var G__71018 = cljs.core.first(seq71016);
var seq71016__$1 = cljs.core.next(seq71016);
var G__71019 = cljs.core.first(seq71016__$1);
var seq71016__$2 = cljs.core.next(seq71016__$1);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71018,G__71019,seq71016__$2);
}));
...
var vec__71033 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var ticks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71033,(0),null);
var units = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71033,(1),null);
...
var _STAR_poly_gcd_time_limit_STAR__orig_val__71050 = emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_;
var _STAR_clock_STAR__orig_val__71051 = emmy.polynomial.gcd._STAR_clock_STAR_;
var _STAR_poly_gcd_time_limit_STAR__temp_val__71052 = timeout;
var _STAR_clock_STAR__temp_val__71053 = emmy.util.stopwatch.stopwatch();
(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__temp_val__71052);

(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__temp_val__71053);

try{return (thunk.cljs$core$IFn$_invoke$arity$0 ? thunk.cljs$core$IFn$_invoke$arity$0() : thunk.call(null));
}finally {(emmy.polynomial.gcd._STAR_clock_STAR_ = _STAR_clock_STAR__orig_val__71051);

(emmy.polynomial.gcd._STAR_poly_gcd_time_limit_STAR_ = _STAR_poly_gcd_time_limit_STAR__orig_val__71050);
}});
/**
...
if(cljs.core.truth_(and__5160__auto__)){
var G__71063 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [u,v], null);
var fexpr__71062 = cljs.core.deref(emmy.polynomial.gcd.gcd_memo);
return (fexpr__71062.cljs$core$IFn$_invoke$arity$1 ? fexpr__71062.cljs$core$IFn$_invoke$arity$1(G__71063) : fexpr__71062.call(null,G__71063));
} else {
return and__5160__auto__;
}
})();
...
var len__5897__auto___71202 = arguments.length;
var i__5898__auto___71203 = (0);
while(true){
if((i__5898__auto___71203 < len__5897__auto___71202)){
args_arr__5922__auto__.push((arguments[i__5898__auto___71203]));

var G__71204 = (i__5898__auto___71203 + (1));
i__5898__auto___71203 = G__71204;
continue;
} else {
}
break;
...
(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$1 = (function (p__71096){
var vec__71097 = p__71096;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71097,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71097,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [u,v], null);
}));

(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$2 = (function (p__71103,f){
var vec__71104 = p__71103;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71104,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71104,(1),null);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(u,v) : f.call(null,u,v));
}));

(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$3 = (function (p__71109,f1,f2){
var vec__71110 = p__71109;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71110,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71110,(1),null);
return (f1.cljs$core$IFn$_invoke$arity$3 ? f1.cljs$core$IFn$_invoke$arity$3(u,v,f2) : f1.call(null,u,v,f2));
}));

(emmy.polynomial.gcd.cont__GT_.cljs$core$IFn$_invoke$arity$variadic = (function (p__71114,f1,f2,more){
var vec__71117 = p__71114;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71117,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71117,(1),null);
var G__71120 = u;
var G__71121 = v;
var G__71122 = (function (u_SINGLEQUOTE_,v_SINGLEQUOTE_){
...
return (f1.cljs$core$IFn$_invoke$arity$3 ? f1.cljs$core$IFn$_invoke$arity$3(G__71120,G__71121,G__71122) : f1.call(null,G__71120,G__71121,G__71122));
}));

/** @this {Function} */
(emmy.polynomial.gcd.cont__GT_.cljs$lang$applyTo = (function (seq71081){
var G__71082 = cljs.core.first(seq71081);
var seq71081__$1 = cljs.core.next(seq71081);
var G__71083 = cljs.core.first(seq71081__$1);
var seq71081__$2 = cljs.core.next(seq71081__$1);
var G__71084 = cljs.core.first(seq71081__$2);
var seq71081__$3 = cljs.core.next(seq71081__$2);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71082,G__71083,G__71084,seq71081__$3);
}));
...
var vec__71135 = emmy.polynomial.gcd.terms__GT_sort_PLUS_unsort(cljs.core.into.cljs$core$IFn$_invoke$arity$2(l_terms,r_terms));
var sort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71135,(0),null);
var unsort = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71135,(1),null);
return emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(unsort,(function (){var G__71140 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,u);
var G__71141 = emmy.polynomial.map_exponents.cljs$core$IFn$_invoke$arity$2(sort,v);
return (continue$.cljs$core$IFn$_invoke$arity$2 ? continue$.cljs$core$IFn$_invoke$arity$2(G__71140,G__71141) : continue$.call(null,G__71140,G__71141));
})());
} else {
...
var primitive = (cljs.core.truth_(emmy.generic.one_QMARK_.cljs$core$IFn$_invoke$arity$1(content))?p:emmy.polynomial.map_coefficients((function (p1__71144_SHARP_){
return emmy.generic.exact_divide.cljs$core$IFn$_invoke$arity$2(p1__71144_SHARP_,content);
}),p));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [content,primitive], null);
}
});
...
var vec__71164 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(u,gcd);
var ku = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71164,(0),null);
var pu = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71164,(1),null);
var vec__71167 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(v,gcd);
var kv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71167,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71167,(1),null);
...
var vec__71174 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(emmy.polynomial.bare_terms(m),(0));
var mono_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71174,(0),null);
var mono_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71174,(1),null);
...
var vec__71177 = emmy.polynomial.pseudo_remainder(u,v);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71177,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71177,(1),null);
if(cljs.core.truth_(emmy.generic.zero_QMARK_.cljs$core$IFn$_invoke$arity$1(r))){
return emmy.generic.abs.cljs$core$IFn$_invoke$arity$1(v);
} else {
var vec__71180 = emmy.polynomial.gcd.__GT_content_PLUS_primitive(r,gcd);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71180,(0),null);
var prim = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71180,(1),null);
var G__71208 = v;
var G__71209 = prim;
u = G__71208;
v = G__71209;
