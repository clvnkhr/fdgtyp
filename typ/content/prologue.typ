...
So let's get rid of the expression derivative $d\/d t$ and replace it with an appropriate functional derivative. If $f$ is a function then we will write $D f$ as the new function that is the derivative of $f$:#footnote[An explanation of functional derivatives is in Appendix #fdg-ref-page(<chap-appendix-b>, page-target: <sec-B.4>, suffix: ".")]
