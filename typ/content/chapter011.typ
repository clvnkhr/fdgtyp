...
#fdg-chapter("Special Relativity", numbered: true)[
...
$ (xi^0\,bold(xi))= cal(R) (R) ((xi')^0 \, bold(xi)') = ((xi')^0 \, R (bold(xi)')) . $
...
$ B (bold(beta))= (cal(R) (R))^(-1) compose B (R (bold(beta))) compose cal(R) (R). $
...
$ cal(R) (R) compose B (bold(beta)) = B (R (bold(beta))) compose cal(R) (R). $
